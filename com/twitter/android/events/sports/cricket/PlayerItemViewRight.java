...
public class PlayerItemViewRight extends RelativeLayout {
    ...
    public PlayerItemViewRight(Context context) {
        this(context, null, 0);
    }

    public PlayerItemViewRight(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public PlayerItemViewRight(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet);
        this.d = context;
        this.e = LayoutInflater.from(this.d).inflate(2130968726, this, true);
