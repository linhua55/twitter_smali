...
public class PlayLoggerContext implements SafeParcelable {
    ...
    public boolean equals(Object obj) {
        ...
        return this.a == playLoggerContext.a && this.b.equals(playLoggerContext.b) && this.c == playLoggerContext.c && this.d == playLoggerContext.d && bj.a(this.h, playLoggerContext.h) && bj.a(this.e, playLoggerContext.e) && bj.a(this.f, playLoggerContext.f) && this.g == playLoggerContext.g && this.i == playLoggerContext.i && this.j == playLoggerContext.j;
    }

    public int hashCode() {
        return bj.a(Integer.valueOf(this.a), this.b, Integer.valueOf(this.c), Integer.valueOf(this.d), this.h, this.e, this.f, Boolean.valueOf(this.g), Boolean.valueOf(this.i), Integer.valueOf(this.j));
    }
