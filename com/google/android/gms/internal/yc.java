...
public class yc implements km {
    protected static final boolean a;
    private static int d;
    private static int e;
    protected final ym b;
    protected final yd c;
    ...
    private void a(long j, zzk<?> com_google_android_gms_internal_zzk_, byte[] bArr, StatusLine statusLine) {
        if (a || j > ((long) d)) {
            ...
            objArr[4] = Integer.valueOf(com_google_android_gms_internal_zzk_.s().b());
            xi.b(str, objArr);
        }
    }

    private static void a(String str, zzk<?> com_google_android_gms_internal_zzk_, zzr com_google_android_gms_internal_zzr) throws zzr {
        wa s = com_google_android_gms_internal_zzk_.s();
        int r = com_google_android_gms_internal_zzk_.r();
        try {
            s.a(com_google_android_gms_internal_zzr);
            com_google_android_gms_internal_zzk_.b(String.format("%s-retry [timeout=%s]", new Object[]{str, Integer.valueOf(r)}));
        } catch (zzr e) {
            com_google_android_gms_internal_zzk_.b(String.format("%s-timeout-giveup [timeout=%s]", new Object[]{str, Integer.valueOf(r)}));
            throw e;
        }
    }

    private void a(Map<String, String> map, aw awVar) {
        if (awVar != null) {
            if (awVar.b != null) {
                map.put("If-None-Match", awVar.b);
            }
            if (awVar.d > 0) {
                map.put("If-Modified-Since", DateUtils.formatDate(new Date(awVar.d)));
            }
        }
    }

    private byte[] a(HttpEntity httpEntity) throws IOException, zzp {
        a aVar = new a(this.c, (int) httpEntity.getContentLength());
        byte[] bArr = null;
        try {
            ...
            try {
                ...
                xi.a("Error occured when calling consumingContent", new Object[0]);
            }
            this.c.a(bArr);
            aVar.close();
        }
    ...
    public com.google.android.gms.internal.pn a(com.google.android.gms.internal.zzk<?> r19) throws com.google.android.gms.internal.zzr {
        /*
        r18 = this;
    ...
    L_0x0004:
        ...
        r4 = r19.f();	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x00e1 }
        r0 = r18;
        r0.a(r2, r4);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x00e1 }
        r0 = r18;
        r4 = r0.b;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x00e1 }
        r0 = r19;
        r15 = r4.a(r0, r2);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x00e1 }
        ...
        r6 = a(r2);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
        r2 = 304; // 0x130 float:4.26E-43 double:1.5E-321;
        if (r4 != r2) goto L_0x0065;
    L_0x0036:
        r2 = r19.f();	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
        if (r2 != 0) goto L_0x004c;
    L_0x003c:
        r3 = new com.google.android.gms.internal.pn;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
    ...
    L_0x004b:
        return r3;
    L_0x004c:
        r3 = r2.g;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
        ...
        r7 = new com.google.android.gms.internal.pn;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
        r8 = 304; // 0x130 float:4.26E-43 double:1.5E-321;
        r9 = r2.a;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
        r10 = r2.g;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
        r11 = 1;
    ...
    L_0x006b:
        r2 = r15.getEntity();	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
        r0 = r18;
        r11 = r0.a(r2);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x013c }
    L_0x0075:
        ...
        r7 = r18;
        r10 = r19;
        r7.a(r8, r10, r11, r12);	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x0140 }
    ...
    L_0x00a0:
        ...
        goto L_0x0075;
    L_0x00a4:
        r3 = new com.google.android.gms.internal.pn;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b2, MalformedURLException -> 0x00c2, IOException -> 0x0140 }
        r7 = 0;
    ...
    L_0x00e6:
        ...
        r9 = r19.d();
        r3[r8] = r9;
        com.google.android.gms.internal.xi.c(r2, r3);
        if (r5 == 0) goto L_0x0136;
    L_0x0107:
        r3 = new com.google.android.gms.internal.pn;
        r7 = 0;
    ...
    L_0x0140:
        ...
        goto L_0x00e3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.yc.a(com.google.android.gms.internal.zzk):com.google.android.gms.internal.pn");
    }
}
