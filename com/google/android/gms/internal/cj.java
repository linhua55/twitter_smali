...
public final class cj {
    ...
    public static final ca<String> a;
    public static final ca<Boolean> aA;
    public static final ca<Boolean> aB;
    public static final ca<Boolean> aC;
    public static final ca<Boolean> aD;
    public static final ca<Boolean> aE;
    public static final ca<Long> aF;
    public static final ca<Boolean> aG;
    ...
    public static final ca<String> b;
    public static final ca<Boolean> c;
    public static final ca<String> d;
    public static final ca<Boolean> e;
    public static final ca<String> f;
    public static final ca<Boolean> g;
    public static final ca<Boolean> h;
    public static final ca<Boolean> i;
    public static final ca<String> j;
    public static final ca<String> k;
    public static final ca<String> l;
    public static final ca<Boolean> m;
    public static final ca<String> n;
    public static final ca<Integer> o;
    public static final ca<Integer> p;
    public static final ca<Integer> q;
    public static final ca<Long> r;
    public static final ca<Long> s;
    public static final ca<Integer> t;
    public static final ca<Boolean> u;
    public static final ca<String> v;
    public static final ca<Long> w;
    public static final ca<String> x;
    public static final ca<Boolean> y;
    public static final ca<String> z;

    static {
        a = ca.a(0, "gads:sdk_core_experiment_id");
        b = ca.a(0, "gads:sdk_core_location", "https://googleads.g.doubleclick.net/mads/static/mad/sdk/native/sdk-core-v40.html");
        c = ca.a(0, "gads:request_builder:singleton_webview", Boolean.valueOf(false));
        d = ca.a(0, "gads:request_builder:singleton_webview_experiment_id");
        e = ca.a(0, "gads:sdk_use_dynamic_module", Boolean.valueOf(false));
        f = ca.a(0, "gads:sdk_use_dynamic_module_experiment_id");
        g = ca.a(0, "gads:sdk_crash_report_enabled", Boolean.valueOf(false));
        h = ca.a(0, "gads:sdk_crash_report_full_stacktrace", Boolean.valueOf(false));
        i = ca.a(0, "gads:block_autoclicks", Boolean.valueOf(false));
        j = ca.a(0, "gads:block_autoclicks_experiment_id");
        k = ca.b(0, "gads:prefetch:experiment_id");
        l = ca.a(0, "gads:spam_app_context:experiment_id");
        m = ca.a(0, "gads:spam_app_context:enabled", Boolean.valueOf(false));
        n = ca.a(0, "gads:video_stream_cache:experiment_id");
        o = ca.a(0, "gads:video_stream_cache:limit_count", 5);
        p = ca.a(0, "gads:video_stream_cache:limit_space", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
        q = ca.a(0, "gads:video_stream_exo_cache:buffer_size", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
        r = ca.a(0, "gads:video_stream_cache:limit_time_sec", 300);
        s = ca.a(0, "gads:video_stream_cache:notify_interval_millis", 1000);
        t = ca.a(0, "gads:video_stream_cache:connect_timeout_millis", 10000);
        u = ca.a(0, "gads:video:metric_reporting_enabled", Boolean.valueOf(false));
        v = ca.a(0, "gads:video:metric_frame_hash_times", BuildConfig.VERSION_NAME);
        w = ca.a(0, "gads:video:metric_frame_hash_time_leniency", 500);
        x = ca.b(0, "gads:spam_ad_id_decorator:experiment_id");
        y = ca.a(0, "gads:spam_ad_id_decorator:enabled", Boolean.valueOf(false));
        z = ca.b(0, "gads:looper_for_gms_client:experiment_id");
        ...
        R = ca.a(0, "gads:app_index:timeout_ms", 1000);
        ...
        am = ca.a(0, "gads:device_info_caching_expiry_ms:expiry", 300000);
        ...
        au = ca.a(0, "gads:network:cache_prediction_duration_s", 300);
        ...
        ax = ca.a(0, "gads:ad_loader:timeout_ms", 60000);
        ay = ca.a(0, "gads:rendering:timeout_ms", 60000);
        az = ca.a(0, "gads:adshield:enable_adshield_instrumentation", Boolean.valueOf(false));
        aA = ca.a(0, "gass:enabled", Boolean.valueOf(false));
        aB = ca.a(0, "gass:enable_int_signal", Boolean.valueOf(true));
        aC = ca.a(0, "gads:adid_notification:first_party_check:enabled", Boolean.valueOf(true));
        aD = ca.a(0, "gads:edu_device_helper:enabled", Boolean.valueOf(true));
        aE = ca.a(0, "gads:support_screen_shot", Boolean.valueOf(true));
        aF = ca.a(0, "gads:js_flags:update_interval", TimeUnit.HOURS.toMillis(12));
        aG = ca.a(0, "gads:custom_render:ping_on_ad_rendered", Boolean.valueOf(false));
    }
