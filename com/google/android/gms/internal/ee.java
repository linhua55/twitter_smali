...
public abstract class ee extends Binder implements ed {
    public ee() {
    ...
    public static ed a(IBinder iBinder) {
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof ed)) ? new ef(iBinder) : (ed) queryLocalInterface;
    }
