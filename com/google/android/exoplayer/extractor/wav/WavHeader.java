...
final class WavHeader {
    ...
    public long getPosition(long j) {
        return ((((((long) this.averageBytesPerSecond) * j) / C.MICROS_PER_SECOND) / ((long) this.blockAlignment)) * ((long) this.blockAlignment)) + this.dataStartPosition;
    }

    public long getTimeUs(long j) {
        return (C.MICROS_PER_SECOND * j) / ((long) this.averageBytesPerSecond);
    }
