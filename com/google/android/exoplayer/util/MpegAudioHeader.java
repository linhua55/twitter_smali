...
public final class MpegAudioHeader {
    ...
    static {
        ...
        BITRATE_V1_L1 = new int[]{32, 64, 96, 128, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, 256, 288, 320, 352, 384, 416, 448};
        BITRATE_V2_L1 = new int[]{32, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, 256};
        BITRATE_V1_L2 = new int[]{32, 48, 56, 64, 80, 96, 112, 128, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, 256, 320, 384};
        BITRATE_V1_L3 = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, 256, 320};
    ...
    public static boolean populateHeader(int i, MpegAudioHeader mpegAudioHeader) {
        ...
        mpegAudioHeader.setValues(i3, str, i6, i9, i2, i7 * ExoPlayerImplInternal.MSG_SEEK_COMPLETE, i8);
        return true;
    }
