...
public final class C$Gson$Types {
    ...
    final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.typeArguments) ^ this.rawType.hashCode()) ^ C$Gson$Types.b(this.ownerType);
        }

        public String toString() {
            StringBuilder stringBuilder = new StringBuilder((this.typeArguments.length + 1) * 30);
            stringBuilder.append(C$Gson$Types.f(this.rawType));
            if (this.typeArguments.length == 0) {
                return stringBuilder.toString();
            }
            stringBuilder.append("<").append(C$Gson$Types.f(this.typeArguments[0]));
    ...
    public static WildcardType b(Type type) {
        return new WildcardTypeImpl(new Type[]{type}, a);
    }
