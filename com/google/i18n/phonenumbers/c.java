...
public class c {
    static Map<Integer, List<String>> a() {
        ...
        arrayList = new ArrayList(1);
        arrayList.add("GN");
        hashMap.put(Integer.valueOf(PsExtractor.VIDEO_STREAM), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("CI");
        ...
        arrayList = new ArrayList(1);
        arrayList.add("GQ");
        hashMap.put(Integer.valueOf(PsExtractor.VIDEO_STREAM_MASK), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("GA");
        ...
        arrayList = new ArrayList(1);
        arrayList.add("TZ");
        hashMap.put(Integer.valueOf(NalUnitUtil.EXTENDED_SAR), arrayList);
        arrayList = new ArrayList(1);
        arrayList.add("UG");
