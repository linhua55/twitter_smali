...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbky;->a:Ljava/util/Collection;
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/twitter/library/client/Session;)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lbky;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/twitter/library/service/ab;Z)V
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/twitter/library/service/ab;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lbky;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/twitter/library/service/ab;Z)V
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/twitter/library/service/ab;Z)V
    ...
    .line 33
    iput-boolean v0, p0, Lbky;->g:Z

    .line 34
    iput-boolean v0, p0, Lbky;->b:Z

    .line 60
    iput-boolean p4, p0, Lbky;->b:Z
    ...
    invoke-direct {v1, p0, p1}, Lbkz;-><init>(Lbky;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbky;->h:Lcom/twitter/library/service/k;

    .line 65
    iget-object v0, p0, Lbky;->h:Lcom/twitter/library/service/k;

    invoke-virtual {p0, v0}, Lbky;->a(Lcom/twitter/internal/android/service/ac;)Lcom/twitter/internal/android/service/AsyncOperation;
...
.method static synthetic w()Ljava/util/Collection;
    ...
    .prologue
    .line 30
    sget-object v0, Lbky;->a:Ljava/util/Collection;
...
.method protected final a()Lcom/twitter/library/service/d;
    ...
    .prologue
    .line 103
    invoke-virtual {p0}, Lbky;->b()Lcom/twitter/library/service/e;

    move-result-object v0

    .line 104
    invoke-virtual {p0}, Lbky;->u()Lcom/twitter/library/network/a;
...
.method protected final b(Lcom/twitter/library/service/aa;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lbky;->c(Lcom/twitter/library/service/aa;)Z
...
.method protected final u()Lcom/twitter/library/network/a;
    ...
    .line 129
    :cond_0
    iget-object v0, p0, Lbky;->c:Lcom/twitter/library/network/a;
    ...
    invoke-virtual {p0}, Lbky;->N()Lcom/twitter/library/service/ab;
