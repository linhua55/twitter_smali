...
.field private d:Ldej;

.field private k:Lcom/crashlytics/android/core/x;

.field private l:Lcom/crashlytics/android/core/x;

.field private m:Lcom/crashlytics/android/core/z;

.field private n:Lcom/crashlytics/android/core/ab;
...
.field private final z:Lcom/crashlytics/android/core/by;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v2, v2, v1}, Lcom/crashlytics/android/core/f;-><init>(FLcom/crashlytics/android/core/z;Lcom/crashlytics/android/core/by;Z)V

    .line 205
    return-void
.end method

.method constructor <init>(FLcom/crashlytics/android/core/z;Lcom/crashlytics/android/core/by;Z)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lcom/crashlytics/android/core/f;-><init>(FLcom/crashlytics/android/core/z;Lcom/crashlytics/android/core/by;ZLjava/util/concurrent/ExecutorService;)V

    .line 211
    return-void
.end method

.method constructor <init>(FLcom/crashlytics/android/core/z;Lcom/crashlytics/android/core/by;ZLjava/util/concurrent/ExecutorService;)V
    .locals 2
    ...
    :goto_0
    iput-object p2, p0, Lcom/crashlytics/android/core/f;->m:Lcom/crashlytics/android/core/z;

    .line 221
    iput-object p3, p0, Lcom/crashlytics/android/core/f;->z:Lcom/crashlytics/android/core/by;
...
.method private K()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/crashlytics/android/core/f;->m:Lcom/crashlytics/android/core/z;

    invoke-interface {v0}, Lcom/crashlytics/android/core/z;->a()V
    :try_end_0
...
.method private a(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 472
    iget-object v2, p0, Lcom/crashlytics/android/core/f;->n:Lcom/crashlytics/android/core/ab;

    invoke-static {p1, p2, p3}, Lcom/crashlytics/android/core/f;->b(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v0, v1, v3}, Lcom/crashlytics/android/core/ab;->a(JLjava/lang/String;)V
...
.method private a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .prologue
    .line 298
    iget-object v0, p0, Lcom/crashlytics/android/core/f;->z:Lcom/crashlytics/android/core/by;

    if-eqz v0, :cond_0

    new-instance v0, Lcom/crashlytics/android/core/aa;

    iget-object v1, p0, Lcom/crashlytics/android/core/f;->z:Lcom/crashlytics/android/core/by;

    invoke-direct {v0, v1}, Lcom/crashlytics/android/core/aa;-><init>(Lcom/crashlytics/android/core/by;)V
...
.method private a(Lcom/crashlytics/android/core/ck;)V
    .locals 7
    ...
    iget-object v5, p0, Lcom/crashlytics/android/core/f;->d:Ldej;

    move-object v4, p1

    move-object v6, p0

    invoke-direct/range {v0 .. v6}, Lcom/crashlytics/android/core/ab;-><init>(Ljava/lang/Thread$UncaughtExceptionHandler;Lcom/crashlytics/android/core/u;Lio/fabric/sdk/android/services/common/IdManager;Lcom/crashlytics/android/core/ck;Ldej;Lcom/crashlytics/android/core/f;)V

    iput-object v0, p0, Lcom/crashlytics/android/core/f;->n:Lcom/crashlytics/android/core/ab;

    .line 336
    iget-object v0, p0, Lcom/crashlytics/android/core/f;->n:Lcom/crashlytics/android/core/ab;

    invoke-virtual {v0}, Lcom/crashlytics/android/core/ab;->c()V
...
.method private a(Landroid/app/Activity;Lio/fabric/sdk/android/services/settings/o;)Z
    ...
    invoke-direct {v4, p1, p2}, Lcom/crashlytics/android/core/az;-><init>(Landroid/content/Context;Lio/fabric/sdk/android/services/settings/o;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/crashlytics/android/core/m;-><init>(Lcom/crashlytics/android/core/f;Landroid/app/Activity;Lcom/crashlytics/android/core/t;Lcom/crashlytics/android/core/az;Lio/fabric/sdk/android/services/settings/o;)V
...
.method private static c(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/crashlytics/android/core/f;->n:Lcom/crashlytics/android/core/ab;
...
.method a(Lio/fabric/sdk/android/services/settings/v;)Lcom/crashlytics/android/core/au;
    .locals 4
    ...
    invoke-direct {v0, p0, v1, v2, v3}, Lcom/crashlytics/android/core/av;-><init>(Lio/fabric/sdk/android/p;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/j;)V
...
.method public a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/crashlytics/android/core/ab;->a(Ljava/util/Map;)V
...
.method public a(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/crashlytics/android/core/ab;->a(Ljava/lang/Thread;Ljava/lang/Throwable;)V
...
.method a(Lv;)V
    ...
    .prologue
    .line 854
    iput-object p1, p0, Lcom/crashlytics/android/core/f;->C:Lv;
...
.method a(Z)V
    ...
    invoke-direct {v0, p0}, Ldem;-><init>(Lio/fabric/sdk/android/p;)V

    .line 915
    invoke-interface {v0}, Ldel;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v0, v1}, Ldel;->a(Landroid/content/SharedPreferences$Editor;)Z
...
.method a(Landroid/content/Context;)Z
    ...
    invoke-direct {v1, p0}, Ldek;-><init>(Lio/fabric/sdk/android/p;)V

    iput-object v1, p0, Lcom/crashlytics/android/core/f;->d:Ldej;
    ...
    iget-object v3, p0, Lcom/crashlytics/android/core/f;->d:Ldej;

    invoke-direct {v1, v2, v3}, Lcom/crashlytics/android/core/x;-><init>(Ljava/lang/String;Ldej;)V
    ...
    .line 264
    new-instance v1, Lcom/crashlytics/android/core/bf;

    invoke-virtual {p0}, Lcom/crashlytics/android/core/f;->h()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, p1, v2}, Lcom/crashlytics/android/core/bf;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 276
    invoke-direct {p0, v1}, Lcom/crashlytics/android/core/f;->a(Lcom/crashlytics/android/core/ck;)V
...
.method public b(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/crashlytics/android/core/ab;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method protected d()Ljava/lang/Void;
    ...
    invoke-virtual {v0}, Lcom/crashlytics/android/core/ab;->h()V
    ...
    :cond_1
    :try_start_2
    iget-object v1, p0, Lcom/crashlytics/android/core/f;->n:Lcom/crashlytics/android/core/ab;

    invoke-virtual {v1}, Lcom/crashlytics/android/core/ab;->d()Z

    .line 368
    invoke-virtual {p0, v0}, Lcom/crashlytics/android/core/f;->a(Lio/fabric/sdk/android/services/settings/v;)Lcom/crashlytics/android/core/au;
    ...
    invoke-virtual {v1, v0}, Lcom/crashlytics/android/core/cd;->a(F)V
    :try_end_3
...
.method o()Lcom/crashlytics/android/core/ab;
    .locals 1
...
.method v()Lz;
    ...
    .line 863
    iget-object v1, p0, Lcom/crashlytics/android/core/f;->C:Lv;

    if-eqz v1, :cond_0

    .line 864
    iget-object v0, p0, Lcom/crashlytics/android/core/f;->C:Lv;

    invoke-interface {v0}, Lv;->d()Lz;
