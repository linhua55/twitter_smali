...
.method protected e_(I)V
    ...
    .line 55
    invoke-virtual {v6, p0}, Lcom/twitter/android/yb;->a(Lcom/twitter/android/kn;)V
    ...
    .line 57
    invoke-virtual {v4}, Lcom/twitter/app/users/o;->c()Lcom/twitter/android/yb;
    ...
    .line 59
    invoke-virtual {p0}, Lcom/twitter/app/users/InjectableUsersFragment;->aE()Lcom/twitter/app/common/list/aa;

    move-result-object v0

    iget-object v1, p0, Lcom/twitter/app/users/InjectableUsersFragment;->q:Lcom/twitter/android/widget/er;

    invoke-virtual {v0, v6, v1}, Lcom/twitter/app/common/list/aa;->a(Lcvt;Landroid/widget/ListAdapter;)V
...
.method g(I)Lcom/twitter/android/hy;
    ...
    .line 65
    invoke-virtual {p0}, Lcom/twitter/app/users/InjectableUsersFragment;->x()Z

    move-result v5

    invoke-virtual {p0}, Lcom/twitter/app/users/InjectableUsersFragment;->ag()Z

    move-result v6

    invoke-virtual {p0}, Lcom/twitter/app/users/InjectableUsersFragment;->ah()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 25
    invoke-virtual {p0}, Lcom/twitter/app/users/InjectableUsersFragment;->u()Lcom/twitter/app/users/o;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Lcom/twitter/app/users/o;->c()Lcom/twitter/android/yb;

    move-result-object v1

    invoke-virtual {v1}, Lcom/twitter/android/yb;->k()Z
...
.method public abstract u()Lcom/twitter/app/users/o;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TT;"
        }
