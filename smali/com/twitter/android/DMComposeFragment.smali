...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lcom/twitter/android/ca;-><init>(Lcom/twitter/android/bz;)V

    invoke-direct {p0, v0}, Lcom/twitter/android/SelectionFragment;-><init>(Lcom/twitter/android/pz;)V
...
.method private b(Ljava/lang/String;)V
    ...
    .line 281
    new-instance v1, Lcom/twitter/library/api/dm/requests/l;

    invoke-virtual {p0}, Lcom/twitter/android/DMComposeFragment;->getActivity()Landroid/support/v4/app/FragmentActivity;

    move-result-object v2

    invoke-virtual {p0}, Lcom/twitter/android/DMComposeFragment;->bf()Lcom/twitter/library/client/Session;

    move-result-object v3

    invoke-direct {v1, v2, v3, v0}, Lcom/twitter/library/api/dm/requests/l;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;Ljava/util/Collection;)V

    .line 282
    iget-object v0, v1, Lcom/twitter/library/api/dm/requests/l;->d:Ljava/lang/String;
    ...
    new-instance v2, Lcom/twitter/android/cb;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/twitter/android/cb;-><init>(Lcom/twitter/android/DMComposeFragment;Lcom/twitter/android/bz;)V
...
.method private c(J)I
    ...
    invoke-virtual {v0, v1}, Lcom/twitter/util/collection/au;->d(Ljava/lang/Object;)Lcom/twitter/util/collection/au;

    .line 395
    invoke-virtual {v0}, Lcom/twitter/util/collection/au;->h()I
...
.method public a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 298
    :goto_0
    invoke-static {p1, v0}, Lry;->a(Ljava/lang/String;Z)Ljava/lang/String;
...
.method protected b()Lsb;
    ...
    invoke-direct {v4, v1, v0, v5}, Lsj;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;Ljava/lang/String;)V

    .line 118
    new-instance v0, Lry;

    invoke-direct {v0, v1, v4, v2, v3}, Lry;-><init>(Landroid/content/Context;Lsj;J)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-direct {v4, v0, v6, v7, v5}, Lcom/twitter/library/client/l;-><init>(Landroid/content/Context;JLjava/lang/String;)V
    ...
    invoke-direct {v3, v0, v1, v4}, Lbtw;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;I)V

    const/16 v0, 0x190

    .line 150
    invoke-virtual {v3, v0}, Lbtw;->a(I)Lbtw;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 102
    invoke-virtual {p0}, Lcom/twitter/android/DMComposeFragment;->b()Lsb;

    move-result-object v1

    iput-object v1, p0, Lcom/twitter/android/DMComposeFragment;->g:Lsb;
...
.method public onStart()V
    ...
    .line 109
    invoke-virtual {p0}, Lcom/twitter/android/DMComposeFragment;->o()V
