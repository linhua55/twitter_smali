...
.field b:Lcom/twitter/android/kj;
...
.field private f:Lcom/twitter/android/ek;
...
.method public a(Lcom/twitter/library/client/ax;)Landroid/support/v4/app/Fragment;
    ...
    .prologue
    .line 150
    iget-object v0, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->f:Lcom/twitter/android/ek;
...
.method a(Ljava/util/List;Lcom/twitter/internal/android/widget/HorizontalListView;Lcom/twitter/internal/android/widget/DockLayout;)Lcom/twitter/android/ek;
    ...
    iget-object v5, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->b:Lcom/twitter/android/kj;
...
.method protected a(Lcom/twitter/app/common/list/x;)Lcom/twitter/app/common/list/x;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 156
    invoke-virtual {p1, v0}, Lcom/twitter/app/common/list/x;->e(I)Lcom/twitter/app/common/list/x;
    ...
    .line 157
    invoke-virtual {v0, v1}, Lcom/twitter/app/common/list/x;->i(Z)Lcom/twitter/app/common/list/x;
...
.method a(II)V
    ...
    .line 102
    invoke-virtual {p0}, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->o_()V
...
.method protected a(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->b:Lcom/twitter/android/kj;
    ...
    iget-object v1, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->b:Lcom/twitter/android/kj;
    ...
    .line 53
    iget-object v0, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->b:Lcom/twitter/android/kj;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->a(Ljava/util/List;Lcom/twitter/internal/android/widget/HorizontalListView;Lcom/twitter/internal/android/widget/DockLayout;)Lcom/twitter/android/ek;

    move-result-object v0

    iput-object v0, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->f:Lcom/twitter/android/ek;

    .line 55
    iget-object v0, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->a:Landroid/support/v4/view/ViewPager;

    iget-object v1, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->f:Lcom/twitter/android/ek;
...
.method a_(Landroid/net/Uri;)V
    ...
    invoke-virtual {v0, p1}, Lcom/twitter/android/ek;->a(Landroid/net/Uri;)I
...
.method public b(Landroid/os/Bundle;Lcom/twitter/app/common/base/y;)V
    ...
    new-instance v1, Lcom/twitter/android/kv;

    invoke-virtual {p0}, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->Y()Lcom/twitter/internal/android/widget/ToolBar;

    move-result-object v2

    iget v3, p0, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->c:I

    invoke-direct {v1, p0, v2, v3}, Lcom/twitter/android/kv;-><init>(Lcom/twitter/android/ku;Lcom/twitter/internal/android/widget/ToolBar;I)V
...
.method c()Ljava/lang/String;
    ...
    .prologue
    .line 74
    invoke-virtual {p0}, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->d()Lcom/twitter/library/client/l;
...
.method protected abstract d()Lcom/twitter/library/client/l;
.end method
...
.method f()Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, v2}, Lcom/twitter/android/ek;->a(I)Lcom/twitter/library/client/ax;
    ...
    invoke-virtual {p0, v1}, Lcom/twitter/android/AbsTabbedPageFragmentActivity;->a(Lcom/twitter/library/client/ax;)Landroid/support/v4/app/Fragment;
...
.method protected onPause()V
    ...
    invoke-virtual {v1}, Lcom/twitter/android/ek;->c()Landroid/net/Uri;
