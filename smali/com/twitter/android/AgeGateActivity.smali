...
.method public a(Lcyd;)Z
    ...
    .line 80
    invoke-direct {p0}, Lcom/twitter/android/AgeGateActivity;->i()Z
    ...
    .line 81
    invoke-virtual {p0}, Lcom/twitter/android/AgeGateActivity;->ac()Lcom/twitter/library/client/Session;

    move-result-object v3

    .line 82
    iget-object v0, p0, Lcom/twitter/android/AgeGateActivity;->J:Lcom/twitter/library/client/bd;
    ...
    iget-object v6, p0, Lcom/twitter/android/AgeGateActivity;->e:Lcss;

    invoke-direct/range {v1 .. v6}, Lbtz;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;JLcss;)V

    .line 84
    invoke-virtual {v1, v7}, Lbtz;->d(Z)Lbtz;

    move-result-object v1

    .line 85
    invoke-virtual {v1, v7}, Lbtz;->c(Z)Lbtz;
    ...
    invoke-virtual {v0}, Lcom/twitter/android/client/bz;->a()V
...
.method public b(Landroid/os/Bundle;Lcom/twitter/app/common/base/y;)V
    ...
    .line 147
    invoke-virtual {p0}, Lcom/twitter/android/AgeGateActivity;->M()Lcom/twitter/android/client/SearchSuggestionController;
    ...
    invoke-direct {v2, p0}, Lcom/twitter/android/w;-><init>(Lcom/twitter/android/AgeGateActivity;)V
    ...
    invoke-virtual {v2, v1}, Lcsu;->a(Ljava/lang/String;)Lcsu;
    ...
    invoke-virtual {v1, v0}, Lcsu;->b(Ljava/lang/String;)Lcsu;

    .line 177
    :cond_1
    invoke-virtual {v1}, Lcsu;->q()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcss;

    iput-object v0, p0, Lcom/twitter/android/AgeGateActivity;->e:Lcss;
