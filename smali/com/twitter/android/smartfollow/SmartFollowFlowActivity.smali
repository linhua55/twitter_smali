...
# instance fields
.field private final a:Lcom/twitter/android/smartfollow/r;
...
.method public constructor <init>()V
    ...
    .line 42
    new-instance v0, Lcom/twitter/android/smartfollow/s;

    invoke-direct {v0, p0}, Lcom/twitter/android/smartfollow/s;-><init>(Lcom/twitter/app/common/base/BaseFragmentActivity;)V

    iput-object v0, p0, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->a:Lcom/twitter/android/smartfollow/r;
...
.method protected A_()V
    ...
    .line 238
    :cond_0
    invoke-super {p0}, Lcom/twitter/android/twitterflows/TwitterFlowsActivity;->A_()V

    .line 239
    return-void
.end method

.method protected a(Lcom/twitter/app/common/inject/t;)Lcom/twitter/android/smartfollow/ab;
    .locals 3
    ...
    new-instance v1, Lcom/twitter/android/smartfollow/t;
    ...
    invoke-direct {v1, p1, v2}, Lcom/twitter/android/smartfollow/t;-><init>(Lcom/twitter/app/common/inject/t;I)V

    .line 127
    invoke-virtual {v0, v1}, Lcom/twitter/android/smartfollow/i;->a(Lcom/twitter/android/smartfollow/t;)Lcom/twitter/android/smartfollow/i;
    ...
    .line 130
    invoke-virtual {v0}, Lcom/twitter/android/smartfollow/i;->a()Lcom/twitter/android/smartfollow/ab;
...
.method public a(Landroid/os/Bundle;Lcom/twitter/app/common/base/y;)Lcom/twitter/app/common/base/y;
    ...
    .prologue
    .line 64
    invoke-super {p0, p1, p2}, Lcom/twitter/android/twitterflows/TwitterFlowsActivity;->a(Landroid/os/Bundle;Lcom/twitter/app/common/base/y;)Lcom/twitter/app/common/base/y;
...
.method public a(Landroid/os/Bundle;Lcom/twitter/library/client/d;)V
    ...
    invoke-direct {v0}, Lcom/twitter/android/smartfollow/af;-><init>()V

    iput-object v0, p0, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->e:Lcom/twitter/android/twitterflows/a;

    .line 89
    :goto_1
    invoke-virtual {p0}, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->T()Lcom/twitter/app/common/inject/o;

    move-result-object v5

    .line 90
    invoke-virtual {p0}, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->U()Lcom/twitter/app/common/inject/b;

    move-result-object v0

    check-cast v0, Lcom/twitter/android/smartfollow/ab;
    ...
    .line 92
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->c()Lcom/twitter/android/smartfollow/finishingtimeline/a;
    ...
    .line 93
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->d()Lcom/twitter/android/smartfollow/followpeople/e;
    ...
    .line 94
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->e()Lcom/twitter/android/smartfollow/followpeople/a;
    ...
    .line 95
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->f()Lcom/twitter/android/smartfollow/interestpicker/a;
    ...
    .line 96
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->j()Lcom/twitter/android/smartfollow/importcontacts/a;
    ...
    .line 97
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->g()Lcom/twitter/android/smartfollow/sharelocation/a;
    ...
    .line 98
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->h()Lcom/twitter/android/smartfollow/waitingforsuggestions/d;
    ...
    .line 99
    invoke-interface {v0}, Lcom/twitter/android/smartfollow/ab;->i()Lcom/twitter/android/smartfollow/waitingforsuggestions/a;
    ...
    .line 103
    iget-object v9, p0, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->a:Lcom/twitter/android/smartfollow/r;

    invoke-virtual {v1, v9}, Lcom/twitter/android/smartfollow/b;->a(Lcom/twitter/android/smartfollow/r;)V
    ...
    .line 111
    invoke-virtual {v5, v1}, Lcom/twitter/app/common/inject/o;->a(Ljava/lang/Object;)Lcom/twitter/app/common/inject/o;

    .line 112
    invoke-virtual {v1}, Lcom/twitter/android/smartfollow/b;->aO_()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v7, v9, v1}, Lcom/twitter/util/collection/v;->b(Ljava/lang/Object;Ljava/lang/Object;)Lcom/twitter/util/collection/v;
    ...
    invoke-direct {v0}, Lcom/twitter/android/smartfollow/ai;-><init>()V
    ...
    .line 114
    :cond_2
    invoke-virtual {v7}, Lcom/twitter/util/collection/v;->q()Ljava/lang/Object;
...
.method public a(Lflow/f;Lflow/g;)V
    ...
    .line 171
    invoke-virtual {p0}, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->P()Lcom/twitter/app/common/base/y;

    move-result-object v0

    invoke-virtual {v0}, Lcom/twitter/app/common/base/y;->a()Z
    ...
    .line 173
    invoke-virtual {p0}, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->A_()V
    ...
    .line 207
    invoke-direct {p0}, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->h()V
...
.method protected synthetic c(Lcom/twitter/app/common/inject/t;)Lcom/twitter/app/common/inject/b;
    ...
    .prologue
    .line 39
    invoke-virtual {p0, p1}, Lcom/twitter/android/smartfollow/SmartFollowFlowActivity;->a(Lcom/twitter/app/common/inject/t;)Lcom/twitter/android/smartfollow/ab;
...
.method public onPause()V
    ...
    invoke-virtual {v0}, Lcom/twitter/android/smartfollow/b;->p()V
