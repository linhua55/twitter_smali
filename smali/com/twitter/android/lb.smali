.class public Lcom/twitter/android/lb;
.super Ljava/lang/Object;
.source "Twttr"


# static fields
.field private static a:Lcom/twitter/android/lb;
...
.method public static declared-synchronized a()Lcom/twitter/android/lb;
    .locals 2

    .prologue
    .line 33
    const-class v1, Lcom/twitter/android/lb;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/twitter/android/lb;->a:Lcom/twitter/android/lb;
    ...
    invoke-direct {v0}, Lcom/twitter/android/lb;-><init>()V
    :try_end_0
    ...
    sput-object v0, Lcom/twitter/android/lb;->a:Lcom/twitter/android/lb;
...
.method private static b(ILandroid/app/Activity;[Ljava/lang/String;)V
    ...
    .line 192
    :cond_0
    instance-of v1, p1, Lcom/twitter/android/kz;

    if-eqz v1, :cond_1

    .line 194
    check-cast p1, Lcom/twitter/android/kz;

    invoke-interface {p1, p0, p2, v0}, Lcom/twitter/android/kz;->onRequestPermissionsResult(I[Ljava/lang/String;[I)V
...
.method public varargs a(ILandroid/app/Activity;[Ljava/lang/String;)V
    ...
    .prologue
    .line 122
    invoke-virtual {p0}, Lcom/twitter/android/lb;->b()Z
    ...
    .line 123
    invoke-virtual {p0, p2, p3}, Lcom/twitter/android/lb;->c(Landroid/content/Context;[Ljava/lang/String;)[[Ljava/lang/String;
    ...
    .line 125
    invoke-static {p1, p2, p3}, Lcom/twitter/android/lb;->b(ILandroid/app/Activity;[Ljava/lang/String;)V
