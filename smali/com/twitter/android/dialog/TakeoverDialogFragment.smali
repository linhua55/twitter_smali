...
.method private m()V
    ...
    invoke-static {v1}, Lcom/twitter/util/ui/r;->b(Landroid/view/View;)Ljava/util/List;
...
.method protected a(Landroid/app/Dialog;Landroid/os/Bundle;)V
    ...
    .line 88
    new-instance v8, Lcdz;

    invoke-direct {v8}, Lcdz;-><init>()V
    ...
    .line 93
    invoke-virtual {v2, v7}, Lcj;->b(Ljava/lang/Object;)Lcp;
    ...
    .line 94
    invoke-virtual {v2, v7}, Lcj;->a(Ljava/lang/Object;)Lcp;
    ...
    .line 95
    invoke-virtual {v2, v4}, Lcj;->a(Z)Lcp;

    move-result-object v2

    check-cast v2, Lcj;

    new-instance v7, Lcom/twitter/library/media/fresco/p;

    invoke-direct {v7, v9, v10}, Lcom/twitter/library/media/fresco/p;-><init>(Lcom/twitter/media/request/a;Lcom/twitter/library/media/fresco/g;)V

    .line 98
    invoke-virtual {v7, v8}, Lcom/twitter/library/media/fresco/p;->c(Lcdz;)Lcom/twitter/library/media/fresco/p;

    move-result-object v7

    .line 99
    invoke-virtual {v7}, Lcom/twitter/library/media/fresco/p;->a()Lcom/twitter/library/media/fresco/n;

    move-result-object v7

    .line 96
    invoke-virtual {v2, v7}, Lcj;->a(Lct;)Lcp;
    ...
    .line 101
    invoke-virtual {v2}, Lcj;->h()Lcm;

    move-result-object v7

    .line 103
    invoke-virtual {v0}, Lcom/facebook/drawee/view/SimpleDraweeView;->getHierarchy()Lcy;
    ...
    .line 105
    invoke-virtual {v0, v7}, Lcom/facebook/drawee/view/SimpleDraweeView;->setController(Lcx;)V
