...
.field private l:Lcvw;


# direct methods
.method public constructor <init>(Landroid/support/v4/app/FragmentActivity;Lcom/twitter/android/moments/ui/animation/c;Lcvy;Ljava/lang/String;Lcom/twitter/util/math/Size;Lcom/twitter/model/moments/k;Landroid/view/ViewGroup;Landroid/view/View;)V
    .locals 2
    ...
    .line 119
    iput-object p3, p0, Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition;->f:Lcvy;
...
.method public static a(Landroid/content/Intent;Lcom/twitter/model/moments/ad;Lcom/twitter/util/math/Size;Ljava/lang/String;Lcom/twitter/model/moments/k;Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition$Type;)Landroid/content/Intent;
    .locals 2
    ...
    invoke-static {p0, v0, p1, v1}, Lcom/twitter/util/aa;->a(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Object;Lcom/twitter/util/serialization/ah;)Landroid/content/Intent;
    ...
    sget-object v1, Lcom/twitter/model/moments/k;->a:Lcom/twitter/util/serialization/ah;

    invoke-static {p0, v0, p4, v1}, Lcom/twitter/util/aa;->a(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Object;Lcom/twitter/util/serialization/ah;)Landroid/content/Intent;
    ...
    invoke-static {p0, v0, p5, v1}, Lcom/twitter/util/aa;->a(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/Object;Lcom/twitter/util/serialization/ah;)Landroid/content/Intent;
...
.method public static a(Landroid/support/v4/app/FragmentActivity;Landroid/content/Intent;Landroid/view/ViewGroup;)Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition;
    ...
    invoke-static {v7}, Lajp;->a(Landroid/view/LayoutInflater;)Lajp;
    ...
    invoke-direct {v8, v9, v7}, Lajr;-><init>(Landroid/content/res/Resources;Lajp;)V

    .line 93
    invoke-virtual {v8, v0, v1}, Lajr;->a(Lcom/twitter/model/moments/ad;Lcom/twitter/model/core/Tweet;)V
...
.method static synthetic e(Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition;)Lcvy;
    .locals 1

    .prologue
    .line 40
    iget-object v0, p0, Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition;->f:Lcvy;

    return-object v0
.end method

.method static synthetic f(Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition;)Lcvw;
    .locals 1

    .prologue
    .line 40
    iget-object v0, p0, Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition;->l:Lcvw;
...
.method public a(Lcvw;)V
    ...
    .line 147
    iput-object p1, p0, Lcom/twitter/android/moments/ui/animation/MomentsActivityTransition;->l:Lcvw;
    ...
    .line 157
    invoke-virtual {v0, v5}, Lcom/twitter/media/request/b;->e(Z)Lcom/twitter/media/request/h;
    ...
    .line 158
    invoke-virtual {v0, v4}, Lcom/twitter/media/request/b;->f(Z)Lcom/twitter/media/request/h;
