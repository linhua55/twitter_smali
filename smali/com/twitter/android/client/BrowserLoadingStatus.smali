...
.field private d:Lcom/twitter/library/client/BrowserDataSource;
...
.method private a(Ljava/lang/String;Landroid/app/Activity;)V
    ...
    .line 195
    invoke-static {p2}, Lcom/twitter/library/client/am;->a(Landroid/content/Context;)Lcom/twitter/library/client/am;
    ...
    iget-object v3, p0, Lcom/twitter/android/client/BrowserLoadingStatus;->d:Lcom/twitter/library/client/BrowserDataSource;

    .line 196
    invoke-virtual {v0, p2, v1, v2, v3}, Lcom/twitter/library/client/am;->a(Landroid/app/Activity;Ljava/lang/String;Landroid/support/customtabs/CustomTabsIntent;Lcom/twitter/library/client/BrowserDataSource;)V
...
.method private b()V
    ...
    .line 211
    iput-object v1, p0, Lcom/twitter/android/client/BrowserLoadingStatus;->d:Lcom/twitter/library/client/BrowserDataSource;
...
.method static synthetic c(Lcom/twitter/android/client/BrowserLoadingStatus;)Lcom/twitter/library/client/BrowserDataSource;
    .locals 1

    .prologue
    .line 32
    iget-object v0, p0, Lcom/twitter/android/client/BrowserLoadingStatus;->d:Lcom/twitter/library/client/BrowserDataSource;
...
# virtual methods
.method public a(Landroid/support/customtabs/CustomTabsIntent;Ljava/lang/String;Lcom/twitter/library/client/BrowserDataSource;Landroid/app/Activity;)V
    .locals 5
    ...
    .line 109
    invoke-static {p4}, Lcom/twitter/library/client/am;->a(Landroid/content/Context;)Lcom/twitter/library/client/am;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcom/twitter/library/client/am;->a(Ljava/lang/String;)Z
    ...
    .line 112
    iput-object p3, p0, Lcom/twitter/android/client/BrowserLoadingStatus;->d:Lcom/twitter/library/client/BrowserDataSource;
    ...
    .line 124
    new-instance v4, Lcom/twitter/android/client/j;

    invoke-direct {v4, p0, p2, p4}, Lcom/twitter/android/client/j;-><init>(Lcom/twitter/android/client/BrowserLoadingStatus;Ljava/lang/String;Landroid/app/Activity;)V
    ...
    .line 133
    invoke-virtual {v0, p4, p2, p1, p3}, Lcom/twitter/library/client/am;->a(Landroid/app/Activity;Ljava/lang/String;Landroid/support/customtabs/CustomTabsIntent;Lcom/twitter/library/client/BrowserDataSource;)V
...
.method public a(Landroid/view/View;Landroid/app/Activity;)V
    ...
    new-instance v2, Lcom/twitter/android/client/k;

    invoke-direct {v2, p0, p2}, Lcom/twitter/android/client/k;-><init>(Lcom/twitter/android/client/BrowserLoadingStatus;Landroid/app/Activity;)V
    ...
    .line 168
    new-instance v1, Lcom/twitter/android/client/l;

    invoke-direct {v1, p0}, Lcom/twitter/android/client/l;-><init>(Lcom/twitter/android/client/BrowserLoadingStatus;)V
