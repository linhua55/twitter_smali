...
# static fields
.field private static a:Lcom/twitter/android/client/cd;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 43
    iput-object p1, p0, Lcom/twitter/android/client/cd;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/twitter/android/client/cd;->c:Ljava/util/HashMap;

    .line 45
    return-void
.end method

.method public static declared-synchronized a(Landroid/content/Context;)Lcom/twitter/android/client/cd;
    .locals 3

    .prologue
    .line 36
    const-class v1, Lcom/twitter/android/client/cd;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/twitter/android/client/cd;->a:Lcom/twitter/android/client/cd;

    if-nez v0, :cond_0

    .line 37
    new-instance v0, Lcom/twitter/android/client/cd;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v0, v2}, Lcom/twitter/android/client/cd;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/twitter/android/client/cd;->a:Lcom/twitter/android/client/cd;
...
# virtual methods
.method public a(J)Lcom/twitter/android/client/WidgetControl;
    .locals 3

    .prologue
    .line 135
    iget-object v1, p0, Lcom/twitter/android/client/cd;->c:Ljava/util/HashMap;

    monitor-enter v1

    .line 136
    :try_start_0
    iget-object v0, p0, Lcom/twitter/android/client/cd;->c:Ljava/util/HashMap;
...
.method a()V
    ...
    .line 103
    iget-boolean v0, p0, Lcom/twitter/android/client/cd;->d:Z
    ...
    .line 109
    iget-object v3, p0, Lcom/twitter/android/client/cd;->c:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/twitter/android/client/cd;->b:Landroid/content/Context;
    ...
    .line 116
    iget-object v4, p0, Lcom/twitter/android/client/cd;->c:Ljava/util/HashMap;
    ...
    iput-boolean v0, p0, Lcom/twitter/android/client/cd;->d:Z
...
.method a(Landroid/content/Intent;)V
    ...
    .line 78
    invoke-virtual {p0, v0, v1}, Lcom/twitter/android/client/cd;->a(J)Lcom/twitter/android/client/WidgetControl;
...
.method b(Landroid/content/Intent;)V
    ...
    invoke-virtual {v2, v3}, Lcom/twitter/android/client/WidgetControl;->c(I)V
