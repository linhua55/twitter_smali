...
.method private a(Lcom/twitter/android/client/y;Lcom/twitter/media/request/a;)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/twitter/android/client/ac;-><init>(IZ)V

    .line 205
    invoke-virtual {p1, p2, v0}, Lcom/twitter/android/client/y;->a(Lcom/twitter/media/request/a;Lcom/twitter/android/client/ac;)Landroid/graphics/Bitmap;
...
.method private b(Z)Landroid/app/PendingIntent;
    ...
    iget-object v3, p0, Lcom/twitter/android/client/notifications/StoriesNotif;->a:Lcom/twitter/library/platform/notifications/ae;

    iget-object v3, v3, Lcom/twitter/library/platform/notifications/ae;->m:Ljava/lang/String;
...
.method public a(Landroid/content/Context;Lcom/twitter/android/client/y;Lcom/twitter/android/client/af;Landroid/graphics/Bitmap;)Landroid/app/Notification;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/twitter/android/client/notifications/af;-><init>(Lcom/twitter/android/client/y;Lcom/twitter/android/client/notifications/StoriesNotif;Landroid/content/Context;J)V
    ...
    invoke-direct {p0, p2, v0}, Lcom/twitter/android/client/notifications/StoriesNotif;->a(Lcom/twitter/android/client/y;Lcom/twitter/media/request/a;)V
    ...
    .line 300
    invoke-virtual {p0}, Lcom/twitter/android/client/notifications/StoriesNotif;->az_()Ljava/lang/String;
    ...
    .line 303
    invoke-static {p1, v1, p3}, Lcom/twitter/android/client/notifications/StoriesNotif;->a(Landroid/content/Context;Landroid/support/v4/app/NotificationCompat$Builder;Lcom/twitter/android/client/af;)V
...
.method public a(Landroid/content/Context;JLcom/twitter/android/client/notifications/ae;ZI)Landroid/content/Intent;
    ...
    iget-object v2, p0, Lcom/twitter/android/client/notifications/StoriesNotif;->a:Lcom/twitter/library/platform/notifications/ae;

    iget-object v2, v2, Lcom/twitter/library/platform/notifications/ae;->m:Ljava/lang/String;
...
.method protected aA_()Ljava/util/List;
    ...
    .prologue
    .line 120
    invoke-super {p0}, Lcom/twitter/android/client/notifications/GenericNotif;->aA_()Ljava/util/List;
