...
.method private static a(Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/library/service/aa;Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lcom/twitter/library/network/at;->a(Lcom/twitter/library/service/aa;)Z
    ...
    .line 990
    invoke-static {v4}, Lcom/twitter/android/client/bz;->a(Landroid/content/Context;)Lcom/twitter/android/client/bz;

    move-result-object v0

    invoke-virtual {v0, v1, p1}, Lcom/twitter/android/client/bz;->a(Lcom/twitter/library/client/Session;Lcom/twitter/library/service/aa;)V
    ...
    .line 993
    invoke-static {v4}, Lcom/twitter/android/client/y;->a(Landroid/content/Context;)Lcom/twitter/android/client/y;
...
.method private static b(Landroid/content/Context;JJ)V
    ...
    .line 763
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/twitter/library/provider/dm;->b(JJ)Ljava/lang/Long;
    ...
    invoke-virtual {v0, v2, v3, v4}, Lcom/twitter/library/provider/dm;->a(JLcom/twitter/library/provider/b;)I
    ...
    invoke-static {v0, v1}, Lcom/twitter/library/provider/cf;->a(J)V
...
.method static b(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    invoke-virtual {v2, v4, v5, v3, v6}, Lcom/twitter/library/provider/s;->a(JILcom/twitter/library/provider/b;)Z
...
.method private static e(Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/android/client/tweetuploadmanager/TweetUploadManager$TweetUploadState;)V
    ...
    .line 516
    invoke-virtual {v0}, Lcom/twitter/android/client/tweetuploadmanager/TweetUploadManager$TweetUploadState;->a()Lvv;

    move-result-object v1

    .line 518
    invoke-virtual {p0}, Lcom/twitter/android/client/tweetuploadmanager/c;->k()Lcom/twitter/util/y;

    move-result-object v2

    invoke-virtual {v1, p0, v2}, Lvv;->a(Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/util/y;)Lcom/twitter/util/concurrent/j;

    move-result-object v2

    .line 519
    invoke-virtual {p0, v1, v2}, Lcom/twitter/android/client/tweetuploadmanager/c;->a(Lvv;Lcom/twitter/util/concurrent/j;)V
...
.method private static g(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    .line 669
    invoke-static {v6, v8, v9}, Lcom/twitter/library/provider/s;->a(Landroid/content/Context;J)Lcom/twitter/library/provider/s;
    ...
    invoke-virtual {v0, v2, v3, v4, v5}, Lcom/twitter/library/provider/s;->a(JILcom/twitter/library/provider/b;)Z

    .line 673
    invoke-static {v6}, Lcom/twitter/android/client/y;->a(Landroid/content/Context;)Lcom/twitter/android/client/y;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/twitter/android/client/y;->a(Lcom/twitter/library/client/Session;JLjava/lang/String;I)Landroid/support/v4/app/NotificationCompat$Builder;

    .line 681
    invoke-static {v6, v8, v9}, Lcom/twitter/library/provider/dm;->a(Landroid/content/Context;J)Lcom/twitter/library/provider/dm;

    move-result-object v0

    .line 682
    invoke-virtual {v0, v8, v9, v2, v3}, Lcom/twitter/library/provider/dm;->b(JJ)Ljava/lang/Long;
    ...
    .line 683
    invoke-virtual {v0, v8, v9}, Lcom/twitter/library/provider/dm;->a(J)Lcom/twitter/model/core/TwitterUser;
    ...
    .line 688
    :cond_1
    invoke-virtual {v0, v1, v7}, Lcom/twitter/library/provider/dm;->a(Lcom/twitter/model/core/TwitterUser;Lcom/twitter/model/drafts/d;)Lcom/twitter/model/core/Tweet;

    move-result-object v0

    .line 689
    invoke-static {v0}, Lcom/twitter/library/provider/cf;->a(Lcom/twitter/model/core/Tweet;)V
...
.method private static i(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    .line 734
    invoke-virtual {v0}, Lcom/twitter/library/api/upload/am;->h()V
...
.method private static j(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    invoke-direct {v2, v0}, Lcom/twitter/library/provider/b;-><init>(Landroid/content/ContentResolver;)V
    ...
    invoke-virtual {v1, v4, v5, v2, v0}, Lcom/twitter/library/provider/s;->a(JLcom/twitter/library/provider/b;Z)Z
...
.method private static l(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    .line 779
    invoke-static {v7}, Lcom/twitter/android/client/y;->a(Landroid/content/Context;)Lcom/twitter/android/client/y;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/twitter/android/client/y;->b(Lcom/twitter/library/client/Session;JLjava/lang/String;I)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 792
    invoke-static {v7, v8, v9}, Lcom/twitter/library/provider/dm;->a(Landroid/content/Context;J)Lcom/twitter/library/provider/dm;
    ...
    invoke-virtual {v0, v4, v5, v1}, Lcom/twitter/library/provider/dm;->a(JLcom/twitter/library/provider/b;)I
    ...
    invoke-virtual {v0, v4, v5}, Lcom/twitter/library/provider/dm;->d(J)Lcom/twitter/model/core/Tweet;
    ...
    invoke-direct {v3, v1}, Lcom/twitter/android/client/tweetuploadmanager/f;-><init>(Lcom/twitter/library/provider/b;)V
    ...
    .line 808
    invoke-static {v4, v5, v0, v3}, Lcom/twitter/library/provider/cf;->a(JLcom/twitter/model/core/Tweet;Ljava/lang/Runnable;)Z
...
.method private static m(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    .line 842
    invoke-static {v8}, Lbjf;->a(Lbjh;)V
    ...
    .line 933
    invoke-static {v7}, Lcom/twitter/android/client/bz;->a(Landroid/content/Context;)Lcom/twitter/android/client/bz;

    move-result-object v0

    .line 934
    invoke-virtual {v0, v10}, Lcom/twitter/android/client/bz;->a([I)V
...
.method private static n(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    .line 976
    invoke-virtual {v0, v2, v3, v4, v5}, Lcom/twitter/android/client/y;->a(JJ)V
...
.method private static p(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    .line 1049
    iget-object v1, v0, Lcom/twitter/model/core/cs;->e:Lcom/twitter/model/core/bm;
    ...
    .line 1051
    iget-wide v0, v0, Lcom/twitter/model/core/cs;->k:J
