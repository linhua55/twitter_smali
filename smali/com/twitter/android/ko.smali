...
.field final b:Lcom/twitter/android/kq;

.field final c:Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/android/kq;Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;)V
    .locals 0
    ...
    .line 36
    iput-object p1, p0, Lcom/twitter/android/ko;->a:Landroid/content/Context;

    .line 37
    iput-object p2, p0, Lcom/twitter/android/ko;->b:Lcom/twitter/android/kq;

    .line 38
    iput-object p3, p0, Lcom/twitter/android/ko;->c:Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;
...
.method public static varargs a([Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p0}, Lcom/twitter/android/iz;->a(J[Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;)V
    ...
    .prologue
    .line 42
    iget-object v0, p0, Lcom/twitter/android/ko;->c:Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;

    invoke-static {v0}, Lzm;->a(Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/twitter/android/ko;->a:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/twitter/android/ko;->c:Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;

    .line 47
    invoke-static {v3}, Lzm;->a(Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {v0, v1, v2, p1, v3}, Lbll;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1}, Lcom/twitter/android/ko;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public b(ILcom/twitter/library/service/x;)V
    ...
    .line 82
    sget-object v1, Lcom/twitter/android/kp;->a:[I

    iget-object v4, p0, Lcom/twitter/android/ko;->c:Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;
    ...
    .line 97
    iget-object v0, p0, Lcom/twitter/android/ko;->b:Lcom/twitter/android/kq;

    iget-object v2, p0, Lcom/twitter/android/ko;->c:Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;

    invoke-interface {v0, v2, v3}, Lcom/twitter/android/kq;->a(Lcom/twitter/model/login/OneFactorEligibleFactor$FactorType;Lcom/twitter/model/login/a;)V
    ...
    .line 125
    invoke-static {v1, v0}, Lcom/twitter/android/ko;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v2}, Lcom/twitter/android/kq;->a(I)V
    ...
    .line 121
    :goto_3
    iget-object v2, p0, Lcom/twitter/android/ko;->b:Lcom/twitter/android/kq;

    invoke-interface {v2, v0}, Lcom/twitter/android/kq;->a(I)V
