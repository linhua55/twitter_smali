...
.method protected a(Lzz;Z)V
    ...
    .prologue
    .line 48
    invoke-super {p0, p1, p2}, Lcom/twitter/android/GalleryActivity;->a(Lzz;Z)V

    .line 50
    iget-object v0, p0, Lcom/twitter/android/FullscreenMediaPlayerActivity;->f:Lzv;

    iget v1, p1, Lzz;->a:I

    invoke-virtual {v0, v1}, Lzv;->a(I)Laab;
    ...
    .line 62
    invoke-virtual {p1}, Laaj;->f()Lcom/twitter/library/av/playback/AVPlayer;
    ...
    .line 64
    invoke-virtual {p0}, Lcom/twitter/android/FullscreenMediaPlayerActivity;->d()Lcom/twitter/android/av/GalleryVideoChromeView;
    ...
    invoke-direct {v1, v2, v0}, Lcom/twitter/library/av/am;-><init>(Lcom/twitter/library/av/playback/AVPlayer;Landroid/view/View;)V
...
.method public b(Landroid/os/Bundle;Lcom/twitter/app/common/base/y;)V
    ...
    .line 28
    invoke-super {p0, p1, p2}, Lcom/twitter/android/GalleryActivity;->b(Landroid/os/Bundle;Lcom/twitter/app/common/base/y;)V
