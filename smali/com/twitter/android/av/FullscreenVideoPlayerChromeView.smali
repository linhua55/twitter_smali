...
# interfaces
.implements Lcom/twitter/android/av/ao;


# instance fields
.field protected final l:Lcom/twitter/android/av/av;
...
.field protected o:Lcom/twitter/library/av/model/j;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v1, Lcom/twitter/android/av/av;

    invoke-direct {v1}, Lcom/twitter/android/av/av;-><init>()V

    invoke-direct {p0, p1, p2, v0, v1}, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/twitter/library/av/control/g;Lcom/twitter/android/av/av;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/twitter/android/av/av;)V
    ...
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/twitter/library/av/control/g;Lcom/twitter/android/av/av;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/twitter/library/av/control/g;Lcom/twitter/android/av/av;)V
    ...
    .line 73
    iput-object p4, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->l:Lcom/twitter/android/av/av;
...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/av/control/g;Lcom/twitter/android/av/av;)V
    .locals 1
    ...
    invoke-direct {p0, p1, v0, p2, p3}, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/twitter/library/av/control/g;Lcom/twitter/android/av/av;)V
...
.method private a(I)V
    ...
    .line 155
    :cond_0
    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->o:Lcom/twitter/library/av/model/j;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->o:Lcom/twitter/library/av/model/j;

    invoke-virtual {v0}, Lcom/twitter/library/av/model/j;->a()Z
...
.method private setupEngagementActionBar(Landroid/content/Context;)V
    ...
    .line 131
    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->l:Lcom/twitter/android/av/av;

    invoke-virtual {v0, p1, p0}, Lcom/twitter/android/av/av;->a(Landroid/content/Context;Landroid/view/ViewGroup;)Lcom/twitter/android/widget/EngagementActionBar;
...
.method protected H()Z
    ...
    invoke-virtual {v0, v1}, Lcom/twitter/android/av/av;->a(Landroid/content/Context;)Z
...
.method public a(Lcom/twitter/library/av/playback/AVPlayerAttachment;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/twitter/android/av/av;->a(Landroid/content/Context;Lcom/twitter/library/av/playback/AVPlayer;)V
...
.method protected a(Lcom/twitter/model/av/a;)V
    ...
    .prologue
    .line 346
    invoke-virtual {p0, p1}, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->b(Lcom/twitter/model/av/a;)Lcom/twitter/library/av/model/j;

    move-result-object v0

    iput-object v0, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->o:Lcom/twitter/library/av/model/j;
    ...
    .line 354
    iget-object v1, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->o:Lcom/twitter/library/av/model/j;

    invoke-virtual {v1}, Lcom/twitter/library/av/model/j;->c()Landroid/net/Uri;

    move-result-object v1

    .line 355
    iget-object v2, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->o:Lcom/twitter/library/av/model/j;

    invoke-virtual {v2, v0}, Lcom/twitter/library/av/model/j;->a(Landroid/content/Context;)Landroid/net/Uri;
    ...
    iget-object v4, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->o:Lcom/twitter/library/av/model/j;

    invoke-virtual {v4, v0}, Lcom/twitter/library/av/model/j;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->o:Lcom/twitter/library/av/model/j;

    invoke-virtual {v3, v0}, Lcom/twitter/library/av/model/j;->c(Landroid/content/Context;)Ljava/lang/String;
...
.method public a(Z)V
    ...
    invoke-virtual {v1}, Lcom/twitter/library/av/model/j;->a()Z
    ...
    invoke-virtual {v1, p1}, Lcom/twitter/library/av/model/j;->a(Z)Ljava/lang/String;
...
.method protected a(ZIIII)V
    ...
    .line 244
    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoPlayerChromeView;->h:Lcom/twitter/android/av/be;
...
.method protected b(Lcom/twitter/model/av/a;)Lcom/twitter/library/av/model/j;
    ...
    .prologue
    .line 370
    new-instance v0, Lcom/twitter/library/av/model/j;

    invoke-direct {v0, p1}, Lcom/twitter/library/av/model/j;-><init>(Lcom/twitter/model/av/a;)V
...
.method public b(Z)V
    ...
    :goto_0
    invoke-virtual {v2, v0}, Lcom/twitter/library/av/model/j;->b(Z)Ljava/lang/String;
...
.method protected setupInternalViews(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p0}, Lcom/twitter/android/av/ExternalActionButton;->setEventLister(Lcom/twitter/android/av/ao;)V
