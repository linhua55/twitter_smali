...
.field private i:Lcom/twitter/util/y;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/twitter/util/y",
            "<",
...
.method protected constructor <init>(Lcom/twitter/media/request/h;)V
    ...
    .line 32
    iget-object v0, p1, Lcom/twitter/media/request/h;->p:Ljava/lang/String;

    iput-object v0, p0, Lcom/twitter/media/request/g;->a:Ljava/lang/String;

    .line 33
    iget-object v0, p1, Lcom/twitter/media/request/h;->q:Ljava/lang/Object;

    iput-object v0, p0, Lcom/twitter/media/request/g;->b:Ljava/lang/Object;

    .line 34
    iget-boolean v0, p1, Lcom/twitter/media/request/h;->r:Z
    ...
    .line 37
    iget-object v0, p1, Lcom/twitter/media/request/h;->u:Lcom/twitter/media/request/i;

    iput-object v0, p0, Lcom/twitter/media/request/g;->h:Lcom/twitter/media/request/i;

    .line 38
    iget-object v0, p1, Lcom/twitter/media/request/h;->v:Ljava/lang/Object;

    iput-object v0, p0, Lcom/twitter/media/request/g;->j:Ljava/lang/Object;

    .line 39
    iget-object v0, p1, Lcom/twitter/media/request/h;->w:Lcom/twitter/media/request/ResourceRequestType;

    iput-object v0, p0, Lcom/twitter/media/request/g;->f:Lcom/twitter/media/request/ResourceRequestType;

    .line 40
    iget-object v0, p1, Lcom/twitter/media/request/h;->x:Ljava/lang/String;
...
.method public B()Lcom/twitter/media/request/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public a(Lcom/twitter/util/y;)V
    ...
    .prologue
    .line 120
    iput-object p1, p0, Lcom/twitter/media/request/g;->i:Lcom/twitter/util/y;
...
.method protected a(Lcom/twitter/media/request/g;)Z
    ...
    invoke-virtual {p0}, Lcom/twitter/media/request/g;->r()Ljava/lang/String;
...
.method public u()Lcom/twitter/util/y;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 73
    iget-object v0, p0, Lcom/twitter/media/request/g;->i:Lcom/twitter/util/y;
...
.method public y()Lcom/twitter/media/request/ResourceRequestType;
    .locals 1
