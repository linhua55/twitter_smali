...
.field private s:Lcom/twitter/util/y;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/twitter/util/y",
            "<",
...
.method private static b(Lcom/twitter/internal/network/g;)V
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/twitter/library/network/k;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method private d()Lcom/twitter/internal/network/HttpOperation;
    .locals 5

    .prologue
    .line 372
    invoke-static {}, Lcom/twitter/library/network/j;->e()Lcom/twitter/internal/network/g;
    ...
    invoke-static {v2, v3, v0}, Lcjw;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static declared-synchronized e()Lcom/twitter/internal/network/g;
    .locals 3
...
.method public a()Lcom/twitter/internal/network/HttpOperation;
    ...
    .prologue
    .line 305
    invoke-direct {p0}, Lcom/twitter/library/network/j;->d()Lcom/twitter/internal/network/HttpOperation;

    move-result-object v0

    .line 306
    iget-object v1, p0, Lcom/twitter/library/network/j;->s:Lcom/twitter/util/y;

    invoke-virtual {v0, v1}, Lcom/twitter/internal/network/HttpOperation;->a(Lcom/twitter/util/y;)V
    ...
    .line 311
    invoke-virtual {v1, v0}, Lcom/twitter/library/network/at;->c(Lcom/twitter/internal/network/HttpOperation;)V
    ...
    .line 313
    :cond_2
    invoke-virtual {v1, v0}, Lcom/twitter/library/network/at;->b(Lcom/twitter/internal/network/HttpOperation;)V
    ...
    .line 332
    :cond_5
    invoke-direct {p0}, Lcom/twitter/library/network/j;->f()Z
    ...
    .line 333
    new-instance v1, Lcom/twitter/library/network/ae;

    iget-object v2, p0, Lcom/twitter/library/network/j;->m:Lcom/twitter/library/network/a;

    invoke-direct {v1, v2}, Lcom/twitter/library/network/ae;-><init>(Lcom/twitter/library/network/a;)V
...
.method public a(Lcom/twitter/util/y;)Lcom/twitter/library/network/j;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 294
    iput-object p1, p0, Lcom/twitter/library/network/j;->s:Lcom/twitter/util/y;
