...
# interfaces
.implements Lcom/twitter/library/av/playback/bd;
...
.field private final c:Lbxa;

.field private final d:Lcom/twitter/library/av/playback/bd;
...
# direct methods
.method public constructor <init>(Lcom/twitter/library/av/playback/AVPlayer;Lbxa;Lcom/twitter/library/scribe/TwitterScribeAssociation;)V
    .locals 1

    .prologue
    .line 58
    new-instance v0, Lcom/twitter/library/av/playback/be;

    invoke-direct {v0, p1}, Lcom/twitter/library/av/playback/be;-><init>(Lcom/twitter/library/av/playback/AVPlayer;)V

    invoke-direct {p0, p1, p2, p3, v0}, Lcom/twitter/library/av/playback/AVPlayerAttachment;-><init>(Lcom/twitter/library/av/playback/AVPlayer;Lbxa;Lcom/twitter/library/scribe/TwitterScribeAssociation;Lcom/twitter/library/av/playback/bd;)V

    .line 59
    return-void
.end method

.method constructor <init>(Lcom/twitter/library/av/playback/AVPlayer;Lbxa;Lcom/twitter/library/scribe/TwitterScribeAssociation;Lcom/twitter/library/av/playback/bd;)V
    .locals 1
    ...
    .line 65
    iput-object p2, p0, Lcom/twitter/library/av/playback/AVPlayerAttachment;->c:Lbxa;
    ...
    .line 67
    iput-object p4, p0, Lcom/twitter/library/av/playback/AVPlayerAttachment;->d:Lcom/twitter/library/av/playback/bd;
...
.method public a(Lcom/twitter/library/av/s;)Lcom/twitter/library/av/playback/AVPlayerAttachment;
    ...
    .line 120
    invoke-static {p1}, Lcom/twitter/library/av/playback/ck;->a(Lcom/twitter/library/av/s;)Lcom/twitter/library/av/playback/ck;
...
.method public a(F)V
    ...
    .line 250
    iget-object v0, p0, Lcom/twitter/library/av/playback/AVPlayerAttachment;->d:Lcom/twitter/library/av/playback/bd;

    invoke-interface {v0, p1}, Lcom/twitter/library/av/playback/bd;->a(F)V
...
.method public a(Lcom/twitter/library/av/playback/AVPlayer$PlayerPauseType;)V
    ...
    invoke-interface {v0, p1}, Lcom/twitter/library/av/playback/bd;->a(Lcom/twitter/library/av/playback/AVPlayer$PlayerPauseType;)V
...
.method public a(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/twitter/library/av/playback/bd;->a(Z)V
...
.method public b()Lbxa;
    ...
    .prologue
    .line 77
    iget-object v0, p0, Lcom/twitter/library/av/playback/AVPlayerAttachment;->c:Lbxa;
...
.method public i()Lcom/twitter/library/av/playback/AVPlayerAttachment;
    ...
    invoke-virtual {v0}, Lcom/twitter/library/av/playback/AVPlayer;->f()Lcom/twitter/library/av/playback/ay;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/twitter/library/av/playback/ay;->c(Lcom/twitter/library/av/playback/AVPlayerAttachment;)Lcom/twitter/library/av/playback/ay;
...
.method public j()Lcom/twitter/library/av/playback/AVPlayerAttachment;
    ...
    invoke-virtual {v0, p0}, Lcom/twitter/library/av/playback/ay;->d(Lcom/twitter/library/av/playback/AVPlayerAttachment;)Lcom/twitter/library/av/playback/ay;
...
.method public k()V
    ...
    .line 193
    invoke-virtual {v0}, Lcom/twitter/library/av/playback/AVPlayer;->s()Lcom/twitter/library/av/playback/AVPlayer$PlayerPauseType;
...
.method public n()V
    ...
    invoke-interface {v0}, Lcom/twitter/library/av/playback/bd;->n()V
...
.method public o()V
    ...
    invoke-interface {v0}, Lcom/twitter/library/av/playback/bd;->o()V
...
.method public p()V
    ...
    invoke-interface {v0}, Lcom/twitter/library/av/playback/bd;->p()V
