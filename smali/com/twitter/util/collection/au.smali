.class public abstract Lcom/twitter/util/collection/au;
...
.method public static a(I)Lcom/twitter/util/collection/au;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0}, Lcom/twitter/util/collection/av;-><init>(I)V

    return-object v0
.end method

.method public static a(Ljava/util/Comparator;)Lcom/twitter/util/collection/au;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .prologue
    .line 53
    new-instance v0, Lcom/twitter/util/collection/aw;

    invoke-direct {v0, p0}, Lcom/twitter/util/collection/aw;-><init>(Ljava/util/Comparator;)V
...
.method public static varargs a(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-virtual {v0, p1}, Lcom/twitter/util/collection/au;->a([Ljava/lang/Object;)Lcom/twitter/util/collection/au;
...
.method public static a(Ljava/util/Comparator;Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 206
    :cond_1
    invoke-static {p0}, Lcom/twitter/util/collection/au;->a(Ljava/util/Comparator;)Lcom/twitter/util/collection/au;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/twitter/util/collection/au;->b(Ljava/lang/Iterable;)Lcom/twitter/util/collection/au;
...
.method public static a(Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 125
    :cond_2
    instance-of v1, p0, Lcom/twitter/util/collection/ax;
...
.method public static e()Lcom/twitter/util/collection/au;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static f()Lcom/twitter/util/collection/au;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    invoke-static {v0}, Lcom/twitter/util/collection/au;->a(Ljava/util/Comparator;)Lcom/twitter/util/collection/au;
...
# virtual methods
.method public final varargs a([Ljava/lang/Object;)Lcom/twitter/util/collection/au;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([TT;)",
    ...
    .line 263
    invoke-virtual {p0, v2}, Lcom/twitter/util/collection/au;->c(Ljava/lang/Object;)Lcom/twitter/util/collection/au;
...
.method public synthetic a(Ljava/lang/Object;)Lcom/twitter/util/collection/d;
    ...
    .prologue
    .line 19
    invoke-virtual {p0, p1}, Lcom/twitter/util/collection/au;->c(Ljava/lang/Object;)Lcom/twitter/util/collection/au;
...
.method public final b(Ljava/lang/Iterable;)Lcom/twitter/util/collection/au;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 277
    invoke-virtual {p0, v1}, Lcom/twitter/util/collection/au;->c(Ljava/lang/Object;)Lcom/twitter/util/collection/au;
...
.method public final c(Ljava/lang/Iterable;)Lcom/twitter/util/collection/au;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 303
    invoke-virtual {p0, v1}, Lcom/twitter/util/collection/au;->d(Ljava/lang/Object;)Lcom/twitter/util/collection/au;
...
.method public final c(Ljava/lang/Object;)Lcom/twitter/util/collection/au;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)",
    ...
    .line 238
    iget-object v0, p0, Lcom/twitter/util/collection/au;->c:Ljava/util/Set;
    ...
    .line 240
    :cond_0
    iget-object v0, p0, Lcom/twitter/util/collection/au;->a:Ljava/util/Set;
    ...
    .line 242
    :cond_2
    iget-object v0, p0, Lcom/twitter/util/collection/au;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lcom/twitter/util/collection/au;->b(I)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/twitter/util/collection/au;->a:Ljava/util/Set;

    .line 244
    iget-object v0, p0, Lcom/twitter/util/collection/au;->a:Ljava/util/Set;

    iget-object v1, p0, Lcom/twitter/util/collection/au;->b:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/twitter/util/collection/au;->b:Ljava/lang/Object;
    ...
    .line 248
    :cond_3
    iput-object p1, p0, Lcom/twitter/util/collection/au;->b:Ljava/lang/Object;
...
.method protected synthetic c()Ljava/lang/Object;
    ...
    .prologue
    .line 19
    invoke-virtual {p0}, Lcom/twitter/util/collection/au;->j()Ljava/util/Set;
...
.method public final d(Ljava/lang/Object;)Lcom/twitter/util/collection/au;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)",
...
.method public final i()Lcom/twitter/util/collection/au;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method protected j()Ljava/util/Set;
    ...
    .line 360
    iput-object v1, p0, Lcom/twitter/util/collection/au;->a:Ljava/util/Set;

    .line 367
    :goto_1
    iput-object v0, p0, Lcom/twitter/util/collection/au;->c:Ljava/util/Set;
    ...
    .line 363
    iput-object v1, p0, Lcom/twitter/util/collection/au;->b:Ljava/lang/Object;
