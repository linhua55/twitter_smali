...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/client/Session;[JZ)V
    ...
    iput-object v0, p0, Lbub;->b:Lcom/twitter/model/core/TwitterUser;

    .line 41
    iput-boolean p4, p0, Lbub;->c:Z

    .line 42
    invoke-virtual {p0}, Lbub;->N()Lcom/twitter/library/service/ab;

    move-result-object v0

    iput-object v0, p0, Lbub;->g:Lcom/twitter/library/service/ab;
...
.method protected a_(Lcom/twitter/library/service/aa;)V
    ...
    iget-object v7, p0, Lbub;->p:Landroid/content/Context;

    iget-object v8, p0, Lbub;->e:Ljava/lang/String;

    iget-object v9, p0, Lbub;->g:Lcom/twitter/library/service/ab;

    invoke-direct {v6, v7, v8, v9, v0}, Lbuv;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/twitter/library/service/ab;[J)V

    .line 60
    invoke-virtual {v6, p0}, Lbuv;->a(Lcom/twitter/library/service/x;)Lcom/twitter/library/service/x;
    ...
    .line 62
    invoke-virtual {v0}, Lbuv;->P()Lcom/twitter/library/service/aa;
    ...
    iget-object v2, p0, Lbub;->p:Landroid/content/Context;

    iget-object v6, p0, Lbub;->g:Lcom/twitter/library/service/ab;
    ...
    invoke-virtual {p0, v0}, Lbub;->b(Lcom/twitter/internal/android/service/AsyncOperation;)V
    ...
    iget-object v3, p0, Lbub;->g:Lcom/twitter/library/service/ab;

    iget-object v4, p0, Lbub;->b:Lcom/twitter/model/core/TwitterUser;

    invoke-direct {v0, v2, v3, v4, v1}, Lbsb;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/model/core/TwitterUser;I)V
