...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/client/Session;I)V
    ...
    invoke-direct {p0, p1, v0, p3}, Lbtw;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;I)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/service/ab;I)V
    ...
    iput-object v0, p0, Lbtw;->b:Ljava/util/List;
...
.method public a(Ljava/lang/String;J)Lbtw;
    .locals 0

    .prologue
    .line 65
    iput-object p1, p0, Lbtw;->j:Ljava/lang/String;

    .line 66
    iput-wide p2, p0, Lbtw;->c:J
...
.method protected a_(Lcom/twitter/library/service/aa;)V
    ...
    .line 79
    :goto_0
    invoke-virtual {p0}, Lbtw;->S()Lcom/twitter/library/provider/dm;
    ...
    iget-object v2, p0, Lbtw;->p:Landroid/content/Context;

    invoke-virtual {p0}, Lbtw;->N()Lcom/twitter/library/service/ab;
    ...
    invoke-direct/range {v1 .. v7}, Lbui;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;JILjava/lang/String;)V

    iget-object v0, p0, Lbtw;->j:Ljava/lang/String;

    .line 85
    invoke-virtual {v1, v0}, Lbui;->a(Ljava/lang/String;)Lbui;

    move-result-object v0

    .line 86
    invoke-virtual {v0, p0}, Lbui;->a(Lcom/twitter/library/service/x;)Lcom/twitter/library/service/x;
    ...
    .line 87
    invoke-virtual {v0}, Lbui;->P()Lcom/twitter/library/service/aa;
    ...
    .line 96
    iget-object v7, v0, Lbui;->b:Ljava/lang/String;
