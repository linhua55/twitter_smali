...
/* compiled from: Twttr */
/* renamed from: bi */
public class bi extends AbstractExecutorService implements bh {
    ...
    protected <T> bj<T> a(Runnable runnable, T t) {
        return new bj(this.a, runnable, t);
    }

    protected <T> bj<T> a(Callable<T> callable) {
        return new bj(this.a, callable);
    }
