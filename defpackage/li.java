...
/* renamed from: li */
public abstract class li extends Binder implements lh {
    public static lh a(IBinder iBinder) {
        ...
        return (queryLocalInterface == null || !(queryLocalInterface instanceof lh)) ? new lj(iBinder) : (lh) queryLocalInterface;
    }
