...
public class cvb {
    ...
    static {
        ...
        r0[cse.AppCompatTheme_buttonStyleSmall] = new String[]{"equiv", "8801"};
        r0[cse.AppCompatTheme_checkboxStyle] = new String[]{"le", "8804"};
        r0[cse.AppCompatTheme_checkedTextViewStyle] = new String[]{"ge", "8805"};
        r0[cse.AppCompatTheme_editTextStyle] = new String[]{"sub", "8834"};
        r0[cse.AppCompatTheme_radioButtonStyle] = new String[]{"sup", "8835"};
        r0[cse.AppCompatTheme_ratingBarStyle] = new String[]{"sube", "8838"};
        r0[cse.AppCompatTheme_ratingBarStyleIndicator] = new String[]{"supe", "8839"};
        r0[cse.AppCompatTheme_ratingBarStyleSmall] = new String[]{"oplus", "8853"};
        r0[cse.AppCompatTheme_seekBarStyle] = new String[]{"otimes", "8855"};
        r0[cse.AppCompatTheme_spinnerStyle] = new String[]{"perp", "8869"};
        r0[cse.AppCompatTheme_switchStyle] = new String[]{"sdot", "8901"};
        ...
        c = r0;
        d = new cvb().a(c).a(a).a(b);
    }

    public cvb a(String[][] strArr) {
    ...
    public cvg b(String str) {
        int length = str.length();
        StringBuilder stringBuilder = new StringBuilder(length);
        List a = MutableList.a(5);
        int i = 0;
        while (i < length) {
                    ...
                    if (length2 > 0) {
                        if (substring.charAt(0) != '#' || length2 <= 1) {
                            ...
                            if (length2 != -1) {
                                ...
                                stringBuilder.append((char) length2);
                                a.add(new int[]{i, indexOf});
                                length2 = indexOf;
                            }
                            i = length2;
                        } else {
                            ...
                            if (charAt2 != 'x' && charAt2 != 'X') {
                                length2 = Integer.parseInt(substring.substring(1));
                                if (length2 != -1) {
                                    stringBuilder.append('&');
                                    if (substring.indexOf(38) != -1) {
                                        stringBuilder.append(substring);
                                ...
                                try {
                                    length2 = Integer.valueOf(substring.substring(2), 16).intValue();
                                } catch (Exception e) {
                                    length2 = -1;
                                }
                                if (length2 != -1) {
        ...
        return new cvg(stringBuilder.toString(), a);
    }
}
