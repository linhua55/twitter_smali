...
.method public constructor <init>(Lorg/spongycastle/crypto/a;)V
    ...
    iput-object v0, p0, Ldij;->g:[B

    .line 47
    iput-object p1, p0, Ldij;->b:Lorg/spongycastle/crypto/a;

    .line 48
    invoke-direct {p0}, Ldij;->c()Z

    move-result v0

    iput-boolean v0, p0, Ldij;->e:Z
...
.method private b([BII)[B
    ...
    .line 189
    :cond_0
    iget-object v1, p0, Ldij;->b:Lorg/spongycastle/crypto/a;
    ...
    .line 202
    :cond_1
    iget-object v2, p0, Ldij;->a:Ljava/security/SecureRandom;
    ...
    .line 222
    iget-object v0, p0, Ldij;->b:Lorg/spongycastle/crypto/a;
...
.method private c()Z
    ...
    invoke-direct {v0, p0}, Ldik;-><init>(Ldij;)V
...
.method private c([BII)[B
    ...
    .line 295
    iget-object v1, p0, Ldij;->a:Ljava/security/SecureRandom;
    ...
    .line 317
    :cond_2
    iget-boolean v1, p0, Ldij;->e:Z

    if-eqz v1, :cond_3

    array-length v1, v2

    iget-object v3, p0, Ldij;->b:Lorg/spongycastle/crypto/a;
    ...
    invoke-static {v2, v1}, Ldij;->a([BI)I
...
.method private d([BII)[B
    ...
    .line 354
    invoke-direct {p0, p1, p2, p3}, Ldij;->c([BII)[B
    ...
    .line 381
    :cond_3
    iget-boolean v0, p0, Ldij;->e:Z

    if-eqz v0, :cond_4

    array-length v0, v2

    iget-object v4, p0, Ldij;->b:Lorg/spongycastle/crypto/a;
...
.method public a(ZLorg/spongycastle/crypto/c;)V
    ...
    .line 119
    invoke-virtual {v0}, Ldin;->a()Ljava/security/SecureRandom;

    move-result-object v1

    iput-object v1, p0, Ldij;->a:Ljava/security/SecureRandom;

    .line 120
    invoke-virtual {v0}, Ldin;->b()Lorg/spongycastle/crypto/c;
    ...
    iput-object v0, p0, Ldij;->a:Ljava/security/SecureRandom;
...
.method public a([BII)[B
    ...
    .prologue
    .line 168
    iget-boolean v0, p0, Ldij;->c:Z

    if-eqz v0, :cond_0

    .line 170
    invoke-direct {p0, p1, p2, p3}, Ldij;->b([BII)[B
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Ldij;->d([BII)[B
