...
# direct methods
.method constructor <init>(Landroid/content/Context;Lcom/twitter/library/client/Session;Lcom/twitter/model/drafts/d;Ljava/util/LinkedHashMap;Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/util/y;Lcom/twitter/util/concurrent/ObservablePromise;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v6}, Lvq;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;Lcom/twitter/model/drafts/d;Ljava/util/LinkedHashMap;Ljava/lang/String;Lcom/twitter/util/y;)V

    .line 131
    iput-object p5, p0, Lwn;->a:Lcom/twitter/android/client/tweetuploadmanager/c;

    .line 132
    iput-object p7, p0, Lwn;->b:Lcom/twitter/util/concurrent/ObservablePromise;
...
.method public a(Lcom/twitter/internal/android/service/ab;)V
    ...
    .line 137
    invoke-super {p0, p1}, Lvq;->a(Lcom/twitter/internal/android/service/ab;)V

    .line 139
    iget-object v0, p0, Lwn;->a:Lcom/twitter/android/client/tweetuploadmanager/c;
    ...
    .line 142
    invoke-static {v0}, Lvv;->a(Lcom/twitter/library/service/aa;)Z
    ...
    .line 144
    iget-object v2, p0, Lwn;->o:Landroid/os/Bundle;

    invoke-static {v2}, Lcom/twitter/library/network/at;->a(Landroid/os/Bundle;)[I
    ...
    .line 149
    invoke-virtual {p0}, Lwn;->a()Lcom/twitter/model/core/cs;
    ...
    .line 151
    iget-object v1, p0, Lwn;->a:Lcom/twitter/android/client/tweetuploadmanager/c;

    invoke-virtual {v1, v2}, Lcom/twitter/android/client/tweetuploadmanager/c;->a(Lcom/twitter/model/core/cs;)V

    .line 152
    iget-object v1, p0, Lwn;->b:Lcom/twitter/util/concurrent/ObservablePromise;
    ...
    iget-object v2, p0, Lwn;->a:Lcom/twitter/android/client/tweetuploadmanager/c;
