...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lsj;J)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lsn;-><init>(Landroid/content/Context;IIZLsj;)V

    .line 60
    iput-wide p3, p0, Lry;->c:J

    .line 61
    return-void
.end method

.method static a(Ljava/lang/String;Lcom/twitter/library/provider/fl;Ljava/util/List;JI)Lcmf;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 80
    invoke-static {p0}, Lry;->b(Ljava/lang/String;)Z

    move-result v0

    .line 81
    invoke-static {p0}, Lry;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 84
    invoke-static {p2, v2, p3, p4, v0}, Lry;->a(Ljava/util/List;Ljava/lang/String;JZ)Ljava/util/List;
    ...
    .line 86
    invoke-static {v1}, Lry;->a(Ljava/lang/Iterable;)Ljava/util/Set;

    move-result-object v3

    .line 89
    invoke-virtual {v1}, Lcom/twitter/util/collection/r;->i()I
    ...
    .line 90
    invoke-interface {p1, v2, v0, v4}, Lcom/twitter/library/provider/fl;->a(Ljava/lang/String;II)Ljava/util/List;
    ...
    .line 105
    invoke-static {v0, v4}, Lczz;->a(Ljava/lang/Iterable;Ldau;)Ljava/lang/Iterable;
    ...
    invoke-static {v1, p5}, Lczz;->a(Ljava/lang/Iterable;I)Ljava/lang/Iterable;
    ...
    sget-object v2, Lcjh;->b:Ljava/util/regex/Pattern;
...
.method private static a(Ljava/util/List;Ljava/lang/String;JZ)Ljava/util/List;
    ...
    invoke-virtual {v0, v3}, Lcom/twitter/util/collection/r;->c(Ljava/lang/Iterable;)Lcom/twitter/util/collection/r;

    move-result-object v0

    invoke-virtual {v0, v4}, Lcom/twitter/util/collection/r;->c(Ljava/lang/Iterable;)Lcom/twitter/util/collection/r;
...
.method private declared-synchronized a(Lcom/twitter/library/provider/g;)V
    .locals 1
    ...
    :try_start_0
    iget-object v0, p0, Lry;->d:Ljava/util/List;
    ...
    invoke-interface {p1, v0}, Lcom/twitter/library/provider/g;->a(Z)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lry;->d:Ljava/util/List;
    :try_end_0
...
# virtual methods
.method protected synthetic a(Ljava/lang/Object;Z)Lcmf;
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Lry;->b(Ljava/lang/String;Z)Lcmf;
...
.method protected bridge synthetic a(Ljava/lang/Object;Lcom/twitter/library/api/search/TwitterTypeAheadGroup;)V
    ...
    invoke-virtual {p0, p1, p2}, Lry;->a(Ljava/lang/String;Lcom/twitter/library/api/search/TwitterTypeAheadGroup;)V
...
.method protected a(Ljava/lang/String;Lcom/twitter/library/api/search/TwitterTypeAheadGroup;)V
    ...
    .prologue
    .line 216
    invoke-virtual {p0, p1}, Lry;->d(Ljava/lang/String;)Ljava/lang/String;
...
.method protected synthetic a(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lry;->c(Ljava/lang/String;)Z
...
.method protected b(Ljava/lang/String;Z)Lcmf;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 72
    invoke-direct {p0, v2}, Lry;->a(Lcom/twitter/library/provider/g;)V

    .line 74
    iget-object v3, p0, Lry;->d:Ljava/util/List;

    iget-wide v4, p0, Lry;->c:J

    iget v6, p0, Lry;->b:I

    move-object v1, p1

    invoke-static/range {v1 .. v6}, Lry;->a(Ljava/lang/String;Lcom/twitter/library/provider/fl;Ljava/util/List;JI)Lcmf;
