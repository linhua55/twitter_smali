...
# static fields
.field private static final c:Lcom/twitter/util/collection/ac;
...
.field private static final d:Lcom/twitter/util/collection/ac;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/twitter/util/collection/ac",
            "<",
...
.field private g:Lcom/twitter/util/y;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/twitter/util/y",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lwe;->c:Lcom/twitter/util/collection/ac;
    ...
    sput-object v0, Lwe;->d:Lcom/twitter/util/collection/ac;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lwe;->a:Lcom/twitter/util/concurrent/ObservablePromise;
    ...
    iput-object v0, p0, Lwe;->e:Ljava/lang/Object;
...
.method private static a(Lcom/twitter/model/media/EditableMedia;)Ljava/util/List;
    ...
    .line 231
    :pswitch_0
    sget-object v0, Lwe;->c:Lcom/twitter/util/collection/ac;
    ...
    invoke-virtual {p0}, Lcom/twitter/model/media/EditableSegmentedVideo;->b()Z
    ...
    .line 236
    sget-object v1, Lwe;->c:Lcom/twitter/util/collection/ac;

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 237
    sget-object v1, Lwe;->d:Lcom/twitter/util/collection/ac;
...
.method public static b(Lcom/twitter/android/client/tweetuploadmanager/c;)Z
    ...
    .line 194
    invoke-virtual {v0}, Lcom/twitter/library/api/upload/am;->d()Z
...
.method private d(Lcom/twitter/android/client/tweetuploadmanager/c;)V
    ...
    .prologue
    .line 100
    iget-object v0, p0, Lwe;->f:Lcom/twitter/android/client/tweetuploadmanager/c;
    ...
    iget-object v1, p0, Lwe;->a:Lcom/twitter/util/concurrent/ObservablePromise;
    ...
    .line 105
    iget-object v1, p0, Lwe;->f:Lcom/twitter/android/client/tweetuploadmanager/c;
    ...
    .line 106
    iget-object v2, p0, Lwe;->f:Lcom/twitter/android/client/tweetuploadmanager/c;
    ...
    .line 109
    iget-object v2, p0, Lwe;->e:Ljava/lang/Object;

    monitor-enter v2

    .line 110
    :try_start_0
    iget-object v1, p0, Lwe;->b:Lcom/twitter/library/api/upload/l;
    ...
    .line 113
    :cond_0
    invoke-virtual {v0}, Lcom/twitter/library/api/upload/am;->b()Lcom/twitter/model/drafts/DraftAttachment;
    ...
    iget-object v6, p0, Lwe;->g:Lcom/twitter/util/y;

    .line 115
    invoke-virtual {v3, v4, v1, v5, v6}, Lcom/twitter/library/api/upload/i;->a(Landroid/net/Uri;Lcom/twitter/media/model/MediaType;Lcom/twitter/library/api/upload/MediaUsage;Lcom/twitter/util/y;)Lcom/twitter/library/api/upload/l;

    move-result-object v1

    .line 120
    :goto_1
    iput-object v1, p0, Lwe;->b:Lcom/twitter/library/api/upload/l;
    ...
    invoke-direct {v3, p0}, Lwf;-><init>(Lwe;)V
    ...
    invoke-direct {v3, p0, p1, v0}, Lwg;-><init>(Lwe;Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/library/api/upload/am;)V
    ...
    invoke-direct {v3, p0, p1, v0}, Lwh;-><init>(Lwe;Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/library/api/upload/am;)V
    ...
    invoke-static {v1}, Lwe;->a(Lcom/twitter/model/media/EditableMedia;)Ljava/util/List;

    move-result-object v1

    iget-object v5, p0, Lwe;->g:Lcom/twitter/util/y;

    sget-object v6, Lcom/twitter/library/api/upload/MediaUsage;->a:Lcom/twitter/library/api/upload/MediaUsage;

    .line 120
    invoke-virtual {v3, v4, v1, v5, v6}, Lcom/twitter/library/api/upload/i;->a(Lcom/twitter/media/model/MediaFile;Ljava/util/List;Lcom/twitter/util/y;Lcom/twitter/library/api/upload/MediaUsage;)Lcom/twitter/library/api/upload/l;
    :try_end_1
    ...
    .line 149
    :cond_2
    iget-object v0, p0, Lwe;->a:Lcom/twitter/util/concurrent/ObservablePromise;
...
.method public a(Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/util/y;)Lcom/twitter/util/concurrent/j;
    ...
    .prologue
    .line 85
    iput-object p1, p0, Lwe;->f:Lcom/twitter/android/client/tweetuploadmanager/c;

    .line 86
    iput-object p2, p0, Lwe;->g:Lcom/twitter/util/y;
    ...
    .line 89
    invoke-direct {p0, p1}, Lwe;->d(Lcom/twitter/android/client/tweetuploadmanager/c;)V
...
.method a(Lcom/twitter/android/client/tweetuploadmanager/c;Lcom/twitter/library/api/upload/am;Lcom/twitter/library/api/upload/h;)V
    .locals 4
    ...
    invoke-direct {v1, p0, p3}, Lwi;-><init>(Lwe;Lcom/twitter/library/api/upload/h;)V
    ...
    invoke-virtual {p2, v0, v1, v2, v3}, Lcom/twitter/library/api/upload/am;->a(JJ)V
...
.method public a(Lcom/twitter/android/client/tweetuploadmanager/c;)Z
    ...
    .line 66
    iget-object v1, p0, Lwe;->e:Ljava/lang/Object;
    ...
    .line 68
    iget-object v0, p0, Lwe;->b:Lcom/twitter/library/api/upload/l;
