...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;Landroid/view/LayoutInflater;)V
    ...
    .line 39
    invoke-direct {p0, v0, v1}, Lum;-><init>(Landroid/view/View;I)V
...
.method constructor <init>(Landroid/view/View;I)V
    ...
    iput-object v0, p0, Lum;->a:Ljava/util/Map;

    .line 46
    iput-object p1, p0, Lum;->b:Landroid/view/View;

    .line 47
    iget-object v0, p0, Lum;->b:Landroid/view/View;
    ...
    iput-object v0, p0, Lum;->c:Landroid/widget/TextView;
...
.method private a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 129
    iget-object v2, p0, Lum;->b:Landroid/view/View;
...
.method public a(Ljava/util/Map;)V
    ...
    .prologue
    .line 57
    iput-object p1, p0, Lum;->a:Ljava/util/Map;
...
.method public getItemOffsets(Landroid/graphics/Rect;Landroid/view/View;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$State;)V
    ...
    .line 81
    iget-object v1, p0, Lum;->a:Ljava/util/Map;
    ...
    .line 90
    iget-object v1, p0, Lum;->c:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 91
    invoke-direct {p0, p3}, Lum;->a(Landroid/support/v7/widget/RecyclerView;)V
...
.method public onDraw(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$State;)V
    ...
    .line 111
    iget-object v6, p0, Lum;->a:Ljava/util/Map;
    ...
    .line 113
    iget-object v6, p0, Lum;->c:Landroid/widget/TextView;

    invoke-virtual {v6, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 114
    invoke-direct {p0, p2}, Lum;->a(Landroid/support/v7/widget/RecyclerView;)V

    .line 115
    iget-object v0, p0, Lum;->b:Landroid/view/View;

    iget-object v6, p0, Lum;->b:Landroid/view/View;

    invoke-virtual {v6}, Landroid/view/View;->getMeasuredWidth()I

    move-result v6

    iget-object v7, p0, Lum;->b:Landroid/view/View;
