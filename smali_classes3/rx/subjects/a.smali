...
.method public static q()Lrx/subjects/a;
    ...
    iput-object v1, v0, Lrx/subjects/SubjectSubscriptionManager;->onTerminated:Ldjf;
...
.method public bt_()V
    ...
    .line 103
    invoke-virtual {v4}, Lrx/subjects/n;->bt_()V
    ...
    .line 105
    :cond_1
    iget-object v5, v4, Lrx/subjects/n;->a:Lrx/ao;

    new-instance v6, Lrx/internal/producers/SingleProducer;

    iget-object v4, v4, Lrx/subjects/n;->a:Lrx/ao;
    ...
    invoke-direct {v6, v4, v7}, Lrx/internal/producers/SingleProducer;-><init>(Lrx/ao;Ljava/lang/Object;)V

    invoke-virtual {v5, v6}, Lrx/ao;->a(Lrx/s;)V
