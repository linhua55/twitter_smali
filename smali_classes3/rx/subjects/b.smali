...
.method public a(Lrx/subjects/n;)V
    ...
    .line 73
    :cond_0
    invoke-virtual {p1}, Lrx/subjects/n;->bt_()V
    ...
    .line 78
    :cond_2
    iget-object v2, p1, Lrx/subjects/n;->a:Lrx/ao;

    new-instance v3, Lrx/internal/producers/SingleProducer;

    iget-object v4, p1, Lrx/subjects/n;->a:Lrx/ao;

    invoke-virtual {v1, v0}, Lrx/internal/operators/NotificationLite;->d(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lrx/internal/producers/SingleProducer;-><init>(Lrx/ao;Ljava/lang/Object;)V

    invoke-virtual {v2, v3}, Lrx/ao;->a(Lrx/s;)V
