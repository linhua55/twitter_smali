...
.method constructor <init>(Lrx/internal/schedulers/m;)V
    ...
    iput-object v0, p0, Lrx/internal/schedulers/i;->b:Ldlx;
    ...
    iget-object v3, p0, Lrx/internal/schedulers/i;->b:Ldlx;
...
.method public a(Ldje;)Lrx/ap;
    ...
    invoke-direct {v1, p0, p1}, Lrx/internal/schedulers/j;-><init>(Lrx/internal/schedulers/i;Ldje;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lrx/internal/schedulers/m;->a(Ldje;JLjava/util/concurrent/TimeUnit;Lrx/internal/util/ak;)Lrx/internal/schedulers/ScheduledAction;
...
.method public a(Ldje;JLjava/util/concurrent/TimeUnit;)Lrx/ap;
    ...
    invoke-direct {v1, p0, p1}, Lrx/internal/schedulers/k;-><init>(Lrx/internal/schedulers/i;Ldje;)V

    iget-object v5, p0, Lrx/internal/schedulers/i;->b:Ldlx;

    move-wide v2, p2

    move-object v4, p4

    invoke-virtual/range {v0 .. v5}, Lrx/internal/schedulers/m;->a(Ldje;JLjava/util/concurrent/TimeUnit;Ldlx;)Lrx/internal/schedulers/ScheduledAction;
