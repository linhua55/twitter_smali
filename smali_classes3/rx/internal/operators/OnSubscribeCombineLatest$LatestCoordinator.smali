...
.field final subscribers:[Lrx/internal/operators/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.method public constructor <init>(Lrx/ao;Ldjl;IIZ)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 117
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/ao;

    .line 118
    iput-object p2, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->combiner:Ldjl;
    ...
    .line 124
    new-array v0, p3, [Lrx/internal/operators/i;

    iput-object v0, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->subscribers:[Lrx/internal/operators/i;
...
.method a(Ljava/lang/Object;I)V
    ...
    .line 189
    iget-object v2, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->subscribers:[Lrx/internal/operators/i;
    ...
    invoke-virtual {v5, v0, v1}, Lrx/internal/operators/i;->b(J)V
    ...
    iget-object v8, v5, Lrx/internal/operators/i;->c:Lrx/internal/operators/NotificationLite;
...
.method a(Ljava/util/Queue;)V
    ...
    .line 177
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->subscribers:[Lrx/internal/operators/i;
    ...
    .line 178
    invoke-virtual {v3}, Lrx/internal/operators/i;->R_()V
...
.method public a([Lrx/o;)V
    ...
    invoke-direct {v4, p0, v1}, Lrx/internal/operators/i;-><init>(Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;I)V
    ...
    .line 138
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/ao;

    invoke-virtual {v1, p0}, Lrx/ao;->a(Lrx/ap;)V

    .line 139
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/ao;

    invoke-virtual {v1, p0}, Lrx/ao;->a(Lrx/s;)V
    ...
    invoke-virtual {v1, v4}, Lrx/o;->b(Lrx/ao;)Lrx/ap;
...
.method a(ZZLrx/ao;Ljava/util/Queue;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
.method c()V
    ...
    .line 236
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->actual:Lrx/ao;
    ...
    invoke-virtual/range {v0 .. v5}, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->a(ZZLrx/ao;Ljava/util/Queue;Z)Z
    ...
    check-cast v6, Lrx/internal/operators/i;
    ...
    invoke-virtual {v3, v0}, Lrx/ao;->a(Ljava/lang/Throwable;)V
    ...
    :cond_7
    :try_start_0
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->combiner:Ldjl;

    invoke-interface {v1, v0}, Ldjl;->b([Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    ...
    .line 286
    invoke-virtual {v3, v0}, Lrx/ao;->b_(Ljava/lang/Object;)V

    .line 288
    const-wide/16 v0, 0x1

    invoke-virtual {v6, v0, v1}, Lrx/internal/operators/i;->b(J)V
