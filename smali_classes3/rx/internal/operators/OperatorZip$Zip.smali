...
.field private final childSubscription:Ldlx;
...
.field private final zipFunction:Ldjl;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ldjl",
            "<+TR;>;"
...
.method public constructor <init>(Lrx/ao;Ldjl;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Ldlx;
    ...
    .line 197
    iput-object p2, p0, Lrx/internal/operators/OperatorZip$Zip;->zipFunction:Ldjl;

    .line 198
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Ldlx;
...
.method a()V
    ...
    check-cast v0, Lrx/internal/operators/ea;

    iget-object v0, v0, Lrx/internal/operators/ea;->a:Lrx/internal/util/s;
    ...
    .line 251
    invoke-interface {v6}, Lrx/r;->bt_()V
    ...
    .line 264
    :try_start_0
    iget-object v0, p0, Lrx/internal/operators/OperatorZip$Zip;->zipFunction:Ldjl;

    invoke-interface {v0, v8}, Ldjl;->b([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v8, v9}, Lrx/internal/operators/ea;->b(J)V
...
.method public a([Lrx/o;Ljava/util/concurrent/atomic/AtomicLong;)V
    ...
    .line 205
    new-instance v3, Lrx/internal/operators/ea;

    invoke-direct {v3, p0}, Lrx/internal/operators/ea;-><init>(Lrx/internal/operators/OperatorZip$Zip;)V

    .line 206
    aput-object v3, v2, v0

    .line 207
    iget-object v4, p0, Lrx/internal/operators/OperatorZip$Zip;->childSubscription:Ldlx;

    invoke-virtual {v4, v3}, Ldlx;->a(Lrx/ap;)V
    ...
    invoke-virtual {v3, v0}, Lrx/o;->a(Lrx/ao;)Lrx/ap;
