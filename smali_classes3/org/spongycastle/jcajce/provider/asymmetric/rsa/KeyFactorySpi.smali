...
.method public constructor <init>()V
    ...
    .prologue
    .line 28
    invoke-direct {p0}, Lorg/spongycastle/jcajce/provider/asymmetric/util/a;-><init>()V
...
# virtual methods
.method public a(Ldhz;)Ljava/security/PrivateKey;
    .locals 4
    ...
    .prologue
    .line 136
    invoke-virtual {p1}, Ldhz;->a()Ldid;

    move-result-object v0

    invoke-virtual {v0}, Ldid;->a()Lorg/spongycastle/asn1/l;

    move-result-object v0

    .line 138
    invoke-static {v0}, Lorg/spongycastle/jcajce/provider/asymmetric/rsa/a;->a(Lorg/spongycastle/asn1/l;)Z
    ...
    .line 140
    invoke-virtual {p1}, Ldhz;->b()Lorg/spongycastle/asn1/d;

    move-result-object v0

    invoke-static {v0}, Ldia;->a(Ljava/lang/Object;)Ldia;

    move-result-object v1

    .line 142
    invoke-virtual {v1}, Ldia;->j()Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v1}, Lorg/spongycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Ldia;)V
    ...
    invoke-direct {v0, p1}, Lorg/spongycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Ldhz;)V
...
.method public a(Ldif;)Ljava/security/PublicKey;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v0, p1}, Lorg/spongycastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;-><init>(Ldif;)V
...
.method protected engineGeneratePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    invoke-static {v1}, Ldhz;->a(Ljava/lang/Object;)Ldhz;

    move-result-object v1

    invoke-virtual {p0, v1}, Lorg/spongycastle/jcajce/provider/asymmetric/rsa/KeyFactorySpi;->a(Ldhz;)Ljava/security/PrivateKey;
    :try_end_0
    ...
    invoke-static {v3}, Ldia;->a(Ljava/lang/Object;)Ldia;

    move-result-object v3

    invoke-direct {v1, v3}, Lorg/spongycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Ldia;)V
    :try_end_1
...
.method protected engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    ...
    :cond_0
    invoke-super {p0, p1}, Lorg/spongycastle/jcajce/provider/asymmetric/util/a;->engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
...
.method protected engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    .line 60
    :cond_2
    invoke-super {p0, p1, p2}, Lorg/spongycastle/jcajce/provider/asymmetric/util/a;->engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
