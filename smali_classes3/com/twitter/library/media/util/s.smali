...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/twitter/library/media/util/s;->a:Lcom/twitter/util/math/Size;
    ...
    sput-object v0, Lcom/twitter/library/media/util/s;->b:Lcom/twitter/util/math/Size;
...
.method private static a(Landroid/content/Context;Lcom/twitter/model/media/EditableImage;)Lcom/twitter/media/model/MediaFile;
    ...
    .line 131
    new-instance v14, Lcom/twitter/library/media/util/j;

    move-object/from16 v0, p1

    invoke-direct {v14, v0}, Lcom/twitter/library/media/util/j;-><init>(Lcom/twitter/model/media/EditableImage;)V

    .line 132
    invoke-virtual {v14}, Lcom/twitter/library/media/util/j;->c()Ljava/io/File;
    ...
    invoke-interface {v15, v2}, Lcom/twitter/platform/p;->a(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-interface {v15, v1}, Lcom/twitter/platform/p;->a(Ljava/lang/String;)Ljava/io/File;
    ...
    .line 195
    sget-object v3, Lcom/twitter/library/media/util/s;->b:Lcom/twitter/util/math/Size;
    ...
    :cond_8
    :try_start_1
    invoke-interface {v15, v3}, Lcom/twitter/platform/p;->b(Ljava/io/File;)Z
    :try_end_1
    ...
    invoke-direct {v2, v0}, Lcdv;-><init>(Lcom/twitter/model/media/EditableImage;)V

    .line 205
    move-object/from16 v0, p0

    invoke-virtual {v2, v0, v1}, Lcdv;->a(Landroid/content/Context;Landroid/graphics/Bitmap;)Z
    ...
    invoke-interface {v2, v11}, Lcom/twitter/platform/p;->c(Ljava/io/File;)Lcom/twitter/util/concurrent/j;
    ...
    .line 224
    invoke-interface {v15, v11}, Lcom/twitter/platform/p;->b(Ljava/io/File;)Z

    move-object v11, v1

    .line 227
    :cond_e
    invoke-interface {v15, v12}, Lcom/twitter/platform/p;->b(Ljava/io/File;)Z
...
.method public static a(Landroid/content/Context;Lcom/twitter/model/media/EditableMedia;)Lcom/twitter/media/model/MediaFile;
    ...
    .prologue
    .line 77
    sget-object v0, Lcom/twitter/library/media/util/v;->a:[I
    ...
    invoke-static {p1}, Lcom/twitter/library/media/util/s;->a(Lcom/twitter/model/media/EditableAnimatedGif;)Lcom/twitter/media/model/MediaFile;
    ...
    invoke-static {p0, p1}, Lcom/twitter/library/media/util/s;->a(Landroid/content/Context;Lcom/twitter/model/media/EditableImage;)Lcom/twitter/media/model/MediaFile;
    ...
    invoke-static {p1}, Lcom/twitter/library/media/util/s;->a(Lcom/twitter/model/media/EditableVideo;)Lcom/twitter/media/model/MediaFile;
    ...
    invoke-static {p0, p1}, Lcom/twitter/library/media/util/s;->a(Landroid/content/Context;Lcom/twitter/model/media/EditableSegmentedVideo;)Lcom/twitter/media/model/MediaFile;
...
.method private static a(Landroid/content/Context;Lcom/twitter/model/media/EditableSegmentedVideo;)Lcom/twitter/media/model/MediaFile;
    ...
    .line 256
    new-instance v2, Lcom/twitter/library/media/util/k;

    invoke-direct {v2, p1}, Lcom/twitter/library/media/util/k;-><init>(Lcom/twitter/model/media/EditableSegmentedVideo;)V

    .line 257
    invoke-virtual {v2}, Lcom/twitter/library/media/util/k;->c()Ljava/io/File;
    ...
    .line 262
    :cond_0
    invoke-static {p0, p1}, Lcom/twitter/library/media/util/s;->b(Landroid/content/Context;Lcom/twitter/model/media/EditableSegmentedVideo;)Ljava/io/File;
...
.method private static a(Lcom/twitter/model/media/EditableVideo;)Lcom/twitter/media/model/MediaFile;
    ...
    .line 239
    :cond_0
    invoke-static {p0}, Lcom/twitter/library/media/util/s;->b(Lcom/twitter/model/media/EditableVideo;)Lcom/twitter/media/model/VideoFile;
...
.method private static b(Lcom/twitter/model/media/EditableVideo;)Lcom/twitter/media/model/VideoFile;
    ...
    invoke-virtual {v8}, Lcom/twitter/platform/PlatformContext;->d()Lcom/twitter/platform/p;
    ...
    sget-object v16, Lcom/twitter/library/media/util/s;->a:Lcom/twitter/util/math/Size;
    ...
    .line 320
    invoke-interface {v9, v3}, Lcom/twitter/platform/p;->b(Ljava/io/File;)Z
    ...
    invoke-static {v12, v13, v2}, Lcjw;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v2}, Lcjw;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 330
    invoke-static {v5, v2}, Lcjw;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 342
    invoke-static {v4, v2}, Lcjw;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Landroid/content/Context;Lcom/twitter/model/media/EditableMedia;)Lcom/twitter/util/concurrent/j;
    ...
    invoke-direct {v1, p0, p1}, Lcom/twitter/library/media/util/u;-><init>(Landroid/content/Context;Lcom/twitter/model/media/EditableMedia;)V
    ...
    new-instance v1, Lcom/twitter/library/media/util/t;

    invoke-direct {v1}, Lcom/twitter/library/media/util/t;-><init>()V
