...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IZZ)V
    ...
    sget v2, Lbju;->adaptiveTweetMediaViewDivider:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)V
    ...
    .prologue
    .line 54
    sget v3, Lbjs;->tweetMediaViewStyle:I
...
.method protected a(Lcom/twitter/library/media/widget/ab;)F
    ...
    .line 228
    invoke-virtual {v0}, Lcom/twitter/model/media/EditableImage;->bo_()F
...
.method protected a(II)Lcom/twitter/util/math/Size;
    ...
    invoke-static {v4}, Lcom/twitter/util/ak;->a(F)I
    ...
    .line 129
    invoke-virtual {v0}, Lcom/twitter/util/math/Size;->f()Z
...
.method public setCard(Lclw;)V
    ...
    .prologue
    .line 73
    invoke-super {p0, p1}, Lcom/twitter/library/media/widget/TweetMediaView;->setCard(Lclw;)V
    ...
    .line 77
    :cond_1
    invoke-virtual {p1}, Lclw;->u()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p1}, Lclw;->t()Z
