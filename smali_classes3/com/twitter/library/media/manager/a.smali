...
.method constructor <init>(Ljava/lang/String;Landroid/content/Context;Landroid/os/HandlerThread;Lcom/twitter/util/collection/q;Ldbd;Ldbd;)V
    ...
    .prologue
    .line 48
    invoke-direct/range {p0 .. p6}, Lcom/twitter/library/media/manager/t;-><init>(Ljava/lang/String;Landroid/content/Context;Landroid/os/HandlerThread;Lcom/twitter/util/collection/q;Ldbd;Ldbd;)V

    .line 49
    return-void
.end method

.method private a(Lcdt;Ljava/io/File;Ljava/io/File;)V
    .locals 7
    ...
    invoke-static {v2, v3, v0}, Ldbt;->a(Ljava/io/InputStream;Ljava/io/OutputStream;I)I
    :try_end_0
...
.method protected a(Lcom/twitter/library/media/manager/b;Ljava/io/File;)Lcom/twitter/library/media/manager/f;
    ...
    invoke-direct {v4, v0}, Lcdt;-><init>(Lcom/twitter/media/model/AnimatedGifFile;)V

    .line 89
    iget-object v2, v4, Lcdt;->a:Ljava/util/List;
    ...
    invoke-interface {v2, v3}, Lcom/twitter/platform/p;->a(Ljava/lang/String;)Ljava/io/File;
    :try_end_0
    ...
    :cond_5
    :try_start_1
    invoke-direct {p0, v4, p2, v3}, Lcom/twitter/library/media/manager/a;->a(Lcdt;Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-direct {v2, v0, v4, v3}, Lcom/twitter/library/media/manager/e;-><init>(Lcom/twitter/media/model/AnimatedGifFile;Lcdt;Landroid/graphics/Movie;)V
    ...
    iget-object v3, v4, Lcdt;->a:Ljava/util/List;

    invoke-direct {v2, v0, v3}, Lcds;-><init>(Lcom/twitter/media/model/AnimatedGifFile;Ljava/util/List;)V
    :try_end_4
