...
.field private final g:[Lcom/twitter/library/network/SecurityScribeLog$ServiceEvaluatorData;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->f:I
    ...
    iput v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->h:I
    ...
    iput-object v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->i:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->g:[Lcom/twitter/library/network/SecurityScribeLog$ServiceEvaluatorData;
    ...
    iput-wide v2, p0, Lcom/twitter/library/network/SecurityScribeLog;->j:J
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->k:Z
    ...
    iput v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->l:I
    ...
    .line 80
    iput-boolean v1, p0, Lcom/twitter/library/network/SecurityScribeLog;->k:Z
...
.method private constructor <init>(Lcom/twitter/library/network/ao;)V
    .locals 8
    ...
    .line 50
    invoke-static {p1}, Lcom/twitter/library/network/ao;->a(Lcom/twitter/library/network/ao;)J
    ...
    .line 51
    invoke-static {p1}, Lcom/twitter/library/network/ao;->b(Lcom/twitter/library/network/ao;)I
    ...
    .line 52
    invoke-static {p1}, Lcom/twitter/library/network/ao;->c(Lcom/twitter/library/network/ao;)Ljava/lang/String;
    ...
    .line 53
    invoke-static {p1}, Lcom/twitter/library/network/ao;->d(Lcom/twitter/library/network/ao;)Ljava/util/List;
    ...
    .line 56
    iget-object v5, p0, Lcom/twitter/library/network/SecurityScribeLog;->g:[Lcom/twitter/library/network/SecurityScribeLog$ServiceEvaluatorData;
    ...
    .line 58
    :cond_0
    invoke-static {p1}, Lcom/twitter/library/network/ao;->e(Lcom/twitter/library/network/ao;)I
    ...
    .line 59
    invoke-static {p1}, Lcom/twitter/library/network/ao;->f(Lcom/twitter/library/network/ao;)J

    move-result-wide v0

    iput-wide v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->j:J

    .line 60
    invoke-static {p1}, Lcom/twitter/library/network/ao;->g(Lcom/twitter/library/network/ao;)Z
    ...
    .line 61
    invoke-static {p1}, Lcom/twitter/library/network/ao;->h(Lcom/twitter/library/network/ao;)I
...
.method synthetic constructor <init>(Lcom/twitter/library/network/ao;Lcom/twitter/library/network/an;)V
    .locals 0

    .prologue
    .line 24
    invoke-direct {p0, p1}, Lcom/twitter/library/network/SecurityScribeLog;-><init>(Lcom/twitter/library/network/ao;)V
...
.method private b(Lcom/fasterxml/jackson/core/JsonGenerator;)V
    ...
    iget v2, p0, Lcom/twitter/library/network/SecurityScribeLog;->f:I
    ...
    iget v2, p0, Lcom/twitter/library/network/SecurityScribeLog;->h:I
    ...
    iget-object v2, p0, Lcom/twitter/library/network/SecurityScribeLog;->i:Ljava/lang/String;
    ...
    iget-wide v2, p0, Lcom/twitter/library/network/SecurityScribeLog;->j:J
    ...
    iget-boolean v2, p0, Lcom/twitter/library/network/SecurityScribeLog;->k:Z
    ...
    iget v2, p0, Lcom/twitter/library/network/SecurityScribeLog;->l:I
    ...
    .line 130
    iget-object v3, p0, Lcom/twitter/library/network/SecurityScribeLog;->g:[Lcom/twitter/library/network/SecurityScribeLog$ServiceEvaluatorData;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 89
    iget v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->f:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 90
    iget v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->h:I

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeInt(I)V

    .line 91
    iget-object v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->i:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 92
    iget-object v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->g:[Lcom/twitter/library/network/SecurityScribeLog$ServiceEvaluatorData;

    invoke-virtual {p1, v0, p2}, Landroid/os/Parcel;->writeTypedArray([Landroid/os/Parcelable;I)V

    .line 95
    iget-wide v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->j:J

    invoke-virtual {p1, v0, v1}, Landroid/os/Parcel;->writeLong(J)V

    .line 96
    iget-boolean v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->k:Z
    ...
    .line 97
    iget v0, p0, Lcom/twitter/library/network/SecurityScribeLog;->l:I
