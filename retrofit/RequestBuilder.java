...
final class RequestBuilder implements RequestFacade {
    ...
    /* synthetic */ class AnonymousClass1 {
        ...
        static {
            $SwitchMap$retrofit$RestMethodInfo$RequestType = new int[RequestType.values().length];
            try {
                $SwitchMap$retrofit$RestMethodInfo$RequestType[RequestType.FORM_URL_ENCODED.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$retrofit$RestMethodInfo$RequestType[RequestType.MULTIPART.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$retrofit$RestMethodInfo$RequestType[RequestType.SIMPLE.ordinal()] = 3;
