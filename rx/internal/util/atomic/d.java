...
public final class d<T> implements Queue<T> {
    ...
    static {
        a = Integer.getInteger("jctools.spsc.max.lookahead.step", 4096).intValue();
        j = new Object();
    }
    ...
    public final boolean offer(T t) {
        ...
        if (a(atomicReferenceArray, a(((long) i2) + c, i)) == null) {
            ...
            int i3 = a;
            T t2 = t;
            a(atomicReferenceArray2, j, i3, t2, (long) i);
            return true;
        }
    }
    ...
    public boolean a(T t, T t2) {
        ...
        long a = a();
        int i = this.e;
        if (a(atomicReferenceArray, a(a + 2, i)) == null) {
            i = a(a, i);
            a(atomicReferenceArray, i + 1, (Object) t2);
            a(atomicReferenceArray, i, (Object) t);
            a(a + 2);
        } else {
            AtomicReferenceArray atomicReferenceArray2 = new AtomicReferenceArray(atomicReferenceArray.length());
            this.f = atomicReferenceArray2;
            i = a(a, i);
            a(atomicReferenceArray2, i + 1, (Object) t2);
            a(atomicReferenceArray2, i, (Object) t);
