...
.method public constructor <init>(Lcom/facebook/cache/disk/r;Lcom/facebook/cache/disk/p;Lcom/facebook/cache/common/CacheEventListener;Lcom/facebook/cache/common/CacheErrorLogger;Lan;)V
    .locals 2
    .param p5    # Lan;
    ...
    .line 164
    invoke-interface {p5, p0}, Lan;->a(Lam;)V

    .line 166
    :cond_0
    invoke-static {}, Lca;->b()Lca;

    move-result-object v0

    iput-object v0, p0, Lcom/facebook/cache/disk/n;->n:Lbx;

    .line 167
    return-void
.end method

.method private a(Ljava/lang/String;Lcom/facebook/cache/common/a;)Lai;
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, Lcom/facebook/cache/disk/l;->c(Ljava/lang/String;Ljava/lang/Object;)Lai;
...
.method private a(Ljava/lang/String;Lcom/facebook/cache/common/a;Lai;)Lai;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {v0, p1, p3, p2}, Lcom/facebook/cache/disk/l;->b(Ljava/lang/String;Lai;Ljava/lang/Object;)Lai;
...
.method private a(Ljava/util/Collection;)Ljava/util/Collection;
    ...
    .line 448
    iget-object v1, p0, Lcom/facebook/cache/disk/n;->n:Lbx;

    invoke-interface {v1}, Lbx;->a()J
...
.method private a(Lai;)V
    ...
    .line 254
    invoke-virtual {p1}, Laj;->c()Ljava/io/File;
    ...
    invoke-static {v1, v2, v3}, Lbo;->c(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private e()V
    ...
    iget-object v10, v0, Lcom/facebook/cache/disk/n;->n:Lbx;

    invoke-interface {v10}, Lbx;->a()J
...
# virtual methods
.method public a(Lcom/facebook/cache/common/a;)Lai;
    .locals 5
    ...
    invoke-interface {v0, v2, p1}, Lcom/facebook/cache/disk/l;->d(Ljava/lang/String;Ljava/lang/Object;)Lai;
...
.method public a(Lcom/facebook/cache/common/a;Lcom/facebook/cache/common/e;)Lai;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 287
    :try_start_0
    invoke-direct {p0, v0, p1}, Lcom/facebook/cache/disk/n;->a(Ljava/lang/String;Lcom/facebook/cache/common/a;)Lai;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v2, v0, v1, p2, p1}, Lcom/facebook/cache/disk/l;->a(Ljava/lang/String;Lai;Lcom/facebook/cache/common/e;Ljava/lang/Object;)V

    .line 291
    invoke-direct {p0, v0, p1, v1}, Lcom/facebook/cache/disk/n;->a(Ljava/lang/String;Lcom/facebook/cache/common/a;Lai;)Lai;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 293
    :try_start_2
    invoke-direct {p0, v1}, Lcom/facebook/cache/disk/n;->a(Lai;)V
    ...
    invoke-static {v1, v2, v0}, Lbo;->a(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Throwable;)V
