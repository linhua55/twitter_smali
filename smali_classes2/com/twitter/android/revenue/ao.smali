...
# direct methods
.method constructor <init>(Landroid/content/Context;Lcom/twitter/model/core/Tweet;Lcom/twitter/library/widget/renderablecontent/DisplayMode;Lcom/twitter/library/view/aa;Lcfs;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lcom/twitter/android/revenue/ao;->a:Lcom/twitter/ui/view/s;

    .line 205
    invoke-static {}, Lcom/twitter/android/revenue/v;->a()I

    move-result v0

    iput v0, p0, Lcom/twitter/android/revenue/ao;->g:I
    ...
    iput-object v0, p0, Lcom/twitter/android/revenue/ao;->h:Lcom/twitter/library/scribe/TwitterScribeAssociation;

    .line 213
    iput-object p1, p0, Lcom/twitter/android/revenue/ao;->b:Landroid/content/Context;

    .line 214
    iput-object p2, p0, Lcom/twitter/android/revenue/ao;->c:Lcom/twitter/model/core/Tweet;

    .line 215
    iput-object p3, p0, Lcom/twitter/android/revenue/ao;->d:Lcom/twitter/library/widget/renderablecontent/DisplayMode;

    .line 216
    iput-object p4, p0, Lcom/twitter/android/revenue/ao;->e:Lcom/twitter/library/view/aa;

    .line 217
    iput-object p5, p0, Lcom/twitter/android/revenue/ao;->f:Lcfs;

    .line 218
    return-void
.end method

.method static synthetic a(Lcom/twitter/android/revenue/ao;)Landroid/content/Context;
    .locals 1

    .prologue
    .line 183
    iget-object v0, p0, Lcom/twitter/android/revenue/ao;->b:Landroid/content/Context;
...
.method private a()V
    ...
    .prologue
    .line 312
    iget-object v0, p0, Lcom/twitter/android/revenue/ao;->c:Lcom/twitter/model/core/Tweet;
    ...
    .line 313
    iget-object v0, p0, Lcom/twitter/android/revenue/ao;->f:Lcfs;

    sget-object v1, Lcom/twitter/library/api/PromotedEvent;->g:Lcom/twitter/library/api/PromotedEvent;

    iget-object v2, p0, Lcom/twitter/android/revenue/ao;->c:Lcom/twitter/model/core/Tweet;
...
.method static synthetic b(Lcom/twitter/android/revenue/ao;)Lcom/twitter/library/widget/renderablecontent/DisplayMode;
    .locals 1

    .prologue
    .line 183
    iget-object v0, p0, Lcom/twitter/android/revenue/ao;->d:Lcom/twitter/library/widget/renderablecontent/DisplayMode;

    return-object v0
.end method

.method static synthetic c(Lcom/twitter/android/revenue/ao;)V
    .locals 0

    .prologue
    .line 183
    invoke-direct {p0}, Lcom/twitter/android/revenue/ao;->a()V
...
.method public a(Landroid/content/Context;Lcom/twitter/model/core/Tweet;I)Landroid/view/View;
    ...
    .line 225
    iget-object v1, p0, Lcom/twitter/android/revenue/ao;->e:Lcom/twitter/library/view/aa;
    ...
    .line 231
    invoke-virtual {p0, p1}, Lcom/twitter/android/revenue/ao;->a(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    invoke-static {p2}, Lcom/twitter/library/av/playback/bm;->b(Lcom/twitter/model/core/Tweet;)Z
    ...
    .line 238
    iget v2, p0, Lcom/twitter/android/revenue/ao;->g:I
    ...
    invoke-virtual {p0, p1, p2}, Lcom/twitter/android/revenue/ao;->a(Landroid/app/Activity;Lcom/twitter/model/core/Tweet;)Lcjm;

    move-result-object v2

    .line 263
    iget-object v3, p0, Lcom/twitter/android/revenue/ao;->a:Lcom/twitter/ui/view/s;

    invoke-virtual {v0, p2, v3, v4, v2}, Lcom/twitter/library/widget/TweetView;->a(Lcom/twitter/model/core/Tweet;Lcom/twitter/ui/view/s;ZLcjm;)V
    ...
    .line 268
    new-instance v2, Lcom/twitter/android/revenue/ap;

    invoke-direct {v2, p0, v0}, Lcom/twitter/android/revenue/ap;-><init>(Lcom/twitter/android/revenue/ao;Lcom/twitter/library/widget/TweetView;)V
...
.method public bridge synthetic a(Landroid/content/Context;Ljava/lang/Object;I)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/android/revenue/ao;->a(Landroid/content/Context;Lcom/twitter/model/core/Tweet;I)Landroid/view/View;
...
.method a(Landroid/app/Activity;Lcom/twitter/model/core/Tweet;)Lcjm;
    .locals 7
    ...
    iget-object v5, p0, Lcom/twitter/android/revenue/ao;->h:Lcom/twitter/library/scribe/TwitterScribeAssociation;
...
.method public synthetic a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/android/revenue/ao;->b(Landroid/view/View;Lcom/twitter/model/core/Tweet;I)V
...
.method public synthetic b(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/android/revenue/ao;->a(Landroid/view/View;Lcom/twitter/model/core/Tweet;I)V
