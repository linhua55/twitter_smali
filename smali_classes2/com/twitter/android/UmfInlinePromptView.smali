...
.method private g()V
    ...
    .line 35
    iget-object v1, p0, Lcom/twitter/android/UmfInlinePromptView;->a:Lcom/twitter/model/timeline/w;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/twitter/android/UmfInlinePromptView;->a:Lcom/twitter/model/timeline/w;

    invoke-virtual {v1}, Lcom/twitter/model/timeline/w;->h()Z
...
.method public c()V
    ...
    .prologue
    .line 43
    iget-object v0, p0, Lcom/twitter/android/UmfInlinePromptView;->a:Lcom/twitter/model/timeline/w;
    ...
    invoke-direct {v1, p0, v0}, Lcom/twitter/android/wr;-><init>(Lcom/twitter/android/UmfInlinePromptView;Landroid/content/Context;)V

    const/4 v0, 0x1

    new-array v0, v0, [Lcom/twitter/model/timeline/w;

    const/4 v2, 0x0

    iget-object v3, p0, Lcom/twitter/android/UmfInlinePromptView;->a:Lcom/twitter/model/timeline/w;

    aput-object v3, v0, v2

    .line 60
    invoke-virtual {v1, v0}, Lcom/twitter/android/wr;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
