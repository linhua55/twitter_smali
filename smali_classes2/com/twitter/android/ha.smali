.class public Lcom/twitter/android/ha;
.super Lcvt;
.source "Twttr"
...
.field private final b:Lcom/twitter/android/kn;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/widget/e;Lcom/twitter/android/kn;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 28
    iput-object p2, p0, Lcom/twitter/android/ha;->a:Lcom/twitter/library/widget/e;

    .line 29
    iput-object p3, p0, Lcom/twitter/android/ha;->b:Lcom/twitter/android/kn;
...
.method protected a(Landroid/content/Context;Lcom/twitter/model/core/TwitterUser;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 37
    iget-object v1, p0, Lcom/twitter/android/ha;->a:Lcom/twitter/library/widget/e;
    ...
    .line 39
    invoke-virtual {v1, p2}, Lcom/twitter/android/xy;->a(Lcom/twitter/model/core/TwitterUser;)V

    .line 40
    const/16 v2, 0x24

    iput v2, v1, Lcom/twitter/android/xy;->i:I
...
.method protected bridge synthetic a(Landroid/content/Context;Ljava/lang/Object;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/android/ha;->a(Landroid/content/Context;Lcom/twitter/model/core/TwitterUser;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method protected a(Landroid/view/View;Landroid/content/Context;Lcom/twitter/model/core/TwitterUser;)V
    ...
    iget-object v1, p3, Lcom/twitter/model/core/TwitterUser;->D:Lcom/twitter/model/core/bm;

    invoke-virtual {p1, v0, v1}, Lcom/twitter/library/widget/UserSocialView;->a(Ljava/lang/String;Lcom/twitter/model/core/bm;)V
    ...
    .line 51
    iget-object v0, p0, Lcom/twitter/android/ha;->b:Lcom/twitter/android/kn;
...
.method protected bridge synthetic a(Landroid/view/View;Landroid/content/Context;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/android/ha;->a(Landroid/view/View;Landroid/content/Context;Lcom/twitter/model/core/TwitterUser;)V
