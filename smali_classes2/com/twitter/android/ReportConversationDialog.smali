...
.field private e:Lcom/twitter/android/ne;
...
.method public static a(IZLjava/lang/String;Ljava/lang/String;Lcom/twitter/android/ne;)Lcom/twitter/android/ReportConversationDialog;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lcom/twitter/android/nh;-><init>(I)V

    const v1, 0x7f0a06e9

    .line 41
    invoke-virtual {v0, v1}, Lcom/twitter/android/nh;->a(I)Lcom/twitter/android/widget/eb;

    move-result-object v0

    check-cast v0, Lcom/twitter/android/nh;

    const v1, 0x7f0b0026

    .line 42
    invoke-virtual {v0, v1}, Lcom/twitter/android/nh;->c(I)Lcom/twitter/android/widget/eb;
    ...
    .line 43
    invoke-virtual {v0}, Lcom/twitter/android/nh;->i()Lcom/twitter/app/common/base/BaseDialogFragment;
    ...
    .line 44
    invoke-direct {v0, p2, p3, p1, p4}, Lcom/twitter/android/ReportConversationDialog;->a(Ljava/lang/String;Ljava/lang/String;ZLcom/twitter/android/ne;)V
...
.method private a(Landroid/content/Context;Lcom/twitter/library/api/dm/requests/ReportConversationRequest$Type;Lcom/twitter/library/client/Session;)V
    ...
    new-instance v2, Lcom/twitter/android/nd;

    invoke-direct {v2, p0, p1}, Lcom/twitter/android/nd;-><init>(Lcom/twitter/android/ReportConversationDialog;Landroid/content/Context;)V
...
.method private a(Ljava/lang/String;Ljava/lang/String;ZLcom/twitter/android/ne;)V
    .locals 0
    ...
    .line 53
    iput-object p4, p0, Lcom/twitter/android/ReportConversationDialog;->e:Lcom/twitter/android/ne;
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    .line 118
    iget-object v1, p0, Lcom/twitter/android/ReportConversationDialog;->e:Lcom/twitter/android/ne;

    if-nez v1, :cond_0

    .line 119
    const-class v1, Lcom/twitter/android/ne;
    ...
    check-cast v0, Lcom/twitter/android/ne;

    iput-object v0, p0, Lcom/twitter/android/ReportConversationDialog;->e:Lcom/twitter/android/ne;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 85
    iget-object v0, p0, Lcom/twitter/android/ReportConversationDialog;->e:Lcom/twitter/android/ne;

    invoke-interface {v0}, Lcom/twitter/android/ne;->x()V
    ...
    invoke-interface {v0}, Lcom/twitter/android/ne;->N_()V
