...
.method public constructor <init>(Landroid/content/Context;Lcpe;)V
    .locals 2
    ...
    .line 34
    iput-object p2, p0, Lcom/twitter/android/media/stickers/StickerMediaImageView;->k:Lcpe;
    ...
    iput-object v0, p0, Lcom/twitter/android/media/stickers/StickerMediaImageView;->l:Landroid/animation/AnimatorSet;

    .line 36
    iget-object v0, p0, Lcom/twitter/android/media/stickers/StickerMediaImageView;->l:Landroid/animation/AnimatorSet;
...
.method protected a(Lcom/twitter/media/request/b;)Lcom/twitter/media/request/a;
    ...
    iget-object v1, p0, Lcom/twitter/android/media/stickers/StickerMediaImageView;->k:Lcpe;

    iget-object v1, v1, Lcpe;->c:Lcpu;

    invoke-direct {v0, v1}, Lcom/twitter/library/media/util/ad;-><init>(Lcpu;)V

    invoke-virtual {p1, v0}, Lcom/twitter/media/request/b;->a(Lcom/twitter/media/request/d;)Lcom/twitter/media/request/b;

    .line 69
    :cond_0
    invoke-super {p0, p1}, Lcom/twitter/media/ui/image/MediaImageView;->a(Lcom/twitter/media/request/b;)Lcom/twitter/media/request/a;
...
.method public getStickerTag()Lcpe;
    .locals 1

    .prologue
    .line 47
    iget-object v0, p0, Lcom/twitter/android/media/stickers/StickerMediaImageView;->k:Lcpe;
