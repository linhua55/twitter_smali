...
.method private a(Lcef;)V
    ...
    invoke-virtual {p1, v0}, Lcef;->a(Lavg;)V
...
.method private a(Ljava/util/List;)V
    ...
    invoke-direct {v4, v5, v0}, Lcom/twitter/android/media/stickers/StickerMediaImageView;-><init>(Landroid/content/Context;Lcpe;)V
    ...
    .line 339
    iget-object v5, v0, Lcpe;->c:Lcpu;

    iget-object v5, v5, Lcpu;->c:Lcpk;

    iget-object v5, v5, Lcpk;->c:Ljava/lang/String;

    invoke-static {v5}, Lcom/twitter/media/request/a;->a(Ljava/lang/String;)Lcom/twitter/media/request/b;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/twitter/android/media/stickers/StickerMediaImageView;->b(Lcom/twitter/media/request/b;)Z
    ...
    .line 343
    invoke-virtual {v4, p0}, Lcom/twitter/android/media/stickers/StickerMediaImageView;->setOnImageLoadedListener(Lcom/twitter/media/ui/image/f;)V
...
.method private b(Lcom/twitter/android/media/stickers/StickerMediaImageView;)V
    ...
    .line 262
    invoke-virtual {p1}, Lcom/twitter/android/media/stickers/StickerMediaImageView;->getStickerTag()Lcpe;

    move-result-object v2

    .line 263
    invoke-virtual {v2, v1}, Lcpe;->a(I)Lcom/twitter/util/math/Size;
    ...
    .line 274
    invoke-virtual {v2, v1}, Lcpe;->b(I)F
    ...
    .line 276
    invoke-virtual {v2, v1}, Lcpe;->c(I)F
...
.method public a(Ljava/util/List;Lcef;Lcom/twitter/library/media/widget/MultiTouchImageView;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 98
    invoke-direct {p0, p2}, Lcom/twitter/android/media/stickers/StickerMediaView;->a(Lcef;)V
...
.method public a(II)Z
    ...
    invoke-virtual {v0}, Lcom/twitter/android/media/stickers/StickerMediaImageView;->getStickerTag()Lcpe;
    ...
    invoke-virtual {v1}, Lcom/twitter/android/media/stickers/StickerMediaImageView;->getStickerTag()Lcpe;

    move-result-object v0

    iget-wide v0, v0, Lcpe;->a:J
...
.method public b()V
    ...
    invoke-virtual {v0, v3}, Lcom/twitter/android/media/stickers/StickerMediaImageView;->b(Lcom/twitter/media/request/b;)Z
