...
# direct methods
.method public constructor <init>(Landroid/content/Context;ILcom/twitter/android/ys;)V
    .locals 5
    .param p2    # I
        .annotation build Landroid/support/annotation/LayoutRes;
        .end annotation
    ...
    .line 41
    iput-object p3, p0, Lcom/twitter/android/people/adapters/f;->b:Lcom/twitter/android/ys;
    ...
    invoke-direct {v3, v4}, Lckc;-><init>(I)V
    ...
    invoke-direct {v3, p1, v4}, Lcjy;-><init>(Landroid/content/Context;I)V

    aput-object v3, v1, v2

    invoke-direct {v0, v1}, Lcjz;-><init>([Lckb;)V

    iput-object v0, p0, Lcom/twitter/android/people/adapters/f;->c:Lckb;
...
.method public a(Landroid/content/Context;Lcom/twitter/model/people/aa;I)Landroid/view/View;
    ...
    .line 52
    iget-object v1, p0, Lcom/twitter/android/people/adapters/f;->b:Lcom/twitter/android/ys;
...
.method public a(Landroid/view/View;Lcom/twitter/model/people/aa;I)V
    ...
    .line 73
    iget-object v0, v4, Lcom/twitter/model/core/TwitterUser;->U:Lcom/twitter/model/timeline/al;
    ...
    iget-object v5, p0, Lcom/twitter/android/people/adapters/f;->c:Lckb;

    .line 83
    invoke-virtual {v2, v5}, Lcom/twitter/media/request/b;->a(Lckb;)Lcom/twitter/media/request/b;

    move-result-object v2

    .line 81
    invoke-virtual {v0, v2}, Lcom/twitter/media/ui/image/BackgroundImageView;->b(Lcom/twitter/media/request/b;)Z
