...
.super Lcom/twitter/android/client/ah;
.source "Twttr"
...
# direct methods
.method constructor <init>(Lcom/twitter/android/client/y;Lcom/twitter/android/client/notifications/StoriesNotif;Landroid/content/Context;J)V
    .locals 4
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/twitter/android/client/ah;-><init>(Ljava/lang/String;Lcom/twitter/android/client/y;Lcom/twitter/android/client/notifications/StatusBarNotif;)V
    ...
    invoke-direct {v0, v1}, Lckc;-><init>(I)V

    iput-object v0, p0, Lcom/twitter/android/client/notifications/af;->g:Lckb;
...
.method private a(Landroid/content/ContentResolver;Ljava/lang/String;I)Lcom/twitter/model/core/Tweet;
    ...
    sget-object v2, Lchh;->a:[Ljava/lang/String;
...
# virtual methods
.method protected a(Lcom/twitter/android/client/y;Lcom/twitter/android/client/notifications/StatusBarNotif;Lcom/twitter/internal/android/service/ab;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 630
    invoke-virtual {p1, p2}, Lcom/twitter/android/client/y;->a(Lcom/twitter/android/client/notifications/StatusBarNotif;)V
...
.method protected b()Ljava/util/List;
    ...
    invoke-direct {v1, v2, v0}, Lbpb;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;)V

    .line 569
    const-string/jumbo v0, "Started due to notification send-to-sync."

    invoke-virtual {v1, v0}, Lbpb;->k(Ljava/lang/String;)Lcom/twitter/library/service/x;

    .line 570
    invoke-virtual {v1}, Lbpb;->P()Lcom/twitter/library/service/aa;
    ...
    .line 578
    sget-object v1, Lcom/twitter/library/provider/di;->a:Landroid/net/Uri;
    ...
    .line 594
    invoke-static {v6}, Lcom/twitter/library/provider/aq;->b(Lcom/twitter/model/core/Tweet;)Lcom/twitter/library/provider/aq;
    ...
    .line 595
    invoke-virtual {v1, v5}, Lcom/twitter/library/provider/aq;->a(Z)Lcom/twitter/library/provider/aq;
    ...
    .line 596
    invoke-virtual {v1, v5}, Lcom/twitter/library/provider/aq;->d(Z)Lcom/twitter/library/provider/aq;

    move-result-object v1

    .line 597
    invoke-static {v6}, Lcih;->a(Lcom/twitter/model/core/Tweet;)Z

    move-result v5

    invoke-virtual {v1, v5}, Lcom/twitter/library/provider/aq;->e(Z)Lcom/twitter/library/provider/aq;
    ...
    .line 599
    invoke-virtual {v6}, Lcom/twitter/model/core/Tweet;->ae()Lcom/twitter/model/core/bm;
    ...
    iget-wide v6, v6, Lcom/twitter/model/core/Tweet;->m:J
    ...
    invoke-virtual {v1, v5}, Lcom/twitter/model/core/ac;->a(I)Lcom/twitter/model/core/e;

    move-result-object v1

    check-cast v1, Lcom/twitter/model/core/MediaEntity;

    invoke-static {v1}, Lcom/twitter/library/media/util/p;->a(Lcom/twitter/model/core/MediaEntity;)Lcom/twitter/media/request/b;

    move-result-object v1

    iget-object v5, p0, Lcom/twitter/android/client/notifications/af;->g:Lckb;

    .line 601
    invoke-virtual {v1, v5}, Lcom/twitter/media/request/b;->a(Lckb;)Lcom/twitter/media/request/b;
