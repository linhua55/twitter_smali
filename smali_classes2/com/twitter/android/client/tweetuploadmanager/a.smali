...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lcom/twitter/util/y;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 40
    iput-object p3, p0, Lcom/twitter/android/client/tweetuploadmanager/a;->c:Lcom/twitter/util/y;
...
.method protected b()Ljava/lang/Boolean;
    ...
    invoke-static {v3, v2}, Lcom/twitter/library/media/util/s;->a(Landroid/content/Context;Lcom/twitter/model/media/EditableMedia;)Lcom/twitter/media/model/MediaFile;
    ...
    .line 84
    :cond_3
    invoke-virtual {v0, v2}, Lcom/twitter/library/api/upload/am;->a(Lcom/twitter/media/model/MediaFile;)V
    :try_end_1
