.class Lcom/twitter/android/card/pollcompose/af;
.super Lcom/twitter/android/card/pollcompose/ad;
.source "Twttr"
...
# direct methods
.method constructor <init>(Lcom/twitter/android/client/tweetuploadmanager/c;Lclp;Lcom/twitter/util/y;Lcom/twitter/util/concurrent/ObservablePromise;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 78
    invoke-direct/range {v1 .. v8}, Lcom/twitter/android/card/pollcompose/ad;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;JLjava/util/List;Lclp;Lcom/twitter/util/y;)V

    .line 84
    iput-object p4, p0, Lcom/twitter/android/card/pollcompose/af;->a:Lcom/twitter/util/concurrent/ObservablePromise;

    .line 85
    iput-object p1, p0, Lcom/twitter/android/card/pollcompose/af;->b:Lcom/twitter/android/client/tweetuploadmanager/c;
...
.method public a(Lcom/twitter/internal/android/service/ab;)V
    ...
    .prologue
    .line 90
    invoke-super {p0, p1}, Lcom/twitter/android/card/pollcompose/ad;->a(Lcom/twitter/internal/android/service/ab;)V

    .line 92
    iget-object v0, p0, Lcom/twitter/android/card/pollcompose/af;->b:Lcom/twitter/android/client/tweetuploadmanager/c;
    ...
    .line 93
    invoke-virtual {p0}, Lcom/twitter/android/card/pollcompose/af;->l()Lcom/twitter/internal/android/service/ab;
    ...
    .line 96
    invoke-virtual {p0}, Lcom/twitter/android/card/pollcompose/af;->a()Lclr;
    ...
    .line 98
    iget-object v1, p0, Lcom/twitter/android/card/pollcompose/af;->b:Lcom/twitter/android/client/tweetuploadmanager/c;

    iget-object v2, v0, Lclr;->a:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/twitter/android/client/tweetuploadmanager/c;->a(Ljava/lang/String;)V

    .line 99
    iget-object v1, p0, Lcom/twitter/android/card/pollcompose/af;->a:Lcom/twitter/util/concurrent/ObservablePromise;
