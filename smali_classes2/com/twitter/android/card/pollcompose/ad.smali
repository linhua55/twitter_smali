.class public Lcom/twitter/android/card/pollcompose/ad;
...
.field private final i:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
            "Lcom/twitter/library/api/upload/am;",
            ">;"
        }
    .end annotation
.end field

.field private final j:Lclp;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->a:Lcom/twitter/android/card/ConsumerPollCard$Configuration;

    iget-object v1, v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->modelName:Ljava/lang/String;

    aput-object v1, v0, v2

    sget-object v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->b:Lcom/twitter/android/card/ConsumerPollCard$Configuration;

    iget-object v1, v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->modelName:Ljava/lang/String;

    aput-object v1, v0, v3

    sget-object v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->c:Lcom/twitter/android/card/ConsumerPollCard$Configuration;

    iget-object v1, v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->modelName:Ljava/lang/String;

    aput-object v1, v0, v4

    sput-object v0, Lcom/twitter/android/card/pollcompose/ad;->a:[Ljava/lang/String;

    .line 53
    new-array v0, v5, [Ljava/lang/String;

    sget-object v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->d:Lcom/twitter/android/card/ConsumerPollCard$Configuration;

    iget-object v1, v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->modelName:Ljava/lang/String;

    aput-object v1, v0, v2

    sget-object v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->e:Lcom/twitter/android/card/ConsumerPollCard$Configuration;

    iget-object v1, v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->modelName:Ljava/lang/String;

    aput-object v1, v0, v3

    sget-object v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->f:Lcom/twitter/android/card/ConsumerPollCard$Configuration;

    iget-object v1, v1, Lcom/twitter/android/card/ConsumerPollCard$Configuration;->modelName:Ljava/lang/String;

    aput-object v1, v0, v4

    sput-object v0, Lcom/twitter/android/card/pollcompose/ad;->b:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/twitter/android/card/pollcompose/ad;->c:[Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/client/Session;JLjava/util/List;Lclp;Lcom/twitter/util/y;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 80
    const-class v0, Lcom/twitter/android/card/pollcompose/ad;
    ...
    .line 81
    iput-object p5, p0, Lcom/twitter/android/card/pollcompose/ad;->i:Ljava/util/List;

    .line 82
    iput-object p6, p0, Lcom/twitter/android/card/pollcompose/ad;->j:Lclp;

    .line 83
    iput-object p7, p0, Lcom/twitter/android/card/pollcompose/ad;->k:Lcom/twitter/util/y;
    ...
    const-class v1, Lcom/twitter/android/card/pollcompose/ad;
    ...
    iput-object v0, p0, Lcom/twitter/android/card/pollcompose/ad;->l:Ljava/lang/String;
    ...
    .line 94
    invoke-virtual {p0, v0}, Lcom/twitter/android/card/pollcompose/ad;->a(Lcom/twitter/internal/android/service/ac;)Lcom/twitter/internal/android/service/AsyncOperation;

    .line 95
    return-void
.end method

.method private a(Lclp;)Ljava/lang/String;
    .locals 12
    ...
    .line 154
    invoke-direct {p0, p1}, Lcom/twitter/android/card/pollcompose/ad;->c(Lclp;)Lclp;
    ...
    invoke-direct {p0, v4}, Lcom/twitter/android/card/pollcompose/ad;->b(Lclp;)Ljava/lang/String;
    ...
    .line 156
    invoke-virtual {v4}, Lclp;->a()Ljava/util/List;
    ...
    .line 159
    sget-object v6, Lcom/twitter/android/card/pollcompose/ad;->c:[Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/twitter/android/card/pollcompose/ad;->i:Ljava/util/List;
    ...
    .line 180
    :cond_1
    invoke-virtual {v4}, Lclp;->b()Ljava/lang/String;
...
.method private b(Lclp;)Ljava/lang/String;
    .locals 2
    ...
    sget-object v1, Lcom/twitter/android/card/pollcompose/ad;->a:[Ljava/lang/String;
    ...
    :cond_0
    sget-object v1, Lcom/twitter/android/card/pollcompose/ad;->b:[Ljava/lang/String;
...
.method private c(Lclp;)Lclp;
    ...
    invoke-virtual {p1}, Lclp;->b()Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2, v3}, Lclp;-><init>(Ljava/util/List;Ljava/lang/String;Lcom/twitter/model/media/EditableImage;)V
...
# virtual methods
.method public a()Lclr;
    .locals 1

    .prologue
    .line 218
    iget-object v0, p0, Lcom/twitter/android/card/pollcompose/ad;->m:Lclr;
...
.method public a(I)V
    ...
    .line 228
    iget-object v0, p0, Lcom/twitter/android/card/pollcompose/ad;->l:Ljava/lang/String;
    ...
    .line 234
    :goto_0
    iget-object v1, p0, Lcom/twitter/android/card/pollcompose/ad;->k:Lcom/twitter/util/y;
...
.method protected a(Lcom/twitter/library/service/aa;)V
    ...
    invoke-virtual {p0, v0}, Lcom/twitter/android/card/pollcompose/ad;->a(I)V

    .line 103
    :try_start_0
    iget-object v0, p0, Lcom/twitter/android/card/pollcompose/ad;->j:Lclp;

    invoke-direct {p0, v0}, Lcom/twitter/android/card/pollcompose/ad;->a(Lclp;)Ljava/lang/String;
    :try_end_0
    ...
    invoke-virtual {p0, v1}, Lcom/twitter/android/card/pollcompose/ad;->a(I)V

    .line 113
    invoke-static {}, Lcom/twitter/library/card/k;->b()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/twitter/android/card/pollcompose/ad;->p:Landroid/content/Context;
    ...
    .line 122
    invoke-virtual {p0}, Lcom/twitter/android/card/pollcompose/ad;->N()Lcom/twitter/library/service/ab;
    ...
    iget-object v2, p0, Lcom/twitter/android/card/pollcompose/ad;->g:Lcom/twitter/internal/android/service/d;
    ...
    invoke-virtual {p0, v2}, Lcom/twitter/android/card/pollcompose/ad;->a(I)V
    ...
    iput-object v0, p0, Lcom/twitter/android/card/pollcompose/ad;->m:Lclr;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/twitter/android/card/pollcompose/ad;->a(Ljava/lang/String;[I)Lcom/twitter/library/service/x;
