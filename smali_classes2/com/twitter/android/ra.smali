.class public Lcom/twitter/android/ra;
.super Lbkj;
.source "Twttr"
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/twitter/android/ra;->d:Lcom/twitter/util/collection/ReferenceList;
    ...
    iput-object v0, p0, Lcom/twitter/android/ra;->a:Landroid/support/v4/util/LruCache;

    .line 60
    if-eqz p2, :cond_1

    .line 61
    iput v1, p0, Lcom/twitter/android/ra;->b:I

    .line 62
    const/16 v0, 0x12

    iput v0, p0, Lcom/twitter/android/ra;->c:I
    ...
    .line 64
    :cond_1
    iput v2, p0, Lcom/twitter/android/ra;->b:I
...
.method private b(Landroid/database/Cursor;)J
    ...
    .line 71
    iget v0, p0, Lcom/twitter/android/ra;->b:I
...
.method private c(Landroid/database/Cursor;)Ljava/util/List;
    ...
    .prologue
    .line 78
    invoke-direct {p0, p1}, Lcom/twitter/android/ra;->b(Landroid/database/Cursor;)J

    move-result-wide v2

    .line 79
    iget-object v0, p0, Lcom/twitter/android/ra;->a:Landroid/support/v4/util/LruCache;
    ...
    .line 85
    iget v0, p0, Lcom/twitter/android/ra;->c:I
    ...
    invoke-static {v0, v1}, Lcug;->f(Ljava/lang/Iterable;Lcom/twitter/util/math/Size;)Ljava/util/List;
    ...
    :cond_0
    :goto_1
    iget-object v1, p0, Lcom/twitter/android/ra;->a:Landroid/support/v4/util/LruCache;
...
.method public a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 101
    iget-object v1, p0, Lcom/twitter/android/ra;->d:Lcom/twitter/util/collection/ReferenceList;
...
.method public bridge synthetic a(Landroid/content/Context;Ljava/lang/Object;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/android/ra;->a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 108
    invoke-direct {p0, p3}, Lcom/twitter/android/ra;->c(Landroid/database/Cursor;)Ljava/util/List;
    ...
    .line 115
    iget-boolean v7, p0, Lcom/twitter/android/ra;->e:Z
...
.method public bridge synthetic a(Landroid/view/View;Landroid/content/Context;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/twitter/android/ra;->a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
...
.method public a(Lcom/twitter/internal/android/widget/HorizontalListView;Z)V
    ...
    .prologue
    .line 146
    invoke-virtual {p0, p2}, Lcom/twitter/android/ra;->b(Z)V
...
.method public b(Z)V
    ...
    .line 129
    iget-boolean v0, p0, Lcom/twitter/android/ra;->e:Z

    if-eq v0, p1, :cond_1

    .line 130
    iput-boolean p1, p0, Lcom/twitter/android/ra;->e:Z
    ...
    .line 132
    iget-object v0, p0, Lcom/twitter/android/ra;->d:Lcom/twitter/util/collection/ReferenceList;
