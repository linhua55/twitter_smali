...
# virtual methods
.method public a(Lcom/twitter/model/timeline/w;)Lcom/twitter/android/dialog/t;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public b(Lcom/twitter/model/timeline/w;)Lcom/twitter/android/dialog/t;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 48
    invoke-virtual {p0, p1}, Lcom/twitter/android/dialog/t;->a(Lcom/twitter/model/timeline/w;)Lcom/twitter/android/dialog/t;

    .line 49
    iget-object v0, p1, Lcom/twitter/model/timeline/w;->k:Ljava/lang/String;

    invoke-virtual {p0, v0}, Lcom/twitter/android/dialog/t;->a(Ljava/lang/String;)Lcom/twitter/android/dialog/q;

    .line 50
    iget-object v0, p1, Lcom/twitter/model/timeline/w;->f:Ljava/lang/String;

    invoke-virtual {p0, v0}, Lcom/twitter/android/dialog/t;->c(Ljava/lang/CharSequence;)Lcom/twitter/android/dialog/m;

    .line 51
    iget-object v0, p1, Lcom/twitter/model/timeline/w;->e:Ljava/lang/String;
