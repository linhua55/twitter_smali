...
# instance fields
.field p:Lcom/twitter/ui/widget/TwitterButton;
...
.method protected F()V
    ...
    invoke-direct {v1, p0}, Lcom/twitter/android/av/at;-><init>(Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;)V
    ...
    iput-object v0, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->p:Lcom/twitter/ui/widget/TwitterButton;

    .line 110
    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->p:Lcom/twitter/ui/widget/TwitterButton;

    new-instance v1, Lcom/twitter/android/av/au;

    iget-object v2, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->p:Lcom/twitter/ui/widget/TwitterButton;

    invoke-direct {v1, p0, v2}, Lcom/twitter/android/av/au;-><init>(Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;Lcom/twitter/ui/widget/TwitterButton;)V
...
.method a(Landroid/view/View;Landroid/view/MotionEvent;)V
    ...
    .prologue
    .line 120
    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->r:Lcom/twitter/android/card/CardActionHelper;

    if-eqz v0, :cond_0

    .line 121
    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->s:Landroid/view/View;
    ...
    .line 123
    iget-object v1, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->r:Lcom/twitter/android/card/CardActionHelper;

    iget-object v2, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->q:Lcom/twitter/android/av/revenue/VideoAppCardData;

    iget-object v2, v2, Lcom/twitter/android/av/revenue/VideoAppCardData;->g:Ljava/lang/String;

    iget-object v3, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->q:Lcom/twitter/android/av/revenue/VideoAppCardData;

    iget-object v3, v3, Lcom/twitter/android/av/revenue/VideoAppCardData;->f:Ljava/lang/String;

    iget-object v4, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->q:Lcom/twitter/android/av/revenue/VideoAppCardData;
...
.method public a(Landroid/view/View;Lcom/twitter/android/card/CardActionHelper;Lcom/twitter/android/av/revenue/VideoAppCardData;)V
    ...
    .prologue
    .line 44
    iput-object p1, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->s:Landroid/view/View;

    .line 45
    iput-object p2, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->r:Lcom/twitter/android/card/CardActionHelper;

    .line 46
    iput-object p3, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->q:Lcom/twitter/android/av/revenue/VideoAppCardData;
    ...
    .line 53
    iget-object v1, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->q:Lcom/twitter/android/av/revenue/VideoAppCardData;
    ...
    .line 65
    iget-object v0, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->q:Lcom/twitter/android/av/revenue/VideoAppCardData;
    ...
    iget-object v5, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->q:Lcom/twitter/android/av/revenue/VideoAppCardData;
    ...
    invoke-static {v0}, Lcom/twitter/android/revenue/x;->a(Ljava/lang/String;)I
    ...
    .line 88
    iget-object v1, p0, Lcom/twitter/android/av/FullscreenVideoCardCanvasChromeView;->p:Lcom/twitter/ui/widget/TwitterButton;
