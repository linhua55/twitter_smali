...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/av/playback/ba;)V
    .locals 4
    ...
    invoke-direct {v0, p2}, Lcom/twitter/android/av/a;-><init>(Lcom/twitter/library/av/playback/ba;)V

    new-instance v1, Lsx;

    invoke-direct {v1, p1}, Lsx;-><init>(Landroid/content/Context;)V
    ...
    .line 92
    invoke-direct {p0, v0, v1, v2, v3}, Lcom/twitter/android/av/b;-><init>(Lcom/twitter/android/av/a;Lsx;Lcom/twitter/library/av/f;Lcom/twitter/library/client/bk;)V

    .line 94
    return-void
.end method

.method constructor <init>(Lcom/twitter/android/av/a;Lsx;Lcom/twitter/library/av/f;Lcom/twitter/library/client/bk;)V
    .locals 1
    ...
    .line 105
    iput-object p2, p0, Lcom/twitter/android/av/b;->d:Lsx;

    .line 106
    iput-object p3, p0, Lcom/twitter/android/av/b;->e:Lcom/twitter/library/av/f;

    .line 107
    iput-object p4, p0, Lcom/twitter/android/av/b;->f:Lcom/twitter/library/client/bk;
...
.method public a(Lcom/twitter/library/av/c;)V
    ...
    iget-object v2, p0, Lcom/twitter/android/av/b;->f:Lcom/twitter/library/client/bk;
    ...
    .line 170
    iget-object v2, p1, Lcom/twitter/library/av/c;->s:Lbvn;
    ...
    iget-wide v6, v2, Lbvn;->a:J

    iput-wide v6, v3, Lcom/twitter/library/scribe/TwitterScribeItem;->ad:J

    .line 172
    iget-object v2, p1, Lcom/twitter/library/av/c;->s:Lbvn;

    iget-wide v6, v2, Lbvn;->b:J

    iput-wide v6, v3, Lcom/twitter/library/scribe/TwitterScribeItem;->ae:J
    ...
    iput v2, v3, Lcom/twitter/library/scribe/TwitterScribeItem;->af:I

    .line 174
    iget-object v2, p1, Lcom/twitter/library/av/c;->s:Lbvn;

    iget-wide v6, v2, Lbvn;->d:J

    iput-wide v6, v3, Lcom/twitter/library/scribe/TwitterScribeItem;->ag:J

    .line 175
    const-string/jumbo v2, "live_video_heartbeat_event"

    invoke-virtual {v0, v2}, Lcom/twitter/library/scribe/TwitterScribeLog;->h(Ljava/lang/String;)Lcom/twitter/library/scribe/ScribeLog;
    ...
    .line 189
    iget-object v0, p0, Lcom/twitter/android/av/b;->d:Lsx;
    ...
    invoke-virtual/range {v0 .. v5}, Lsx;->a(Landroid/content/Context;Ljava/lang/String;Lcom/twitter/model/av/AVMediaPlaylist;Lcom/twitter/model/av/AVMedia;Ljava/lang/String;)V
