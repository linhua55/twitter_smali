.class public Lcom/twitter/android/av/bg;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcom/twitter/android/av/bh;-><init>()V

    sput-object v0, Lcom/twitter/android/av/bg;->a:Lcom/twitter/library/av/playback/m;
...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/av/playback/ba;)V
    ...
    invoke-direct {v0, p2}, Lcom/twitter/android/av/l;-><init>(Lcom/twitter/library/av/playback/ba;)V

    new-instance v1, Lcom/twitter/android/av/b;

    invoke-direct {v1, p1, p2}, Lcom/twitter/android/av/b;-><init>(Landroid/content/Context;Lcom/twitter/library/av/playback/ba;)V

    invoke-direct {p0, v0, v1}, Lcom/twitter/android/av/bg;-><init>(Lcom/twitter/android/av/l;Lcom/twitter/android/av/b;)V
...
.method constructor <init>(Lcom/twitter/android/av/l;Lcom/twitter/android/av/b;)V
    ...
    .line 45
    iput-object p2, p0, Lcom/twitter/android/av/bg;->c:Lcom/twitter/android/av/b;
    ...
    iput-boolean v0, p0, Lcom/twitter/android/av/bg;->d:Z
    ...
    iput-object v0, p0, Lcom/twitter/android/av/bg;->e:Lcom/twitter/android/av/j;
...
.method public a(Ljava/lang/String;Lcom/twitter/library/av/c;)V
    ...
    .prologue
    .line 59
    iget-boolean v0, p0, Lcom/twitter/android/av/bg;->d:Z

    if-eqz v0, :cond_0

    .line 60
    invoke-virtual {p0, p1, p2}, Lcom/twitter/android/av/bg;->c(Ljava/lang/String;Lcom/twitter/library/av/c;)Lcom/twitter/util/concurrent/j;
    ...
    .line 62
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/twitter/android/av/bg;->b(Ljava/lang/String;Lcom/twitter/library/av/c;)V
...
.method protected b(Ljava/lang/String;Lcom/twitter/library/av/c;)V
    ...
    .line 75
    :pswitch_0
    iget-object v0, p0, Lcom/twitter/android/av/bg;->e:Lcom/twitter/android/av/j;
    ...
    .line 79
    :pswitch_1
    iget-object v0, p0, Lcom/twitter/android/av/bg;->c:Lcom/twitter/android/av/b;
...
.method c(Ljava/lang/String;Lcom/twitter/library/av/c;)Lcom/twitter/util/concurrent/j;
    ...
    new-instance v1, Lcom/twitter/android/av/bi;

    invoke-direct {v1, p0, p1, p2}, Lcom/twitter/android/av/bi;-><init>(Lcom/twitter/android/av/bg;Ljava/lang/String;Lcom/twitter/library/av/c;)V
