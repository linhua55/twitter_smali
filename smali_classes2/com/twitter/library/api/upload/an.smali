.class public Lcom/twitter/library/api/upload/an;
...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/service/ab;)V
    ...
    .line 41
    iput-object p1, p0, Lcom/twitter/library/api/upload/an;->a:Landroid/content/Context;

    .line 42
    iput-object p2, p0, Lcom/twitter/library/api/upload/an;->b:Lcom/twitter/library/service/ab;
    ...
    iput-object v0, p0, Lcom/twitter/library/api/upload/an;->d:Lcom/twitter/internal/network/HttpOperation$RequestMethod;

    .line 44
    const v0, 0xea60

    iput v0, p0, Lcom/twitter/library/api/upload/an;->f:I
...
.method public a()Lcom/twitter/internal/network/HttpOperation;
    ...
    .prologue
    .line 150
    iget-object v0, p0, Lcom/twitter/library/api/upload/an;->c:Ljava/lang/StringBuilder;
    ...
    iget-object v1, p0, Lcom/twitter/library/api/upload/an;->a:Landroid/content/Context;

    iget-object v2, p0, Lcom/twitter/library/api/upload/an;->c:Ljava/lang/StringBuilder;

    invoke-direct {v0, v1, v2}, Lcom/twitter/library/network/j;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/twitter/library/api/upload/an;->b:Lcom/twitter/library/service/ab;
    ...
    iget-object v1, p0, Lcom/twitter/library/api/upload/an;->d:Lcom/twitter/internal/network/HttpOperation$RequestMethod;
    ...
    iget-object v2, p0, Lcom/twitter/library/api/upload/an;->b:Lcom/twitter/library/service/ab;
    ...
    iget-object v1, p0, Lcom/twitter/library/api/upload/an;->e:Lcom/twitter/internal/network/i;
    ...
    iget-object v1, p0, Lcom/twitter/library/api/upload/an;->g:Lorg/apache/http/HttpEntity;
    ...
    .line 163
    iget v1, p0, Lcom/twitter/library/api/upload/an;->f:I
...
.method public a(Lcom/twitter/internal/network/i;)Lcom/twitter/library/api/upload/an;
    .locals 0

    .prologue
    .line 79
    iput-object p1, p0, Lcom/twitter/library/api/upload/an;->e:Lcom/twitter/internal/network/i;

    .line 80
    return-object p0
.end method

.method public a(Ljava/lang/String;)Lcom/twitter/library/api/upload/an;
    .locals 2
    ...
    iput-object v0, p0, Lcom/twitter/library/api/upload/an;->g:Lorg/apache/http/HttpEntity;

    .line 96
    iget-object v0, p0, Lcom/twitter/library/api/upload/an;->g:Lorg/apache/http/HttpEntity;
...
.method public a(Ljava/lang/String;Landroid/net/Uri;)Lcom/twitter/library/api/upload/an;
    .locals 4
    ...
    iget-object v2, p0, Lcom/twitter/library/api/upload/an;->a:Landroid/content/Context;

    const/4 v3, 0x0

    invoke-direct {v0, v2, v3}, Lcom/twitter/library/network/n;-><init>(Landroid/content/Context;Lcom/twitter/internal/network/s;)V

    .line 113
    const/16 v2, 0x8

    invoke-static {v2}, Lcom/twitter/util/aj;->a(I)Ljava/lang/String;
    ...
    .line 114
    invoke-virtual {v0}, Lcom/twitter/library/network/n;->a()V
    :try_end_0
...
.method public a(Ljava/lang/StringBuilder;)Lcom/twitter/library/api/upload/an;
    .locals 0

    .prologue
    .line 69
    iput-object p1, p0, Lcom/twitter/library/api/upload/an;->c:Ljava/lang/StringBuilder;

    .line 70
    return-object p0
.end method

.method public a(Ljava/util/ArrayList;)Lcom/twitter/library/api/upload/an;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ">;)",
            "Lcom/twitter/library/api/upload/an;"
        }
    .end annotation
    ...
    .line 86
    invoke-static {p1}, Lcom/twitter/library/util/an;->a(Ljava/util/List;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/twitter/library/api/upload/an;->a(Ljava/lang/String;)Lcom/twitter/library/api/upload/an;
