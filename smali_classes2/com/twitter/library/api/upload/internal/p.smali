...
.field private n:Lcom/twitter/library/util/r;
...
# direct methods
.method constructor <init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/media/model/MediaFile;Lcom/twitter/library/api/upload/g;Lcom/twitter/util/y;ILjava/util/List;Lcom/twitter/library/api/upload/MediaUsage;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 82
    invoke-direct {p0, p1, p2, p4, p5}, Lcom/twitter/library/api/upload/internal/a;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/library/api/upload/g;Lcom/twitter/util/y;)V
...
.method private a(Lcom/twitter/library/util/ac;IJLjava/lang/String;)V
    .locals 13
    ...
    invoke-direct/range {v0 .. v11}, Lcom/twitter/library/api/upload/internal/w;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/media/model/MediaFile;JLcom/twitter/library/util/ac;IJLjava/lang/String;Z)V
...
.method private g()V
    ...
    .line 320
    iget-object v0, p0, Lcom/twitter/library/api/upload/internal/p;->n:Lcom/twitter/library/util/r;
...
.method a(Lcoy;Lcom/twitter/internal/android/service/ab;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p1, Lcoy;->f:Lcox;

    if-eqz v0, :cond_1

    iget-object v0, p1, Lcoy;->f:Lcox;

    iget-object v0, v0, Lcox;->c:Ljava/lang/String;
...
.method c()V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/twitter/library/util/r;-><init>(Ljava/io/RandomAccessFile;JJ)V

    iput-object v0, p0, Lcom/twitter/library/api/upload/internal/p;->n:Lcom/twitter/library/util/r;
    ...
    .line 177
    iget-object v1, p0, Lcom/twitter/library/api/upload/internal/p;->n:Lcom/twitter/library/util/r;

    invoke-virtual {v1}, Lcom/twitter/library/util/r;->a()I
...
.method d()V
    ...
    invoke-virtual {v0}, Lcom/twitter/library/util/r;->hasNext()Z
    ...
    invoke-virtual {v0}, Lcom/twitter/library/util/r;->b()Lcom/twitter/library/util/ac;
    ...
    .line 204
    invoke-virtual {v0}, Lcom/twitter/library/util/r;->d()J
    ...
    .line 205
    invoke-virtual {v0}, Lcom/twitter/library/util/r;->e()Ljava/lang/String;
    ...
    .line 201
    invoke-direct/range {v1 .. v6}, Lcom/twitter/library/api/upload/internal/p;->a(Lcom/twitter/library/util/ac;IJLjava/lang/String;)V
