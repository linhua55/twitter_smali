...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/media/model/MediaFile;Ljava/util/List;Lcom/twitter/library/api/upload/g;Lcom/twitter/util/y;Lcom/twitter/library/api/upload/MediaUsage;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 55
    invoke-direct {p0, p1, p2, p5, p6}, Lcom/twitter/library/api/upload/internal/a;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/library/api/upload/g;Lcom/twitter/util/y;)V
...
.method private a(Lcom/twitter/media/model/MediaFile;)V
    ...
    iget-object v5, p0, Lcom/twitter/library/api/upload/internal/c;->c:Lcom/twitter/util/y;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/twitter/library/api/upload/internal/n;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/media/model/MediaFile;Lcom/twitter/library/api/upload/g;Lcom/twitter/util/y;Ljava/util/List;Ljava/util/List;Lcom/twitter/library/api/upload/MediaUsage;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/twitter/library/api/upload/internal/h;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/media/model/MediaFile;Lcom/twitter/library/api/upload/g;Lcom/twitter/util/y;Lcom/twitter/library/api/upload/MediaUsage;)V
