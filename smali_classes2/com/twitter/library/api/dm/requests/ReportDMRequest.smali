...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/client/Session;JLcom/twitter/library/api/dm/requests/ReportDMRequest$Type;)V
    ...
    .line 32
    invoke-static {p5}, Lcom/twitter/util/object/g;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/api/t;)V
    ...
    .prologue
    .line 53
    invoke-virtual {p0}, Lcom/twitter/library/api/dm/requests/ReportDMRequest;->S()Lcom/twitter/library/provider/dm;

    move-result-object v0

    .line 54
    invoke-virtual {p0}, Lcom/twitter/library/api/dm/requests/ReportDMRequest;->T()Lcom/twitter/library/provider/b;
    ...
    invoke-virtual {v0, v2, v3, v4, v1}, Lcom/twitter/library/provider/dm;->b(JZLcom/twitter/library/provider/b;)V
    ...
    invoke-virtual {v0, v2, v3, v1}, Lcom/twitter/library/provider/dm;->e(JLcom/twitter/library/provider/b;)V

    .line 61
    invoke-virtual {v1}, Lcom/twitter/library/provider/b;->a()V

    .line 65
    new-instance v0, Lcom/twitter/library/api/dm/requests/o;

    iget-object v1, p0, Lcom/twitter/library/api/dm/requests/ReportDMRequest;->p:Landroid/content/Context;

    invoke-virtual {p0}, Lcom/twitter/library/api/dm/requests/ReportDMRequest;->N()Lcom/twitter/library/service/ab;

    move-result-object v2

    iget-wide v4, p0, Lcom/twitter/library/api/dm/requests/ReportDMRequest;->a:J

    invoke-direct {v0, v1, v2, v4, v5}, Lcom/twitter/library/api/dm/requests/o;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;J)V

    invoke-virtual {v0}, Lcom/twitter/library/api/dm/requests/o;->P()Lcom/twitter/library/service/aa;
...
.method protected b()Lcom/twitter/library/service/e;
    ...
    .prologue
    .line 38
    invoke-virtual {p0}, Lcom/twitter/library/api/dm/requests/ReportDMRequest;->K()Lcom/twitter/library/service/e;
