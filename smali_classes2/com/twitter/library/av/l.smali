...
# instance fields
.field private final b:Lcom/twitter/library/av/ag;
...
.method constructor <init>(Landroid/content/Context;Ljava/util/Map;Ljava/util/Map;Ljava/util/Set;Lcom/twitter/library/av/ai;Lcom/twitter/library/av/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 136
    invoke-static {p0, p2, p3}, Lcom/twitter/library/av/l;->a(Lcom/twitter/library/av/l;Ljava/util/Map;Ljava/util/Map;)Lcom/twitter/library/av/ah;

    move-result-object v0

    .line 135
    invoke-virtual {p5, p1, v0, p6}, Lcom/twitter/library/av/ai;->a(Landroid/content/Context;Lcom/twitter/library/av/ah;Lcom/twitter/library/av/f;)Lcom/twitter/library/av/ag;

    move-result-object v0

    iput-object v0, p0, Lcom/twitter/library/av/l;->b:Lcom/twitter/library/av/ag;
...
.method constructor <init>(Landroid/content/Context;Ljava/util/Map;Ljava/util/Map;Ljava/util/Set;Lcom/twitter/library/av/f;)V
    ...
    .prologue
    .line 122
    new-instance v5, Lcom/twitter/library/av/ai;

    invoke-direct {v5}, Lcom/twitter/library/av/ai;-><init>()V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/twitter/library/av/l;-><init>(Landroid/content/Context;Ljava/util/Map;Ljava/util/Map;Ljava/util/Set;Lcom/twitter/library/av/ai;Lcom/twitter/library/av/f;)V

    .line 124
    return-void
.end method

.method protected static a(Lcom/twitter/library/av/l;Ljava/util/Map;Ljava/util/Map;)Lcom/twitter/library/av/ah;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public a()Ljava/util/List;
    ...
    .prologue
    .line 305
    iget-object v0, p0, Lcom/twitter/library/av/l;->b:Lcom/twitter/library/av/ag;

    invoke-virtual {v0}, Lcom/twitter/library/av/ag;->a()Ljava/util/List;
...
.method public a(Lcom/twitter/library/av/playback/ba;Lcom/twitter/model/av/AVMedia;Lcom/twitter/model/av/AVMediaPlaylist;)V
    .locals 3

    .prologue
    .line 218
    invoke-virtual {p1}, Lcom/twitter/library/av/playback/ba;->b()Z
    ...
    .line 230
    invoke-interface {v0}, Lcom/twitter/library/av/n;->bl_()V
    ...
    .line 236
    invoke-virtual {v0, v1, v2}, Lcom/twitter/library/av/ag;->a(Ljava/util/List;Lcom/twitter/model/av/DynamicAd;)V
...
.method public a(Ljava/util/List;)V
    ...
    invoke-virtual {v0, v1}, Lcom/twitter/library/av/ag;->a(Ljava/util/List;)V
