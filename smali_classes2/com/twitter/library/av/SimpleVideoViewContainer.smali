...
# instance fields
.field private final b:Lcom/twitter/library/av/j;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/av/playback/AVPlayerAttachment;Lcom/twitter/library/av/be;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/twitter/library/av/SimpleVideoViewContainer;-><init>(Landroid/content/Context;Lcom/twitter/library/av/playback/AVPlayerAttachment;Lcom/twitter/library/av/be;Lcom/twitter/library/av/j;)V

    .line 29
    return-void
.end method

.method constructor <init>(Landroid/content/Context;Lcom/twitter/library/av/playback/AVPlayerAttachment;Lcom/twitter/library/av/be;Lcom/twitter/library/av/j;)V
    .locals 0

    .prologue
    .line 43
    invoke-direct {p0, p1, p2, p3}, Lcom/twitter/library/av/VideoViewContainer;-><init>(Landroid/content/Context;Lcom/twitter/library/av/playback/AVPlayerAttachment;Lcom/twitter/library/av/be;)V

    .line 44
    iput-object p4, p0, Lcom/twitter/library/av/SimpleVideoViewContainer;->b:Lcom/twitter/library/av/j;
...
.method public a()Z
    ...
    .line 104
    iget-object v0, p0, Lcom/twitter/library/av/SimpleVideoViewContainer;->c:Landroid/view/View;

    invoke-virtual {p0, v0}, Lcom/twitter/library/av/SimpleVideoViewContainer;->removeView(Landroid/view/View;)V

    .line 108
    :cond_0
    iget-object v0, p0, Lcom/twitter/library/av/SimpleVideoViewContainer;->f:Lcom/twitter/library/av/playback/AVPlayerAttachment;
    ...
    invoke-virtual {v0, p0}, Lcom/twitter/library/av/v;->b(Lcom/twitter/library/av/z;)V
...
.method protected getSurfaceTexture()Landroid/graphics/SurfaceTexture;
    ...
    iget-object v1, p0, Lcom/twitter/library/av/SimpleVideoViewContainer;->b:Lcom/twitter/library/av/j;
