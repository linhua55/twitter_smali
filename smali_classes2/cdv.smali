...
# instance fields
.field final a:Lcom/twitter/util/math/c;
...
.method public constructor <init>(FILjava/util/List;)V
    ...
    .line 64
    iput-object p3, p0, Lcdv;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lcdv;->a:Lcom/twitter/util/math/c;
...
.method public constructor <init>(Lcom/twitter/model/media/EditableImage;)V
    ...
    invoke-direct {p0, p1, v0}, Lcdv;-><init>(Lcom/twitter/model/media/EditableImage;Ljava/util/List;)V
...
.method public constructor <init>(Lcom/twitter/model/media/EditableImage;Ljava/util/List;)V
    ...
    .line 57
    iput-object p2, p0, Lcdv;->e:Ljava/util/List;
...
.method public a(Landroid/content/Context;Lcom/twitter/media/request/ImageResponse;)Lcom/twitter/util/concurrent/j;
    ...
    .line 77
    :cond_0
    iget-object v1, p0, Lcdv;->e:Ljava/util/List;
    ...
    invoke-direct {v2, p0, p2, p1, v0}, Lcdw;-><init>(Lcdv;Lcom/twitter/media/request/ImageResponse;Landroid/content/Context;Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v1, p0}, Lcdx;-><init>(Lcdv;)V
...
.method a(Landroid/content/Context;F)Ljava/util/List;
    ...
    .line 123
    iget-object v0, p0, Lcdv;->e:Ljava/util/List;
    ...
    iget-object v5, p0, Lcdv;->a:Lcom/twitter/util/math/c;

    iget v6, p0, Lcdv;->c:I

    invoke-virtual {v0, v4, v5, v6}, Lcpo;->a(FLcom/twitter/util/math/c;I)Landroid/graphics/Matrix;
    ...
    .line 138
    iget-object v6, v0, Lcpo;->b:Lcpf;

    iget-object v6, v6, Lcpf;->j:Lcpu;
    ...
    .line 140
    iget-object v6, v0, Lcpu;->c:Lcpk;

    iget-object v6, v6, Lcpk;->c:Ljava/lang/String;
    ...
    invoke-direct {v6, v0}, Lcom/twitter/library/media/util/ad;-><init>(Lcpu;)V
...
.method public a(Landroid/content/Context;Landroid/graphics/Bitmap;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lcdv;->a(Landroid/content/Context;F)Ljava/util/List;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 182
    iget-object v2, p0, Lcdv;->e:Ljava/util/List;

    iget-object v3, p1, Lcdv;->e:Ljava/util/List;

    invoke-static {v2, v3}, Lczz;->b(Ljava/lang/Iterable;Ljava/lang/Iterable;)Z

    move-result v2

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcdv;->a:Lcom/twitter/util/math/c;

    iget-object v3, p1, Lcdv;->a:Lcom/twitter/util/math/c;
...
.method public hashCode()I
    ...
    iget-object v1, p0, Lcdv;->a:Lcom/twitter/util/math/c;
