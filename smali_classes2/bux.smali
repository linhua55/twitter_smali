...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/client/Session;JIJJLjava/lang/Integer;)V
    ...
    .line 49
    iput-wide p3, p0, Lbux;->a:J

    .line 50
    iput p5, p0, Lbux;->b:I

    .line 51
    iput-wide p6, p0, Lbux;->c:J

    .line 52
    iput-wide p8, p0, Lbux;->h:J

    .line 53
    iput-object p10, p0, Lbux;->i:Ljava/lang/Integer;
...
.method private t()Landroid/net/Uri;
    ...
    .prologue
    .line 114
    invoke-virtual {p0}, Lbux;->N()Lcom/twitter/library/service/ab;
    ...
    .line 120
    :sswitch_0
    sget-object v2, Lcom/twitter/library/provider/dk;->x:Landroid/net/Uri;

    iget-wide v4, p0, Lbux;->a:J

    invoke-static {v2, v4, v5}, Landroid/content/ContentUris;->withAppendedId(Landroid/net/Uri;J)Landroid/net/Uri;

    move-result-object v2

    invoke-static {v2, v0, v1}, Lcom/twitter/library/provider/cn;->a(Landroid/net/Uri;J)Landroid/net/Uri;
    ...
    .line 125
    :sswitch_1
    sget-object v2, Lcom/twitter/library/provider/dk;->y:Landroid/net/Uri;
...
.method protected a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/api/as;)V
    ...
    .line 155
    :cond_1
    invoke-virtual {p0}, Lbux;->S()Lcom/twitter/library/provider/dm;

    move-result-object v1

    .line 156
    invoke-virtual {p0}, Lbux;->T()Lcom/twitter/library/provider/b;
    ...
    iput-object v0, p0, Lbux;->k:Lcom/twitter/model/core/TwitterUser;

    .line 170
    iget-object v2, p0, Lbux;->k:Lcom/twitter/model/core/TwitterUser;

    iget-wide v3, p0, Lbux;->a:J

    iget v5, p0, Lbux;->b:I

    iget-wide v6, p0, Lbux;->c:J

    iget-wide v8, p0, Lbux;->h:J

    invoke-virtual/range {v1 .. v10}, Lcom/twitter/library/provider/dm;->a(Lcom/twitter/model/core/TwitterUser;JIJJLcom/twitter/library/provider/b;)Z

    move-result v0

    iput-boolean v0, p0, Lbux;->j:Z
    ...
    .line 173
    iget-object v0, p0, Lbux;->k:Lcom/twitter/model/core/TwitterUser;
...
.method protected bridge synthetic a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/service/c;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lbux;->a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/api/as;)V
...
.method protected b()Lcom/twitter/library/service/e;
    ...
    .line 65
    :cond_0
    invoke-virtual {p0}, Lbux;->K()Lcom/twitter/library/service/e;
    ...
    .line 67
    invoke-direct {p0}, Lbux;->t()Landroid/net/Uri;

    move-result-object v2

    const-string/jumbo v3, "users_user_id"

    invoke-virtual {v0, v2, v3, v4, v4}, Lcom/twitter/library/provider/dm;->a(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)[J
    ...
    .line 72
    iget-object v2, p0, Lbux;->i:Ljava/lang/Integer;
    ...
    iget-object v3, p0, Lbux;->i:Ljava/lang/Integer;
...
.method protected synthetic f()Lcom/twitter/library/service/c;
    ...
    .prologue
    .line 31
    invoke-virtual {p0}, Lbux;->e()Lcom/twitter/library/api/as;
