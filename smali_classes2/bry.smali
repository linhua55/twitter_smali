...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/client/Session;Lcom/twitter/model/core/Tweet;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0, p3, p4}, Lbry;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/model/core/Tweet;Ljava/util/List;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/library/service/ab;Lcom/twitter/model/core/Tweet;Ljava/util/List;)V
    ...
    iput-object v0, p0, Lbry;->a:Ljava/util/List;

    .line 52
    iput-object p3, p0, Lbry;->b:Lcom/twitter/model/core/Tweet;

    .line 53
    iput-object p4, p0, Lbry;->c:Ljava/util/List;
...
.method private a(Lcom/twitter/library/api/ai;)V
    ...
    .line 114
    invoke-virtual {p0}, Lbry;->S()Lcom/twitter/library/provider/dm;

    move-result-object v0

    .line 115
    invoke-virtual {p0}, Lbry;->N()Lcom/twitter/library/service/ab;
    ...
    .line 124
    iget-wide v6, v0, Lcom/twitter/model/core/cs;->b:J

    invoke-static {v6, v7, v2, v3}, Lcom/twitter/library/provider/cn;->a(JJ)Landroid/net/Uri;

    move-result-object v8

    .line 126
    iget-object v0, p0, Lbry;->p:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v7

    sget-object v9, Lcho;->b:[Ljava/lang/String;
    ...
    invoke-virtual {v0, v5}, Lcgi;->a(Landroid/database/Cursor;)Lcom/twitter/model/core/Tweet;
...
.method protected a()Lcom/twitter/library/service/d;
    ...
    .line 59
    invoke-virtual {p0}, Lbry;->K()Lcom/twitter/library/service/e;
    ...
    iget-object v2, p0, Lbry;->b:Lcom/twitter/model/core/Tweet;
    ...
    .line 65
    iget-object v1, p0, Lbry;->c:Ljava/util/List;
    ...
    .line 69
    :cond_0
    iget-object v1, p0, Lbry;->b:Lcom/twitter/model/core/Tweet;
...
.method protected a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/service/c;)V
    ...
    .line 87
    invoke-direct {p0, v0}, Lbry;->a(Lcom/twitter/library/api/ai;)V
