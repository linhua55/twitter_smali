...
.method public static a(Landroid/content/Context;Lcom/twitter/library/client/Session;Lcom/twitter/model/core/Tweet;)Lbtg;
    .locals 4
    ...
    invoke-direct {v0, p0, p1, v2, v3}, Lbtg;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;J)V

    invoke-virtual {v0, p2}, Lbtg;->a(Lcom/twitter/model/core/Tweet;)Lbtg;
...
# virtual methods
.method public a(Lcom/twitter/model/core/Tweet;)Lbtg;
    .locals 2
...
.method protected a()Lcom/twitter/library/service/d;
    ...
    .prologue
    .line 63
    invoke-virtual {p0}, Lbtg;->K()Lcom/twitter/library/service/e;
...
.method protected a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/api/t;)V
    ...
    .line 79
    iget-object v0, p0, Lbtg;->p:Landroid/content/Context;
    ...
    .line 81
    invoke-virtual {p0}, Lbtg;->T()Lcom/twitter/library/provider/b;
    ...
    .line 85
    iget-wide v4, p0, Lbtg;->b:J

    invoke-virtual {v1, v4, v5, v0, v2}, Lcom/twitter/library/provider/dm;->a(JLcom/twitter/model/core/cs;Lcom/twitter/library/provider/b;)V
    ...
    invoke-virtual {v1, v4, v5}, Lcom/twitter/library/provider/dm;->c(J)Lcom/twitter/model/core/cs;
    ...
    .line 100
    :cond_2
    iget-wide v2, p0, Lbtg;->a:J

    iget-wide v4, p0, Lbtg;->b:J

    invoke-virtual {v1, v2, v3, v4, v5}, Lcom/twitter/library/provider/dm;->a(JJ)Z
...
.method protected bridge synthetic a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/service/c;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lbtg;->a(Lcom/twitter/internal/network/HttpOperation;Lcom/twitter/library/service/aa;Lcom/twitter/library/api/t;)V
...
.method protected b(Lcom/twitter/library/service/aa;)Z
    ...
    iget-object v2, p0, Lbtg;->p:Landroid/content/Context;

    invoke-virtual {p0}, Lbtg;->N()Lcom/twitter/library/service/ab;

    move-result-object v3

    iget-wide v4, p0, Lbtg;->g:J

    iget-boolean v6, p0, Lbtg;->h:Z

    invoke-direct/range {v1 .. v6}, Lbto;-><init>(Landroid/content/Context;Lcom/twitter/library/service/ab;JZ)V

    .line 115
    invoke-virtual {v1}, Lbto;->P()Lcom/twitter/library/service/aa;

    move-result-object v0

    .line 116
    invoke-virtual {v1, v0}, Lbto;->c(Lcom/twitter/library/service/aa;)V
...
.method protected synthetic f()Lcom/twitter/library/service/c;
    ...
    .prologue
    .line 25
    invoke-virtual {p0}, Lbtg;->b()Lcom/twitter/library/api/t;
