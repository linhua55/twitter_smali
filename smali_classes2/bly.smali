...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    .line 64
    iput-object p1, p0, Lbly;->b:Landroid/content/Context;

    .line 65
    iput-object p2, p0, Lbly;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lbly;->d:Lcom/twitter/library/client/bd;
    ...
    iput-object v0, p0, Lbly;->c:Lcom/twitter/library/client/bk;

    .line 68
    return-void
.end method

.method public static a(Landroid/content/Context;Landroid/support/v4/app/LoaderManager;ILblz;)V
    .locals 1
    ...
    .line 59
    invoke-static {p0, p1, p2, v0}, Lbly;->a(Landroid/content/Context;Landroid/support/v4/app/LoaderManager;ILjava/util/List;)V
...
.method public static a(Landroid/content/Context;Landroid/support/v4/app/LoaderManager;ILjava/util/List;)V
    ...
    invoke-direct {v1, p0, p3}, Lbly;-><init>(Landroid/content/Context;Ljava/util/List;)V
...
.method public a(Landroid/support/v4/content/Loader;Landroid/database/Cursor;)V
    ...
    .prologue
    .line 84
    iget-object v0, p0, Lbly;->c:Lcom/twitter/library/client/bk;
    ...
    sget-object v4, Lcom/twitter/model/ads/e;->a:Lcom/twitter/util/serialization/ah;
    ...
    .line 94
    iget-object v1, p0, Lbly;->e:Ljava/util/List;
    ...
    .line 95
    invoke-interface {v1, v0}, Lblz;->a(Lcom/twitter/model/ads/e;)V
    ...
    .line 108
    iget-object v0, p0, Lbly;->d:Lcom/twitter/library/client/bd;

    new-instance v2, Lbma;

    iget-object v3, p0, Lbly;->b:Landroid/content/Context;

    invoke-direct {v2, v3, v1}, Lbma;-><init>(Landroid/content/Context;Lcom/twitter/library/client/Session;)V

    invoke-virtual {v0, v2}, Lcom/twitter/library/client/bd;->a(Lcom/twitter/library/service/x;)Ljava/lang/String;
...
.method public onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/content/Loader;
    ...
    iget-object v1, p0, Lbly;->b:Landroid/content/Context;

    .line 75
    invoke-static {v2, v3}, Lcom/twitter/library/provider/cp;->a(J)Landroid/net/Uri;

    move-result-object v2

    sget-object v3, Lbly;->a:[Ljava/lang/String;
...
.method public synthetic onLoadFinished(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lbly;->a(Landroid/support/v4/content/Loader;Landroid/database/Cursor;)V
