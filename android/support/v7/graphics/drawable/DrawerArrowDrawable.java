...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        setColor(obtainStyledAttributes.getColor(R.styleable.DrawerArrowToggle_color, ARROW_DIRECTION_LEFT));
        ...
        this.mSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.DrawerArrowToggle_drawableSize, ARROW_DIRECTION_LEFT);
