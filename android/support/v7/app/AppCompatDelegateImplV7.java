...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            if (windowCallback != null) {
                windowCallback.onMenuOpened(mx.AppCompatTheme_ratingBarStyleSmall, menuBuilder);
            }
            return true;
        }
        ...
        this.mInvalidatePanelMenuRunnable = new Runnable() {
            public void run() {
                ...
                if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0) {
                    AppCompatDelegateImplV7.this.doInvalidatePanelMenu(mx.AppCompatTheme_ratingBarStyleSmall);
                }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (panelState == null || panelState.menu == null) {
                    invalidatePanelMenu(mx.AppCompatTheme_ratingBarStyleSmall);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (obtainStyledAttributes.getBoolean(R.styleable.AppCompatTheme_windowNoTitle, false)) {
                ...
                requestWindowFeature(mx.AppCompatTheme_ratingBarStyleSmall);
            }
            if (obtainStyledAttributes.getBoolean(R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(mx.AppCompatTheme_seekBarStyle);
            }
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(mx.AppCompatTheme_seekBarStyle);
                }
    ...
    public boolean requestWindowFeature(int i) {
        ...
        if (this.mWindowNoTitle && sanitizeWindowFeatureId == mx.AppCompatTheme_ratingBarStyleSmall) {
            return false;
        }
        ...
        switch (sanitizeWindowFeatureId) {
            ...
            case mx.AppCompatTheme_ratingBarStyleSmall /*108*/:
                ...
                return true;
            case mx.AppCompatTheme_seekBarStyle /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int i, Menu menu) {
        if (i == mx.AppCompatTheme_ratingBarStyleSmall) {
            ActionBar supportActionBar = getSupportActionBar();
            if (supportActionBar != null) {
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z, z2, true, z2);
    }
    ...
    private void reopenMenu(MenuBuilder menuBuilder, boolean z) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && z) {
            ...
            if (!isDestroyed()) {
                windowCallback.onPanelClosed(mx.AppCompatTheme_ratingBarStyleSmall, getPanelState(0, true).menu);
            }
            ...
            if (panelState2.menu != null && !panelState2.refreshMenuContent && windowCallback.onPreparePanel(0, panelState2.createdPanelView, panelState2.menu)) {
                windowCallback.onMenuOpened(mx.AppCompatTheme_ratingBarStyleSmall, panelState2.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == mx.AppCompatTheme_ratingBarStyleSmall) && this.mDecorContentParent != null) {
            TypedValue typedValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        boolean z = panelFeatureState.featureId == 0 || panelFeatureState.featureId == mx.AppCompatTheme_ratingBarStyleSmall;
    ...
    private void checkCloseActionMenu(MenuBuilder menuBuilder) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback windowCallback = getWindowCallback();
            if (!(windowCallback == null || isDestroyed())) {
                windowCallback.onPanelClosed(mx.AppCompatTheme_ratingBarStyleSmall, menuBuilder);
            }
    ...
    private void doInvalidatePanelMenu(int i) {
        ...
        panelState.refreshDecorView = true;
        if ((i == mx.AppCompatTheme_ratingBarStyleSmall || i == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int i) {
        if (i == 8) {
            ...
            return mx.AppCompatTheme_ratingBarStyleSmall;
        } else if (i != 9) {
            return i;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return mx.AppCompatTheme_seekBarStyle;
        }
    }
