...
class ToolbarActionBar extends ActionBar {
    ...
    final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(mx.AppCompatTheme_ratingBarStyleSmall, menuBuilder);
            return true;
        }
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(mx.AppCompatTheme_ratingBarStyleSmall, menuBuilder);
                }
