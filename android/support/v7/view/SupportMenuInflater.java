...
public class SupportMenuInflater extends MenuInflater {
    ...
    class MenuState {
        ...
        public void readGroup(AttributeSet attributeSet) {
            ...
            this.groupId = obtainStyledAttributes.getResourceId(R.styleable.MenuGroup_android_id, defaultItemOrder);
            this.groupCategory = obtainStyledAttributes.getInt(R.styleable.MenuGroup_android_menuCategory, defaultItemOrder);
            this.groupOrder = obtainStyledAttributes.getInt(R.styleable.MenuGroup_android_orderInCategory, defaultItemOrder);
            this.groupCheckable = obtainStyledAttributes.getInt(R.styleable.MenuGroup_android_checkableBehavior, defaultItemOrder);
            this.groupVisible = obtainStyledAttributes.getBoolean(R.styleable.MenuGroup_android_visible, defaultItemVisible);
            this.groupEnabled = obtainStyledAttributes.getBoolean(R.styleable.MenuGroup_android_enabled, defaultItemVisible);
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemId = obtainStyledAttributes.getResourceId(R.styleable.MenuItem_android_id, defaultItemOrder);
            ...
            this.itemIconResId = obtainStyledAttributes.getResourceId(R.styleable.MenuItem_android_icon, defaultItemOrder);
            ...
            if (obtainStyledAttributes.hasValue(R.styleable.MenuItem_android_checkable)) {
                this.itemCheckable = obtainStyledAttributes.getBoolean(R.styleable.MenuItem_android_checkable, defaultItemChecked) ? 1 : defaultItemOrder;
            } else {
            ...
            this.itemActionViewLayout = obtainStyledAttributes.getResourceId(R.styleable.MenuItem_actionLayout, defaultItemOrder);
