...
class ActivityChooserModel extends DataSetObservable {
    ...
    private void readHistoricalDataImpl() {
        ...
        r9 = this;
        r8 = 1;
        r0 = r9.mContext;	 Catch:{ FileNotFoundException -> 0x00de }
        r1 = r9.mHistoryFileName;	 Catch:{ FileNotFoundException -> 0x00de }
        r1 = r0.openFileInput(r1);	 Catch:{ FileNotFoundException -> 0x00de }
        r2 = android.util.Xml.newPullParser();	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r0 = "UTF-8";
        r2.setInput(r1, r0);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r0 = 0;
    L_0x0014:
    ...
    L_0x0019:
        r0 = r2.next();	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        goto L_0x0014;
    L_0x001e:
        r0 = "historical-records";
        r3 = r2.getName();	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r0 = r0.equals(r3);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        if (r0 != 0) goto L_0x0056;
    L_0x002b:
        r0 = new org.xmlpull.v1.XmlPullParserException;	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r2 = "Share records file does not start with historical-records tag.";
        r0.<init>(r2);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        throw r0;	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
    L_0x0034:
        r0 = move-exception;
        r2 = LOG_TAG;	 Catch:{ all -> 0x00d2 }
        ...
        r4 = r9.mHistoryFileName;	 Catch:{ all -> 0x00d2 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x00d2 }
        r3 = r3.toString();	 Catch:{ all -> 0x00d2 }
        android.util.Log.e(r2, r3, r0);	 Catch:{ all -> 0x00d2 }
    ...
    L_0x0055:
        return;
    L_0x0056:
        r0 = r9.mHistoricalRecords;	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r0.clear();	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
    L_0x005b:
        r3 = r2.next();	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
    ...
    L_0x006f:
        ...
        r3 = r4.equals(r3);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
    ...
    L_0x00a9:
        r3 = 0;
        r4 = "activity";
        r3 = r2.getAttributeValue(r3, r4);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r4 = 0;
        r5 = "time";
        r4 = r2.getAttributeValue(r4, r5);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r4 = java.lang.Long.parseLong(r4);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r6 = 0;
        r7 = "weight";
        r6 = r2.getAttributeValue(r6, r7);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r6 = java.lang.Float.parseFloat(r6);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r7 = new android.support.v7.widget.ActivityChooserModel$HistoricalRecord;	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r7.<init>(r3, r4, r6);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        r0.add(r7);	 Catch:{ XmlPullParserException -> 0x0034, IOException -> 0x0085 }
        goto L_0x005b;
    L_0x00d2:
        r0 = move-exception;
