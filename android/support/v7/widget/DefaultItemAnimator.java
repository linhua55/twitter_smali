...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    class AnonymousClass4 extends VpaListenerAdapter {
        ...
        AnonymousClass4(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class AnonymousClass5 extends VpaListenerAdapter {
        ...
        AnonymousClass5(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$animation = viewPropertyAnimatorCompat;
            super();
        }
    ...
    class AnonymousClass6 extends VpaListenerAdapter {
        ...
        AnonymousClass6(ViewHolder viewHolder, int i, int i2, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$deltaX = i;
            this.val$deltaY = i2;
            this.val$animation = viewPropertyAnimatorCompat;
    ...
    public void runPendingAnimations() {
        ...
        if (i4 != 0 || i != 0 || i3 != 0 || i2 != 0) {
            ...
            if (i2 != 0) {
                ...
                anonymousClass1 = new AnonymousClass2(arrayList);
                if (i4 != 0) {
            ...
            if (i3 != 0) {
                ...
                Runnable anonymousClass3 = new AnonymousClass3(arrayList2);
                if (i4 == 0 && i == 0 && i2 == 0) {
                    anonymousClass3.run();
                    return;
                }
    ...
    private void animateRemoveImpl(ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnonymousClass4(viewHolder, animate)).start();
    }
    ...
    private void animateAddImpl(ViewHolder viewHolder) {
        ...
        animate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnonymousClass5(viewHolder, animate)).start();
    }
    ...
    private void animateMoveImpl(ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        animate.setDuration(getMoveDuration()).setListener(new AnonymousClass6(viewHolder, i5, i6, animate)).start();
    }
    ...
    private void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            duration.alpha(0.0f).setListener(new AnonymousClass7(changeInfo, duration)).start();
        }
        if (view != null) {
            duration = ViewCompat.animate(view);
            this.mChangeAnimations.add(changeInfo.newHolder);
            duration.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnonymousClass8(changeInfo, duration, view)).start();
        }
    }
