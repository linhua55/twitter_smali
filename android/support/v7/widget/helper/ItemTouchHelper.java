...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class AnonymousClass1 implements AnimatorUpdateListenerCompat {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4) {
            ...
            this.mValueAnimator.addUpdateListener(new AnonymousClass1(ItemTouchHelper.this));
    ...
    class AnonymousClass3 extends RecoverAnimation {
        ...
        AnonymousClass3(ViewHolder viewHolder, int i, int i2, float f, float f2, float f3, float f4, int i3, ViewHolder viewHolder2) {
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation anonymousClass3 = new AnonymousClass3(viewHolder2, i4, i2, f2, f3, f, signum, swipeIfNecessary, viewHolder2);
