...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(size, C.ENCODING_PCM_32BIT), i2);
    }
    ...
    private void onCloseClicked() {
        if (!TextUtils.isEmpty(this.mSearchSrcTextView.getText())) {
            this.mSearchSrcTextView.setText(TtmlNode.ANONYMOUS_REGION_ID);
    ...
    public void onActionViewCollapsed() {
        setQuery(TtmlNode.ANONYMOUS_REGION_ID, IS_AT_LEAST_FROYO);
        clearFocus();
        updateViewsVisibility(true);
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        Parcelable activity = PendingIntent.getActivity(getContext(), 0, intent2, C.ENCODING_PCM_32BIT);
