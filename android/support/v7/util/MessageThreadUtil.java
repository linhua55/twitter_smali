...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class AnonymousClass1 implements MainThreadCallback<T> {
        ...
        AnonymousClass1(MainThreadCallback mainThreadCallback) {
                    ...
                    while (next != null) {
                        switch (next.what) {
                            ...
                            case AnonymousClass1.ADD_TILE /*2*/:
                                AnonymousClass1.this.val$callback.addTile(next.arg1, (Tile) next.data);
                                break;
    ...
    class AnonymousClass2 implements BackgroundCallback<T> {
        ...
        AnonymousClass2(BackgroundCallback backgroundCallback) {
                        ...
                        if (next != null) {
                            switch (next.what) {
                                ...
                                case AnonymousClass2.RECYCLE_TILE /*4*/:
                                    AnonymousClass2.this.val$callback.recycleTile((Tile) next.data);
                                    break;
                                default:
                                    Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                                    break;
