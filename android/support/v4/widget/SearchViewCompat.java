...
public final class SearchViewCompat {
    ...
    class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class AnonymousClass1 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListenerCompat val$listener;

            AnonymousClass1(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class AnonymousClass2 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListenerCompat val$listener;

            AnonymousClass2(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new AnonymousClass1(onQueryTextListenerCompat));
        }
        ...
        public Object newOnCloseListener(OnCloseListenerCompat onCloseListenerCompat) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new AnonymousClass2(onCloseListenerCompat));
        }
