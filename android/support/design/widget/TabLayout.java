...
public class TabLayout extends HorizontalScrollView {
    ...
    class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(int i, int i2) {
            ...
            if (i3 != left || i4 != right) {
                ...
                createAnimator.setUpdateListener(new AnonymousClass1(i3, left, i4, right));
                createAnimator.setListener(new AnonymousClass2(i));
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTabStrip.setSelectedIndicatorHeight(obtainStyledAttributes.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorHeight, MODE_SCROLLABLE));
        this.mTabStrip.setSelectedIndicatorColor(obtainStyledAttributes.getColor(R.styleable.TabLayout_tabIndicatorColor, MODE_SCROLLABLE));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TabLayout_tabPadding, MODE_SCROLLABLE);
        ...
        try {
            this.mTabTextSize = (float) obtainStyledAttributes2.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, MODE_SCROLLABLE);
            ...
            if (obtainStyledAttributes.hasValue(R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), obtainStyledAttributes.getColor(R.styleable.TabLayout_tabSelectedTextColor, MODE_SCROLLABLE));
            }
            this.mRequestedTabMinWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TabLayout_tabMinWidth, INVALID_WIDTH);
            this.mRequestedTabMaxWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TabLayout_tabMaxWidth, INVALID_WIDTH);
            this.mTabBackgroundResId = obtainStyledAttributes.getResourceId(R.styleable.TabLayout_tabBackground, MODE_SCROLLABLE);
            this.mContentInsetStart = obtainStyledAttributes.getDimensionPixelSize(R.styleable.TabLayout_tabContentStart, MODE_SCROLLABLE);
            this.mMode = obtainStyledAttributes.getInt(R.styleable.TabLayout_tabMode, MODE_FIXED);
            this.mTabGravity = obtainStyledAttributes.getInt(R.styleable.TabLayout_tabGravity, MODE_SCROLLABLE);
