...
public class TextInputLayout extends LinearLayout {
    ...
    class AnonymousClass3 extends ViewPropertyAnimatorListenerAdapter {
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.getResourceId(R.styleable.TextInputLayout_hintTextAppearance, INVALID_MAX_LENGTH) != INVALID_MAX_LENGTH) {
        ...
        setCounterMaxLength(obtainStyledAttributes.getInt(R.styleable.TextInputLayout_counterMaxLength, INVALID_MAX_LENGTH));
    ...
    public void setError(@Nullable CharSequence charSequence) {
        if (!TextUtils.equals(this.mError, charSequence)) {
            ...
            if (this.mErrorShown) {
                ...
                if (isLaidOut) {
                    ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new AnonymousClass3(charSequence)).start();
                } else {
                    this.mErrorView.setVisibility(4);
                }
            }
