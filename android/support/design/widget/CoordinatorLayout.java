...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = obtainStyledAttributes.getInteger(R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.mAnchorId = obtainStyledAttributes.getResourceId(R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        int resourceId = obtainStyledAttributes.getResourceId(R.styleable.CoordinatorLayout_keylines, TYPE_ON_INTERCEPT);
        if (resourceId != 0) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        z = TYPE_ON_INTERCEPT;
        Behavior behavior = ((LayoutParams) this.mBehaviorTouchView.getLayoutParams()).getBehavior();
        z2 = behavior != null ? behavior.onTouchEvent(this, this.mBehaviorTouchView, motionEvent) : TYPE_ON_INTERCEPT;
        if (this.mBehaviorTouchView == null) {
            z2 |= super.onTouchEvent(motionEvent);
        } else if (z) {
            if (TYPE_ON_INTERCEPT != null) {
