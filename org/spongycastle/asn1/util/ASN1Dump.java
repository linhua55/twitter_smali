...
public class ASN1Dump {
    static void a(String str, boolean z, ASN1Primitive aSN1Primitive, StringBuffer stringBuffer) {
        ...
        if (aSN1Primitive instanceof ASN1Sequence) {
            ...
            stringBuffer.append(str + "ObjectIdentifier(" + ((ASN1ObjectIdentifier) aSN1Primitive).a() + ")" + property);
        } else if (aSN1Primitive instanceof ASN1Boolean) {
            stringBuffer.append(str + "Boolean(" + ((ASN1Boolean) aSN1Primitive).a() + ")" + property);
        } else if (aSN1Primitive instanceof ASN1Integer) {
            stringBuffer.append(str + "Integer(" + ((ASN1Integer) aSN1Primitive).a() + ")" + property);
        } else if (aSN1Primitive instanceof DERBitString) {
            DERBitString dERBitString = (DERBitString) aSN1Primitive;
            stringBuffer.append(str + "DER Bit String" + "[" + dERBitString.e().length + ", " + dERBitString.h() + "] ");
            if (z) {
                stringBuffer.append(a(str, dERBitString.e()));
            } else {
                stringBuffer.append(property);
            }
        } else if (aSN1Primitive instanceof DERIA5String) {
            stringBuffer.append(str + "IA5String(" + ((DERIA5String) aSN1Primitive).a() + ") " + property);
        } else if (aSN1Primitive instanceof DERUTF8String) {
            stringBuffer.append(str + "UTF8String(" + ((DERUTF8String) aSN1Primitive).a() + ") " + property);
        } else if (aSN1Primitive instanceof DERPrintableString) {
            stringBuffer.append(str + "PrintableString(" + ((DERPrintableString) aSN1Primitive).a() + ") " + property);
        } else if (aSN1Primitive instanceof DERVisibleString) {
            stringBuffer.append(str + "VisibleString(" + ((DERVisibleString) aSN1Primitive).a() + ") " + property);
        } else if (aSN1Primitive instanceof DERBMPString) {
            stringBuffer.append(str + "BMPString(" + ((DERBMPString) aSN1Primitive).a() + ") " + property);
        } else if (aSN1Primitive instanceof DERT61String) {
            stringBuffer.append(str + "T61String(" + ((DERT61String) aSN1Primitive).a() + ") " + property);
        } else if (aSN1Primitive instanceof ASN1UTCTime) {
            stringBuffer.append(str + "UTCTime(" + ((ASN1UTCTime) aSN1Primitive).e() + ") " + property);
        } else if (aSN1Primitive instanceof ASN1GeneralizedTime) {
            stringBuffer.append(str + "GeneralizedTime(" + ((ASN1GeneralizedTime) aSN1Primitive).a() + ") " + property);
    ...
    private static String a(String str, String str2, boolean z, ASN1Primitive aSN1Primitive, String str3) {
        ...
        if (!dERApplicationSpecific.b()) {
            return str2 + str + " ApplicationSpecific[" + dERApplicationSpecific.e() + "] (" + new String(Hex.a(dERApplicationSpecific.a())) + ")" + str3;
        }
        try {
    ...
    public static String a(Object obj, boolean z) {
        ...
        if (obj instanceof ASN1Primitive) {
            ...
            a("", z, ((ASN1Encodable) obj).d(), stringBuffer);
        }
        return stringBuffer.toString();
    }
