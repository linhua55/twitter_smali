    ...
    static {
        a = new X9ECParametersHolder() {
            protected X9ECParameters a() {
                ...
                ECCurve a2 = SECNamedCurves.b(new Fp(c, c2, c3, c4, valueOf));
        ...
        j = new X9ECParametersHolder() {
            protected X9ECParameters a() {
                ...
                BigInteger valueOf2 = BigInteger.valueOf(1);
                ECCurve a = SECNamedCurves.b(new Fp(c, bigInteger, valueOf, c2, valueOf2), new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240));
        ...
        D = new X9ECParametersHolder() {
            protected X9ECParameters a() {
                ...
                BigInteger valueOf2 = BigInteger.valueOf(4);
                ECCurve a = SECNamedCurves.b(new F2m(409, 87, bigInteger, valueOf, c, valueOf2));
        ...
        E = new X9ECParametersHolder() {
            protected X9ECParameters a() {
                ...
                BigInteger valueOf2 = BigInteger.valueOf(2);
                ECCurve a2 = SECNamedCurves.b(new F2m(409, 87, valueOf, c, c2, valueOf2));
