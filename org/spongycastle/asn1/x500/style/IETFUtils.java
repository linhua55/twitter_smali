...
public class IETFUtils {
    private static String c(String str) {
        ...
        int i5 = 0;
        for (i = 
        /* Method generation error in method: org.spongycastle.asn1.x500.style.IETFUtils.c(java.lang.String):java.lang.String
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r0_7 'i' int) = (r0_6 'i' int), (r0_19 'i' int) binds: {(r0_6 'i' int)=B:11:0x0036, (r0_19 'i' int)=B:48:0x00ba} in method: org.spongycastle.asn1.x500.style.IETFUtils.c(java.lang.String):java.lang.String
...
Caused by: jadx.core.utils.exceptions.CodegenException: Unknown instruction: PHI in method: org.spongycastle.asn1.x500.style.IETFUtils.c(java.lang.String):java.lang.String
 ...
 */
        ...
        public static ASN1Encodable a(String str, int i) throws IOException {
        ...
        public static void a(StringBuffer stringBuffer, RDN rdn, Hashtable hashtable) {
            if (rdn.a()) {
                ...
                for (int i = 0; i != c.length; i++) {
                    ...
                    a(stringBuffer, c[i], hashtable);
                }
                return;
            }
            a(stringBuffer, rdn.b(), hashtable);
        }
        ...
        public static void a(StringBuffer stringBuffer, AttributeTypeAndValue attributeTypeAndValue, Hashtable hashtable) {
            ...
            if (str != null) {
                ...
                stringBuffer.append(attributeTypeAndValue.a().a());
            }
            stringBuffer.append('=');
            stringBuffer.append(a(attributeTypeAndValue.b()));
        }
        ...
        public static String a(ASN1Encodable aSN1Encodable) {
            ...
            if (!(aSN1Encodable instanceof ASN1String) || (aSN1Encodable instanceof DERUniversalString)) {
                try {
                    stringBuffer.append("#" + a(Hex.a(aSN1Encodable.d().a("DER"))));
                } catch (IOException e) {
        ...
        public static String a(String str) {
            ...
            if (c2.length() > 0 && c2.charAt(0) == '#') {
                ...
                if (d instanceof ASN1String) {
                    c = Strings.c(((ASN1String) d).a().trim());
                    return b(c);
                }
            }
            c = c2;
        ...
        public static boolean a(RDN rdn, RDN rdn2) {
            if (rdn.a()) {
                ...
                AttributeTypeAndValue[] c = rdn.c();
                AttributeTypeAndValue[] c2 = rdn2.c();
        ...
        private static boolean a(AttributeTypeAndValue attributeTypeAndValue, AttributeTypeAndValue attributeTypeAndValue2) {
            ...
            if (a(a(attributeTypeAndValue.b())).equals(a(a(attributeTypeAndValue2.b())))) {
                return true;
            }
            return false;
        }
