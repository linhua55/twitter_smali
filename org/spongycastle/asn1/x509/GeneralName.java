...
public class GeneralName extends ASN1Object implements ASN1Choice {
        ...
        if (obj instanceof ASN1TaggedObject) {
            ...
            switch (a) {
                case p.View_android_theme /*0*/:
                    return new GeneralName(a, ASN1Sequence.a(aSN1TaggedObject, false));
                case p.View_android_focusable /*1*/:
                    return new GeneralName(a, DERIA5String.a(aSN1TaggedObject, false));
                case p.View_paddingStart /*2*/:
                    return new GeneralName(a, DERIA5String.a(aSN1TaggedObject, false));
                case p.View_paddingEnd /*3*/:
                    throw new IllegalArgumentException("unknown tag: " + a);
                case p.View_theme /*4*/:
                    return new GeneralName(a, X500Name.a(aSN1TaggedObject, true));
                case p.Toolbar_contentInsetStart /*5*/:
                    return new GeneralName(a, ASN1Sequence.a(aSN1TaggedObject, false));
                case p.Toolbar_contentInsetEnd /*6*/:
                    return new GeneralName(a, DERIA5String.a(aSN1TaggedObject, false));
                case p.Toolbar_contentInsetLeft /*7*/:
                    return new GeneralName(a, ASN1OctetString.a(aSN1TaggedObject, false));
                case p.Toolbar_contentInsetRight /*8*/:
                    return new GeneralName(a, ASN1ObjectIdentifier.a(aSN1TaggedObject, false));
            }
        }
    ...
    public String toString() {
        ...
        switch (this.b) {
            ...
            case p.View_paddingStart /*2*/:
            case p.Toolbar_contentInsetEnd /*6*/:
                stringBuffer.append(DERIA5String.a(this.a).a());
                break;
            case p.View_theme /*4*/:
