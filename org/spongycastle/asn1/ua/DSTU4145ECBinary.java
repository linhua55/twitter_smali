...
public class DSTU4145ECBinary extends ASN1Object {
    ...
    private DSTU4145ECBinary(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.a(0) instanceof ASN1TaggedObject) {
            ...
            if (aSN1TaggedObject.e() && aSN1TaggedObject.a() == 0) {
                this.a = ASN1Integer.a(aSN1TaggedObject.h()).a();
                i = 1;
            } else {
        ...
        i++;
        this.c = ASN1Integer.a(aSN1Sequence.a(i));
        i++;
        this.d = ASN1OctetString.a(aSN1Sequence.a(i));
        i++;
        this.e = ASN1Integer.a(aSN1Sequence.a(i));
