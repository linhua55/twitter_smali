...
class X509Util {
    ...
    static {
        ...
        b = new Hashtable();
        c = new HashSet();
        a.put("MD2WITHRSAENCRYPTION", PKCSObjectIdentifiers.o_);
        a.put("MD2WITHRSA", PKCSObjectIdentifiers.o_);
        a.put("MD5WITHRSAENCRYPTION", PKCSObjectIdentifiers.e);
        a.put("MD5WITHRSA", PKCSObjectIdentifiers.e);
        a.put("SHA1WITHRSAENCRYPTION", PKCSObjectIdentifiers.p_);
        a.put("SHA1WITHRSA", PKCSObjectIdentifiers.p_);
        a.put("SHA224WITHRSAENCRYPTION", PKCSObjectIdentifiers.v_);
        a.put("SHA224WITHRSA", PKCSObjectIdentifiers.v_);
        a.put("SHA256WITHRSAENCRYPTION", PKCSObjectIdentifiers.s_);
        a.put("SHA256WITHRSA", PKCSObjectIdentifiers.s_);
        a.put("SHA384WITHRSAENCRYPTION", PKCSObjectIdentifiers.t_);
        a.put("SHA384WITHRSA", PKCSObjectIdentifiers.t_);
        a.put("SHA512WITHRSAENCRYPTION", PKCSObjectIdentifiers.u_);
        a.put("SHA512WITHRSA", PKCSObjectIdentifiers.u_);
    ...
    static Implementation a(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
    ...
    static Provider a(String str) throws NoSuchProviderException {
