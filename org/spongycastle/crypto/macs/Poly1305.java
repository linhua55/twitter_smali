...
public class Poly1305 implements Mac {
    ...
    public void a(CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters2 instanceof KeyParameter) {
            a(((KeyParameter) cipherParameters2).a(), bArr);
            c();
            return;
        }
    ...
    private void a(byte[] bArr, byte[] bArr2) {
        if (this.a == null || (bArr2 != null && bArr2.length == 16)) {
            ...
            if (this.a != null) {
                ...
                this.a.a(true, new KeyParameter(bArr, 0, 16));
                this.a.a(bArr2, 0, bArr3, 0);
                bArr = bArr3;
            }
            this.l = Pack.c(bArr, 0);
            this.m = Pack.c(bArr, 4);
            this.n = Pack.c(bArr, 8);
            this.o = Pack.c(bArr, 12);
            return;
        }
