...
public class CCMBlockCipher implements AEADBlockCipher {
    ...
    private byte[] h;
    private ExposedByteArrayOutputStream i;
    private ExposedByteArrayOutputStream j;
    ...
    public CCMBlockCipher(BlockCipher blockCipher) {
        this.i = new ExposedByteArrayOutputStream(this);
        this.j = new ExposedByteArrayOutputStream(this);
        this.a = blockCipher;
