...
public class IESEngine {
    ...
    private void a(CipherParameters cipherParameters) {
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.i = (IESParameters) ((ParametersWithIV) cipherParameters).b();
            return;
        }
        this.m = null;
    ...
    private byte[] b(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (this.d == null) {
            ...
            if (this.m != null) {
                this.d.a(true, new ParametersWithIV(new KeyParameter(obj2), this.m));
            } else {
    ...
    private byte[] c(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (this.d == null) {
            ...
            if (this.m != null) {
                this.d.a(false, new ParametersWithIV(new KeyParameter(obj), this.m));
            } else {
    ...
    public byte[] a(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        this.b.a(new KDFParameters(bArr2, this.i.a()));
        if (this.f) {
            return b(bArr, i, i2);
        }
        return c(bArr, i, i2);
