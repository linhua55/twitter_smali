            ...
            for (int i6 = 0; i6 < 256; i6++) {
                ...
                switch (this.i & 3) {
                    ...
                    case p.View_android_focusable /*1*/:
                        ...
                        this.h[(i6 * 2) + 513] = this.f[(a[1][i6] & 255) ^ i(a)];
                        continue;
                ...
                this.h[(i6 * 2) + 513] = this.f[(a[1][(a[1][i] & 255) ^ i(i3)] & 255) ^ i(a)];
            }
        }
    }
