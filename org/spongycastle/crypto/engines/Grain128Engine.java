...
public class Grain128Engine implements StreamCipher {
    ...
    private int d() {
        ...
        int i18 = (this.e[2] >>> 27) | (this.e[3] << 5);
        return ((((((((((i ^ i7) ^ i11) ^ i18) ^ this.e[3]) ^ (i2 & i15)) ^ (i3 & i4)) ^ (i5 & i6)) ^ (i8 & i12)) ^ (i9 & i10)) ^ (i13 & i14)) ^ (i16 & i17);
    }
    ...
    private int f() {
        ...
        i2 &= i6;
        return ((((((i ^ (((i2 & ((this.d[2] >>> 31) | (this.d[3] << 1))) ^ ((((((this.d[0] >>> 8) | (this.d[1] << 24)) & i2) ^ (((this.d[0] >>> 13) | (this.d[1] << 19)) & ((this.d[0] >>> 20) | (this.d[1] << 12)))) ^ (i6 & ((this.d[1] >>> 10) | (this.d[2] << 22)))) ^ (((this.d[1] >>> 28) | (this.d[2] << 4)) & ((this.d[2] >>> 15) | (this.d[3] << 17))))) ^ ((this.d[2] >>> 29) | (this.d[3] << 3)))) ^ i3) ^ i4) ^ i5) ^ this.e[2]) ^ ((this.e[2] >>> 9) | (this.e[3] << 23))) ^ ((this.e[2] >>> 25) | (this.e[3] << 7));
    }
