...
public class SerpentEngine implements BlockCipher {
    ...
    private int[] a(byte[] bArr) throws IllegalArgumentException {
        ...
        if (length == 0) {
            ...
            obj2[98] = this.e;
            obj2[99] = this.f;
            e(obj2[100], obj2[cse.AppCompatTheme_buttonStyleSmall], obj2[cse.AppCompatTheme_checkboxStyle], obj2[cse.AppCompatTheme_checkedTextViewStyle]);
            obj2[100] = this.c;
            obj2[cse.AppCompatTheme_buttonStyleSmall] = this.d;
            obj2[cse.AppCompatTheme_checkboxStyle] = this.e;
            obj2[cse.AppCompatTheme_checkedTextViewStyle] = this.f;
            c(obj2[cse.AppCompatTheme_editTextStyle], obj2[cse.AppCompatTheme_radioButtonStyle], obj2[cse.AppCompatTheme_ratingBarStyle], obj2[cse.AppCompatTheme_ratingBarStyleIndicator]);
            obj2[cse.AppCompatTheme_editTextStyle] = this.c;
            obj2[cse.AppCompatTheme_radioButtonStyle] = this.d;
            obj2[cse.AppCompatTheme_ratingBarStyle] = this.e;
            obj2[cse.AppCompatTheme_ratingBarStyleIndicator] = this.f;
            a(obj2[cse.AppCompatTheme_ratingBarStyleSmall], obj2[cse.AppCompatTheme_seekBarStyle], obj2[cse.AppCompatTheme_spinnerStyle], obj2[cse.AppCompatTheme_switchStyle]);
            obj2[cse.AppCompatTheme_ratingBarStyleSmall] = this.c;
            obj2[cse.AppCompatTheme_seekBarStyle] = this.d;
            obj2[cse.AppCompatTheme_spinnerStyle] = this.e;
            obj2[cse.AppCompatTheme_switchStyle] = this.f;
            ...
            obj2[126] = this.e;
            obj2[127] = this.f;
            g(obj2[128], obj2[129], obj2[130], obj2[131]);
            obj2[128] = this.c;
            obj2[129] = this.d;
            obj2[130] = this.e;
            obj2[131] = this.f;
    ...
    private void b(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        d();
        c(this.b[100] ^ this.c, this.b[cse.AppCompatTheme_buttonStyleSmall] ^ this.d, this.b[cse.AppCompatTheme_checkboxStyle] ^ this.e, this.b[cse.AppCompatTheme_checkedTextViewStyle] ^ this.f);
        d();
        e(this.b[cse.AppCompatTheme_editTextStyle] ^ this.c, this.b[cse.AppCompatTheme_radioButtonStyle] ^ this.d, this.b[cse.AppCompatTheme_ratingBarStyle] ^ this.e, this.b[cse.AppCompatTheme_ratingBarStyleIndicator] ^ this.f);
        d();
        g(this.b[cse.AppCompatTheme_ratingBarStyleSmall] ^ this.c, this.b[cse.AppCompatTheme_seekBarStyle] ^ this.d, this.b[cse.AppCompatTheme_spinnerStyle] ^ this.e, this.b[cse.AppCompatTheme_switchStyle] ^ this.f);
        d();
    ...
    private void c(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        this.c ^= this.b[cse.AppCompatTheme_ratingBarStyleSmall];
        this.d ^= this.b[cse.AppCompatTheme_seekBarStyle];
        this.e ^= this.b[cse.AppCompatTheme_spinnerStyle];
        this.f ^= this.b[cse.AppCompatTheme_switchStyle];
        e();
        f(this.c, this.d, this.e, this.f);
        this.c ^= this.b[cse.AppCompatTheme_editTextStyle];
        this.d ^= this.b[cse.AppCompatTheme_radioButtonStyle];
        this.e ^= this.b[cse.AppCompatTheme_ratingBarStyle];
        this.f ^= this.b[cse.AppCompatTheme_ratingBarStyleIndicator];
        e();
        d(this.c, this.d, this.e, this.f);
        this.c ^= this.b[100];
        this.d ^= this.b[cse.AppCompatTheme_buttonStyleSmall];
        this.e ^= this.b[cse.AppCompatTheme_checkboxStyle];
        this.f ^= this.b[cse.AppCompatTheme_checkedTextViewStyle];
        e();
