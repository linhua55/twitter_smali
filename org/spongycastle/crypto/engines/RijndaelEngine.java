...
public class RijndaelEngine implements BlockCipher {
    ...
    private byte d(int i) {
        if (i >= 0) {
            return d[i + cse.AppCompatTheme_editTextStyle];
        }
        return (byte) 0;
    }
