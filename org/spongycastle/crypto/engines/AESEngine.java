...
public class AESEngine implements BlockCipher {
    ...
    private void a(int[][] iArr) {
        ...
        int i2 = this.i ^ iArr[0][1];
        int i3 = this.j ^ iArr[0][2];
        int i4 = 1;
        int i5 = this.k ^ iArr[0][3];
        while (i4 < this.f - 1) {
            a = (((d[i & 255] ^ a(d[(i2 >> 8) & 255], 24)) ^ a(d[(i3 >> 16) & 255], 16)) ^ a(d[(i5 >> 24) & 255], 8)) ^ iArr[i4][0];
            a2 = (((d[i2 & 255] ^ a(d[(i3 >> 8) & 255], 24)) ^ a(d[(i5 >> 16) & 255], 16)) ^ a(d[(i >> 24) & 255], 8)) ^ iArr[i4][1];
            a3 = (((d[i3 & 255] ^ a(d[(i5 >> 8) & 255], 24)) ^ a(d[(i >> 16) & 255], 16)) ^ a(d[(i2 >> 24) & 255], 8)) ^ iArr[i4][2];
            int i6 = i4 + 1;
            i5 = (((d[i5 & 255] ^ a(d[(i >> 8) & 255], 24)) ^ a(d[(i2 >> 16) & 255], 16)) ^ a(d[(i3 >> 24) & 255], 8)) ^ iArr[i4][3];
            i = (((d[a & 255] ^ a(d[(a2 >> 8) & 255], 24)) ^ a(d[(a3 >> 16) & 255], 16)) ^ a(d[(i5 >> 24) & 255], 8)) ^ iArr[i6][0];
            i2 = (((d[a2 & 255] ^ a(d[(a3 >> 8) & 255], 24)) ^ a(d[(i5 >> 16) & 255], 16)) ^ a(d[(a >> 24) & 255], 8)) ^ iArr[i6][1];
            i3 = iArr[i6][2] ^ (((d[a3 & 255] ^ a(d[(i5 >> 8) & 255], 24)) ^ a(d[(a >> 16) & 255], 16)) ^ a(d[(a2 >> 24) & 255], 8));
            i4 = i6 + 1;
            i5 = (((d[i5 & 255] ^ a(d[(a >> 8) & 255], 24)) ^ a(d[(a2 >> 16) & 255], 16)) ^ a(d[(a3 >> 24) & 255], 8)) ^ iArr[i6][3];
        }
        a = (((d[i & 255] ^ a(d[(i2 >> 8) & 255], 24)) ^ a(d[(i3 >> 16) & 255], 16)) ^ a(d[(i5 >> 24) & 255], 8)) ^ iArr[i4][0];
        a2 = (((d[i2 & 255] ^ a(d[(i3 >> 8) & 255], 24)) ^ a(d[(i5 >> 16) & 255], 16)) ^ a(d[(i >> 24) & 255], 8)) ^ iArr[i4][1];
        a3 = (((d[i3 & 255] ^ a(d[(i5 >> 8) & 255], 24)) ^ a(d[(i >> 16) & 255], 16)) ^ a(d[(i2 >> 24) & 255], 8)) ^ iArr[i4][2];
        i5 = ((d[i5 & 255] ^ a(d[(i >> 8) & 255], 24)) ^ a(d[(i2 >> 16) & 255], 16)) ^ a(d[(i3 >> 24) & 255], 8);
        i3 = i4 + 1;
        i5 ^= iArr[i4][3];
        this.h = ((((a[a & 255] & 255) ^ ((a[(a2 >> 8) & 255] & 255) << 8)) ^ ((a[(a3 >> 16) & 255] & 255) << 16)) ^ (a[(i5 >> 24) & 255] << 24)) ^ iArr[i3][0];
        this.i = ((((a[a2 & 255] & 255) ^ ((a[(a3 >> 8) & 255] & 255) << 8)) ^ ((a[(i5 >> 16) & 255] & 255) << 16)) ^ (a[(a >> 24) & 255] << 24)) ^ iArr[i3][1];
        this.j = ((((a[a3 & 255] & 255) ^ ((a[(i5 >> 8) & 255] & 255) << 8)) ^ ((a[(a >> 16) & 255] & 255) << 16)) ^ (a[(a2 >> 24) & 255] << 24)) ^ iArr[i3][2];
        this.k = ((((a[i5 & 255] & 255) ^ ((a[(a >> 8) & 255] & 255) << 8)) ^ ((a[(a2 >> 16) & 255] & 255) << 16)) ^ (a[(a3 >> 24) & 255] << 24)) ^ iArr[i3][3];
    }
    ...
    private void b(int[][] iArr) {
        ...
        int a2;
        int a3;
        int i = this.h ^ iArr[this.f][0];
        int i2 = this.i ^ iArr[this.f][1];
        int i3 = this.j ^ iArr[this.f][2];
        int i4 = this.f - 1;
        int i5 = this.k ^ iArr[this.f][3];
        while (i4 > 1) {
            a = (((e[i & 255] ^ a(e[(i5 >> 8) & 255], 24)) ^ a(e[(i3 >> 16) & 255], 16)) ^ a(e[(i2 >> 24) & 255], 8)) ^ iArr[i4][0];
            a2 = (((e[i2 & 255] ^ a(e[(i >> 8) & 255], 24)) ^ a(e[(i5 >> 16) & 255], 16)) ^ a(e[(i3 >> 24) & 255], 8)) ^ iArr[i4][1];
            a3 = (((e[i3 & 255] ^ a(e[(i2 >> 8) & 255], 24)) ^ a(e[(i >> 16) & 255], 16)) ^ a(e[(i5 >> 24) & 255], 8)) ^ iArr[i4][2];
            int i6 = i4 - 1;
            i5 = (((e[i5 & 255] ^ a(e[(i3 >> 8) & 255], 24)) ^ a(e[(i2 >> 16) & 255], 16)) ^ a(e[(i >> 24) & 255], 8)) ^ iArr[i4][3];
            i = (((e[a & 255] ^ a(e[(i5 >> 8) & 255], 24)) ^ a(e[(a3 >> 16) & 255], 16)) ^ a(e[(a2 >> 24) & 255], 8)) ^ iArr[i6][0];
            i2 = (((e[a2 & 255] ^ a(e[(a >> 8) & 255], 24)) ^ a(e[(i5 >> 16) & 255], 16)) ^ a(e[(a3 >> 24) & 255], 8)) ^ iArr[i6][1];
            i3 = iArr[i6][2] ^ (((e[a3 & 255] ^ a(e[(a2 >> 8) & 255], 24)) ^ a(e[(a >> 16) & 255], 16)) ^ a(e[(i5 >> 24) & 255], 8));
            i4 = i6 - 1;
            i5 = (((e[i5 & 255] ^ a(e[(a3 >> 8) & 255], 24)) ^ a(e[(a2 >> 16) & 255], 16)) ^ a(e[(a >> 24) & 255], 8)) ^ iArr[i6][3];
        }
        a = (((e[i & 255] ^ a(e[(i5 >> 8) & 255], 24)) ^ a(e[(i3 >> 16) & 255], 16)) ^ a(e[(i2 >> 24) & 255], 8)) ^ iArr[i4][0];
        a2 = (((e[i2 & 255] ^ a(e[(i >> 8) & 255], 24)) ^ a(e[(i5 >> 16) & 255], 16)) ^ a(e[(i3 >> 24) & 255], 8)) ^ iArr[i4][1];
        a3 = (((e[i3 & 255] ^ a(e[(i2 >> 8) & 255], 24)) ^ a(e[(i >> 16) & 255], 16)) ^ a(e[(i5 >> 24) & 255], 8)) ^ iArr[i4][2];
        i5 = (((e[i5 & 255] ^ a(e[(i3 >> 8) & 255], 24)) ^ a(e[(i2 >> 16) & 255], 16)) ^ a(e[(i >> 24) & 255], 8)) ^ iArr[i4][3];
        this.h = ((((b[a & 255] & 255) ^ ((b[(i5 >> 8) & 255] & 255) << 8)) ^ ((b[(a3 >> 16) & 255] & 255) << 16)) ^ (b[(a2 >> 24) & 255] << 24)) ^ iArr[0][0];
        this.i = ((((b[a2 & 255] & 255) ^ ((b[(a >> 8) & 255] & 255) << 8)) ^ ((b[(i5 >> 16) & 255] & 255) << 16)) ^ (b[(a3 >> 24) & 255] << 24)) ^ iArr[0][1];
        this.j = ((((b[a3 & 255] & 255) ^ ((b[(a2 >> 8) & 255] & 255) << 8)) ^ ((b[(a >> 16) & 255] & 255) << 16)) ^ (b[(i5 >> 24) & 255] << 24)) ^ iArr[0][2];
        this.k = ((((b[i5 & 255] & 255) ^ ((b[(a3 >> 8) & 255] & 255) << 8)) ^ ((b[(a2 >> 16) & 255] & 255) << 16)) ^ (b[(a >> 24) & 255] << 24)) ^ iArr[0][3];
    }
}
