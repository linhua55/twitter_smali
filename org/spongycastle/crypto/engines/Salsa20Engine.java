...
public class Salsa20Engine implements SkippingStreamCipher {
    ...
    static {
        a = Strings.d("expand 32-byte k");
        b = Strings.d("expand 16-byte k");
    }
    ...
    public void a(boolean z, CipherParameters cipherParameters) {
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            } else if (b instanceof KeyParameter) {
                a(((KeyParameter) b).a(), a);
            } else {
    ...
    protected long f() {
        return (((long) this.d[9]) << 32) | (((long) this.d[8]) & 4294967295L);
    }
