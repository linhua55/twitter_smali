...
public class CamelliaLightEngine implements BlockCipher {
    ...
    public int a(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException {
        if (!this.a) {
