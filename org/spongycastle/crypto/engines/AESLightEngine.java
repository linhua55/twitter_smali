...
public class AESLightEngine implements BlockCipher {
    ...
    private void a(int[][] iArr) {
        ...
        int b2;
        int b3;
        int i = this.f ^ iArr[0][0];
        int i2 = this.g ^ iArr[0][1];
        int i3 = iArr[0][2] ^ this.h;
        int i4 = this.i ^ iArr[0][3];
        int i5 = i;
        i = i2;
        i2 = i3;
        i3 = 1;
        while (i3 < this.d - 1) {
            b = b((((a[i5 & 255] & 255) ^ ((a[(i >> 8) & 255] & 255) << 8)) ^ ((a[(i2 >> 16) & 255] & 255) << 16)) ^ (a[(i4 >> 24) & 255] << 24)) ^ iArr[i3][0];
            b2 = b((((a[i & 255] & 255) ^ ((a[(i2 >> 8) & 255] & 255) << 8)) ^ ((a[(i4 >> 16) & 255] & 255) << 16)) ^ (a[(i5 >> 24) & 255] << 24)) ^ iArr[i3][1];
            b3 = b((((a[i2 & 255] & 255) ^ ((a[(i4 >> 8) & 255] & 255) << 8)) ^ ((a[(i5 >> 16) & 255] & 255) << 16)) ^ (a[(i >> 24) & 255] << 24)) ^ iArr[i3][2];
            int i6 = i3 + 1;
            i4 = b((((a[i4 & 255] & 255) ^ ((a[(i5 >> 8) & 255] & 255) << 8)) ^ ((a[(i >> 16) & 255] & 255) << 16)) ^ (a[(i2 >> 24) & 255] << 24)) ^ iArr[i3][3];
            i5 = b((((a[b & 255] & 255) ^ ((a[(b2 >> 8) & 255] & 255) << 8)) ^ ((a[(b3 >> 16) & 255] & 255) << 16)) ^ (a[(i4 >> 24) & 255] << 24)) ^ iArr[i6][0];
            i = b((((a[b2 & 255] & 255) ^ ((a[(b3 >> 8) & 255] & 255) << 8)) ^ ((a[(i4 >> 16) & 255] & 255) << 16)) ^ (a[(b >> 24) & 255] << 24)) ^ iArr[i6][1];
            i2 = iArr[i6][2] ^ b((((a[b3 & 255] & 255) ^ ((a[(i4 >> 8) & 255] & 255) << 8)) ^ ((a[(b >> 16) & 255] & 255) << 16)) ^ (a[(b2 >> 24) & 255] << 24));
            i3 = i6 + 1;
            i4 = b((((a[i4 & 255] & 255) ^ ((a[(b >> 8) & 255] & 255) << 8)) ^ ((a[(b2 >> 16) & 255] & 255) << 16)) ^ (a[(b3 >> 24) & 255] << 24)) ^ iArr[i6][3];
        }
        b = b((((a[i5 & 255] & 255) ^ ((a[(i >> 8) & 255] & 255) << 8)) ^ ((a[(i2 >> 16) & 255] & 255) << 16)) ^ (a[(i4 >> 24) & 255] << 24)) ^ iArr[i3][0];
        b2 = b((((a[i & 255] & 255) ^ ((a[(i2 >> 8) & 255] & 255) << 8)) ^ ((a[(i4 >> 16) & 255] & 255) << 16)) ^ (a[(i5 >> 24) & 255] << 24)) ^ iArr[i3][1];
        b3 = b((((a[i2 & 255] & 255) ^ ((a[(i4 >> 8) & 255] & 255) << 8)) ^ ((a[(i5 >> 16) & 255] & 255) << 16)) ^ (a[(i >> 24) & 255] << 24)) ^ iArr[i3][2];
        i2 = i3 + 1;
        i4 = b((((a[i4 & 255] & 255) ^ ((a[(i5 >> 8) & 255] & 255) << 8)) ^ ((a[(i >> 16) & 255] & 255) << 16)) ^ (a[(i2 >> 24) & 255] << 24)) ^ iArr[i3][3];
        this.f = ((((a[b & 255] & 255) ^ ((a[(b2 >> 8) & 255] & 255) << 8)) ^ ((a[(b3 >> 16) & 255] & 255) << 16)) ^ (a[(i4 >> 24) & 255] << 24)) ^ iArr[i2][0];
        this.g = ((((a[b2 & 255] & 255) ^ ((a[(b3 >> 8) & 255] & 255) << 8)) ^ ((a[(i4 >> 16) & 255] & 255) << 16)) ^ (a[(b >> 24) & 255] << 24)) ^ iArr[i2][1];
        this.h = ((((a[b3 & 255] & 255) ^ ((a[(i4 >> 8) & 255] & 255) << 8)) ^ ((a[(b >> 16) & 255] & 255) << 16)) ^ (a[(b2 >> 24) & 255] << 24)) ^ iArr[i2][2];
        this.i = ((((a[i4 & 255] & 255) ^ ((a[(b >> 8) & 255] & 255) << 8)) ^ ((a[(b2 >> 16) & 255] & 255) << 16)) ^ (a[(b3 >> 24) & 255] << 24)) ^ iArr[i2][3];
    }
    ...
    private void b(int[][] iArr) {
        ...
        int c2;
        int c3;
        int i = this.f ^ iArr[this.d][0];
        int i2 = this.g ^ iArr[this.d][1];
        int i3 = this.h ^ iArr[this.d][2];
        int i4 = this.d - 1;
        int i5 = this.i ^ iArr[this.d][3];
        while (i4 > 1) {
            c = c((((b[i & 255] & 255) ^ ((b[(i5 >> 8) & 255] & 255) << 8)) ^ ((b[(i3 >> 16) & 255] & 255) << 16)) ^ (b[(i2 >> 24) & 255] << 24)) ^ iArr[i4][0];
            c2 = c((((b[i2 & 255] & 255) ^ ((b[(i >> 8) & 255] & 255) << 8)) ^ ((b[(i5 >> 16) & 255] & 255) << 16)) ^ (b[(i3 >> 24) & 255] << 24)) ^ iArr[i4][1];
            c3 = c((((b[i3 & 255] & 255) ^ ((b[(i2 >> 8) & 255] & 255) << 8)) ^ ((b[(i >> 16) & 255] & 255) << 16)) ^ (b[(i5 >> 24) & 255] << 24)) ^ iArr[i4][2];
            int i6 = i4 - 1;
            i5 = c((((b[i5 & 255] & 255) ^ ((b[(i3 >> 8) & 255] & 255) << 8)) ^ ((b[(i2 >> 16) & 255] & 255) << 16)) ^ (b[(i >> 24) & 255] << 24)) ^ iArr[i4][3];
            i = c((((b[c & 255] & 255) ^ ((b[(i5 >> 8) & 255] & 255) << 8)) ^ ((b[(c3 >> 16) & 255] & 255) << 16)) ^ (b[(c2 >> 24) & 255] << 24)) ^ iArr[i6][0];
            i2 = c((((b[c2 & 255] & 255) ^ ((b[(c >> 8) & 255] & 255) << 8)) ^ ((b[(i5 >> 16) & 255] & 255) << 16)) ^ (b[(c3 >> 24) & 255] << 24)) ^ iArr[i6][1];
            i3 = iArr[i6][2] ^ c((((b[c3 & 255] & 255) ^ ((b[(c2 >> 8) & 255] & 255) << 8)) ^ ((b[(c >> 16) & 255] & 255) << 16)) ^ (b[(i5 >> 24) & 255] << 24));
            i4 = i6 - 1;
            i5 = c((((b[i5 & 255] & 255) ^ ((b[(c3 >> 8) & 255] & 255) << 8)) ^ ((b[(c2 >> 16) & 255] & 255) << 16)) ^ (b[(c >> 24) & 255] << 24)) ^ iArr[i6][3];
        }
        c = c((((b[i & 255] & 255) ^ ((b[(i5 >> 8) & 255] & 255) << 8)) ^ ((b[(i3 >> 16) & 255] & 255) << 16)) ^ (b[(i2 >> 24) & 255] << 24)) ^ iArr[i4][0];
        c2 = c((((b[i2 & 255] & 255) ^ ((b[(i >> 8) & 255] & 255) << 8)) ^ ((b[(i5 >> 16) & 255] & 255) << 16)) ^ (b[(i3 >> 24) & 255] << 24)) ^ iArr[i4][1];
        c3 = c((((b[i3 & 255] & 255) ^ ((b[(i2 >> 8) & 255] & 255) << 8)) ^ ((b[(i >> 16) & 255] & 255) << 16)) ^ (b[(i5 >> 24) & 255] << 24)) ^ iArr[i4][2];
        i5 = c((((b[i5 & 255] & 255) ^ ((b[(i3 >> 8) & 255] & 255) << 8)) ^ ((b[(i2 >> 16) & 255] & 255) << 16)) ^ (b[(i >> 24) & 255] << 24)) ^ iArr[i4][3];
        this.f = ((((b[c & 255] & 255) ^ ((b[(i5 >> 8) & 255] & 255) << 8)) ^ ((b[(c3 >> 16) & 255] & 255) << 16)) ^ (b[(c2 >> 24) & 255] << 24)) ^ iArr[0][0];
        this.g = ((((b[c2 & 255] & 255) ^ ((b[(c >> 8) & 255] & 255) << 8)) ^ ((b[(i5 >> 16) & 255] & 255) << 16)) ^ (b[(c3 >> 24) & 255] << 24)) ^ iArr[0][1];
        this.h = ((((b[c3 & 255] & 255) ^ ((b[(c2 >> 8) & 255] & 255) << 8)) ^ ((b[(c >> 16) & 255] & 255) << 16)) ^ (b[(i5 >> 24) & 255] << 24)) ^ iArr[0][2];
        this.i = ((((b[i5 & 255] & 255) ^ ((b[(c3 >> 8) & 255] & 255) << 8)) ^ ((b[(c2 >> 16) & 255] & 255) << 16)) ^ (b[(c >> 24) & 255] << 24)) ^ iArr[0][3];
    }
}
