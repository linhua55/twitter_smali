...
public class TlsDHUtils {
    ...
    public static DHPrivateKeyParameters a(SecureRandom secureRandom, DHParameters dHParameters, OutputStream outputStream) throws IOException {
    ...
    public static DHPrivateKeyParameters b(SecureRandom secureRandom, DHParameters dHParameters, OutputStream outputStream) throws IOException {
        AsymmetricCipherKeyPair a = a(secureRandom, dHParameters);
        new ServerDHParams((DHPublicKeyParameters) a.a()).a(outputStream);
        return (DHPrivateKeyParameters) a.b();
    }

    public static DHPublicKeyParameters a(DHPublicKeyParameters dHPublicKeyParameters) throws IOException {
