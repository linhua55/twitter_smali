...
public class TlsBlockCipher implements TlsCipher {
    ...
    public TlsBlockCipher(TlsContext tlsContext, BlockCipher blockCipher, BlockCipher blockCipher2, Digest digest, Digest digest2, int i) throws IOException {
        ...
        this.a = tlsContext;
        this.b = new byte[256];
        tlsContext.a().b(this.b);
        this.c = TlsUtils.b(tlsContext);
        this.h = tlsContext.c().k;
    ...
    protected int a(byte[] bArr, int i, int i2, int i3, int i4) {
        ...
        byte[] bArr2 = this.b;
        for (i6 = 
        /* Method generation error in method: org.spongycastle.crypto.tls.TlsBlockCipher.a(byte[], int, int, int, int):int
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r1_4 'i6' int) = (r1_1 'i6' int), (r1_2 'i6' int), (r1_3 'i6' int) binds: {(r1_1 'i6' int)=B:14:0x0039, (r1_3 'i6' int)=B:5:0x0019, (r1_2 'i6' int)=B:17:0x0043} in method: org.spongycastle.crypto.tls.TlsBlockCipher.a(byte[], int, int, int, int):int
...
Caused by: jadx.core.utils.exceptions.CodegenException: Unknown instruction: PHI in method: org.spongycastle.crypto.tls.TlsBlockCipher.a(byte[], int, int, int, int):int
