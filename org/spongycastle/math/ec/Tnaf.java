...
/* compiled from: Twttr */
class Tnaf {
    public static final ZTauElement[] a;
    public static final byte[][] b;
    public static final ZTauElement[] c;
    ...
    static {
        e = ECConstants.d.negate();
        f = ECConstants.e.negate();
        g = ECConstants.f.negate();
        a = new ZTauElement[]{null, new ZTauElement(ECConstants.d, ECConstants.c), null, new ZTauElement(g, e), null, new ZTauElement(e, e), null, new ZTauElement(ECConstants.d, e), null};
        r0 = new byte[8][];
        ...
        b = r0;
        c = new ZTauElement[]{null, new ZTauElement(ECConstants.d, ECConstants.c), null, new ZTauElement(g, ECConstants.d), null, new ZTauElement(e, ECConstants.d), null, new ZTauElement(ECConstants.d, ECConstants.d), null};
        r0 = new byte[8][];
        r0[1] = new byte[]{(byte) 1};
        r0[2] = null;
        r0[3] = new byte[]{(byte) -1, (byte) 0, (byte) 1};
    ...
    public static ZTauElement a(SimpleBigDecimal simpleBigDecimal, SimpleBigDecimal simpleBigDecimal2, byte b) {
        ...
        if (simpleBigDecimal2.d() != simpleBigDecimal.d()) {
            ...
            return new ZTauElement(c.add(BigInteger.valueOf((long) i2)), c2.add(BigInteger.valueOf((long) i)));
        } else {
            throw new IllegalArgumentException("mu must be 1 or -1");
        }
    }
    ...
    public static BigInteger[] b(ECCurve.F2m f2m) {
        if (f2m.n()) {
            int q = f2m.q();
            int intValue = f2m.g().a().intValue();
            byte o = f2m.o();
            int a = a(f2m.j());
            BigInteger[] a2 = a(o, (q + 3) - intValue, false);
            if (o == (byte) 1) {
                a2[0] = a2[0].negate();
                a2[1] = a2[1].negate();
            }
            BigInteger shiftRight = ECConstants.d.add(a2[1]).shiftRight(a);
            BigInteger negate = ECConstants.d.add(a2[0]).shiftRight(a).negate();
    ...
    protected static int a(BigInteger bigInteger) {
        if (bigInteger != null) {
            if (bigInteger.equals(ECConstants.e)) {
                return 1;
            }
            if (bigInteger.equals(ECConstants.g)) {
                return 2;
            }
        }
    ...
    public static F2m a(F2m f2m, byte[] bArr) {
        F2m f2m2 = (F2m) ((ECCurve.F2m) f2m.d()).e();
        ...
        if (b == (byte) 1 || b == -1) {
            ...
            while (true) {
                ...
                if (bigInteger3.testBit(0)) {
                    ...
                    if (i2 != 0) {
                        bigInteger3 = bigInteger3.subtract(zTauElementArr[i].a);
                        bigInteger4 = bigInteger4.subtract(zTauElementArr[i].b);
                    } else {
                        bigInteger3 = bigInteger3.add(zTauElementArr[i].a);
                        bigInteger4 = bigInteger4.add(zTauElementArr[i].b);
                    }
                    mod = bigInteger3;
                } else {
