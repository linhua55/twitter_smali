...
class LongArray {
    ...
    public void a(int i, int[] iArr) {
        Object obj = this.g;
        int b = b(obj, 0, obj.length, i, iArr);
        if (b < obj.length) {
            this.g = new long[b];
            System.arraycopy(obj, 0, this.g, 0, b);
        }
    }
    ...
    public LongArray a(int i, int i2, int[] iArr) {
        ...
        System.arraycopy(this.g, 0, jArr, 0, c);
        while (true) {
            i--;
            if (i >= 0) {
                a(jArr, c, i2, iArr);
                c = b(jArr, 0, jArr.length, i2, iArr);
            } else {
                this(jArr, 0, c);
                return this;
            }
    ...
    public LongArray d(int i, int[] iArr) {
        ...
        if (d == 0) {
            ...
            while (true) {
                ...
                longArrayArr[i2].a(longArrayArr[1 - i2], iArr2[1 - i2], i4);
                int b = longArrayArr[i2].b(i3);
                if (b == 0) {
                    return longArrayArr2[1 - i2];
                }
                int i5 = iArr3[1 - i2];
                longArrayArr2[i2].a(longArrayArr2[1 - i2], i5, i4);
                i5 += i4;
                if (i5 > d) {
                    d = i5;
                } else if (i5 == d) {
                    d = longArrayArr2[i2].b(d);
                }
                i4 += b - i3;
                i3 = b;
            }
    ...
    public String toString() {
        ...
        c--;
        StringBuffer stringBuffer = new StringBuffer(Long.toBinaryString(this.g[c]));
        while (true) {
            c--;
            if (c < 0) {
                return stringBuffer.toString();
            }
            String toBinaryString = Long.toBinaryString(this.g[c]);
