...
public abstract class Nat256 {
    ...
    public static boolean a(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        boolean b = b(iArr, i, iArr2, i2);
        if (b) {
            c(iArr, i, iArr2, i2, iArr3, i3);
        } else {
            c(iArr2, i2, iArr, i, iArr3, i3);
        }
        return b;
    }
    ...
    public static boolean b(int[] iArr, int i, int[] iArr2, int i2) {
    ...
    public static void b(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
    ...
    public static long a(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
    ...
    public static int a(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i2 + 3] = (int) j4;
        return (j4 >>> 32) == 0 ? 0 : Nat.a(8, iArr, i2, 4);
    }
    ...
    public static int a(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i3 + 2] = (int) j2;
        return (j2 >>> 32) == 0 ? 0 : Nat.a(8, iArr, i3, 3);
    }
    ...
    public static int c(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        long j = 0 + ((((long) iArr[i + 0]) & 4294967295L) - (((long) iArr2[i2 + 0]) & 4294967295L));
        iArr3[i3 + 0] = (int) j;
        j = (j >> 32) + ((((long) iArr[i + 1]) & 4294967295L) - (((long) iArr2[i2 + 1]) & 4294967295L));
        iArr3[i3 + 1] = (int) j;
