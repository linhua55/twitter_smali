...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    public static final ProviderConfiguration a;
    ...
    static {
        b = "BouncyCastle Security Provider v1.51";
        a = new BouncyCastleProviderConfiguration();
        c = new HashMap();
        d = new String[]{"PBEPBKDF2", "PBEPKCS12"};
        e = new String[]{"SipHash"};
        f = new String[]{"AES", "ARC4", "Blowfish", "Camellia", "CAST5", "CAST6", "ChaCha", "DES", "DESede", "GOST28147", "Grainv1", "Grain128", "HC128", "HC256", "IDEA", "Noekeon", "RC2", "RC5", "RC6", "Rijndael", "Salsa20", "SEED", "Serpent", "Shacal2", "Skipjack", "TEA", "Twofish", "Threefish", "VMPC", "VMPCKSA3", "XTEA", "XSalsa20"};
        g = new String[]{"X509", "IES"};
        h = new String[]{"DSA", "DH", "EC", "RSA", "GOST", "ECGOST", "ElGamal", "DSTU4145"};
        i = new String[]{"GOST3411", "MD2", "MD4", "MD5", "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "SHA3", "Skein", "SM3", "Tiger", "Whirlpool"};
    ...
    public static PublicKey a(SubjectPublicKeyInfo subjectPublicKeyInfo) throws IOException {
        AsymmetricKeyInfoConverter asymmetricKeyInfoConverter = (AsymmetricKeyInfoConverter) c.get(subjectPublicKeyInfo.a().b());
    ...
    public static PrivateKey a(PrivateKeyInfo privateKeyInfo) throws IOException {
        AsymmetricKeyInfoConverter asymmetricKeyInfoConverter = (AsymmetricKeyInfoConverter) c.get(privateKeyInfo.a().b());
        if (asymmetricKeyInfoConverter == null) {
            return null;
        }
