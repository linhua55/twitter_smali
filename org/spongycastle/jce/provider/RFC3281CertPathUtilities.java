...
class RFC3281CertPathUtilities {
    ...
    static {
        a = X509Extensions.E.a();
        b = X509Extensions.D.a();
        c = X509Extensions.p.a();
        d = X509Extensions.x.a();
    }

    protected static void a(X509AttributeCertificate x509AttributeCertificate, CertPath certPath, CertPath certPath2, ExtendedPKIXParameters extendedPKIXParameters) throws CertPathValidatorException {
    ...
    protected static void a(X509AttributeCertificate x509AttributeCertificate, ExtendedPKIXParameters extendedPKIXParameters, X509Certificate x509Certificate, Date date, List list) throws CertPathValidatorException {
                    ...
                    if (a != null) {
                        try {
                            ...
                            while (i < a2.length && certStatus.b() == 11 && !reasonsMask.a()) {
                                try {
                                    a(a2[i], x509AttributeCertificate, (ExtendedPKIXParameters) extendedPKIXParameters.clone(), date, x509Certificate, certStatus, reasonsMask, list);
                                    obj = 1;
                                    i++;
                                } catch (Throwable e) {
    ...
    protected static void a(X509AttributeCertificate x509AttributeCertificate, ExtendedPKIXParameters extendedPKIXParameters) throws CertPathValidatorException {
    ...
    protected static void b(X509AttributeCertificate x509AttributeCertificate, ExtendedPKIXParameters extendedPKIXParameters) throws CertPathValidatorException {
        try {
    ...
    protected static void a(X509Certificate x509Certificate, ExtendedPKIXParameters extendedPKIXParameters) throws CertPathValidatorException {
        Object obj = null;
    ...
    protected static void b(X509Certificate x509Certificate, ExtendedPKIXParameters extendedPKIXParameters) throws CertPathValidatorException {
    ...
    protected static CertPathValidatorResult a(CertPath certPath, ExtendedPKIXParameters extendedPKIXParameters) throws CertPathValidatorException {
        try {
            try {
    ...
    protected static CertPath c(X509AttributeCertificate x509AttributeCertificate, ExtendedPKIXParameters extendedPKIXParameters) throws CertPathValidatorException {
    ...
    private static void a(DistributionPoint distributionPoint, X509AttributeCertificate x509AttributeCertificate, ExtendedPKIXParameters extendedPKIXParameters, Date date, X509Certificate x509Certificate, CertStatus certStatus, ReasonsMask reasonsMask, List list) throws AnnotatedException {
        if (x509AttributeCertificate.getExtensionValue(X509Extensions.D.a()) == null) {
