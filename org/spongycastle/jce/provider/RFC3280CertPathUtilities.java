...
public class RFC3280CertPathUtilities {
    ...
    private static final PKIXCRLUtil p;

    static {
        p = new PKIXCRLUtil();
        a = X509Extensions.q.a();
        b = X509Extensions.r.a();
        c = X509Extensions.w.a();
        d = X509Extensions.m.a();
        e = X509Extensions.v.a();
        f = X509Extensions.l.a();
        g = X509Extensions.t.a();
        h = X509Extensions.g.a();
        i = X509Extensions.p.a();
        j = X509Extensions.e.a();
        k = X509Extensions.o.a();
        l = X509Extensions.s.a();
        m = X509Extensions.c.a();
        n = X509Extensions.h.a();
        o = new String[]{"unspecified", "keyCompromise", "cACompromise", "affiliationChanged", "superseded", "cessationOfOperation", "certificateHold", "unknown", "removeFromCRL", "privilegeWithdrawn", "aACompromise"};
    }

    protected static void a(DistributionPoint distributionPoint, Object obj, X509CRL x509crl) throws AnnotatedException {
        int i = 0;
        try {
            ...
            if (a != null) {
                if (a.h() != null) {
                    ...
                    if (h.a() == 0) {
                        GeneralName[] a2 = GeneralNames.a(h.b()).a();
                        for (Object add : a2) {
                            arrayList.add(add);
                        }
                    }
                    if (h.a() == 1) {
                        ...
                        try {
                            Enumeration e = ASN1Sequence.a(ASN1Primitive.b(CertPathValidatorUtilities.a(x509crl).getEncoded())).e();
                            while (e.hasMoreElements()) {
                                aSN1EncodableVector.a((ASN1Encodable) e.nextElement());
                            }
                            aSN1EncodableVector.a(h.b());
                    ...
                    if (distributionPoint.a() != null) {
                        DistributionPointName a4 = distributionPoint.a();
                        GeneralName[] generalNameArr = null;
                        if (a4.a() == 0) {
                            generalNameArr = GeneralNames.a(a4.b()).a();
                        }
                        if (a4.a() == 1) {
                            if (distributionPoint.c() != null) {
                                a3 = distributionPoint.c().a();
                            } else {
                                a3 = new GeneralName[1];
                                try {
                                    a3[0] = new GeneralName(new X509Name((ASN1Sequence) ASN1Primitive.b(CertPathValidatorUtilities.a(obj).getEncoded())));
                                } catch (Throwable e22) {
                                    throw new AnnotatedException("Could not read certificate issuer.", e22);
                                }
                            }
                            for (int i2 = 0; i2 < a3.length; i2++) {
                                Enumeration e3 = ASN1Sequence.a(a3[i2].b().d()).e();
                                ASN1EncodableVector aSN1EncodableVector2 = new ASN1EncodableVector();
                                while (e3.hasMoreElements()) {
                                    aSN1EncodableVector2.a((ASN1Encodable) e3.nextElement());
                                }
                                aSN1EncodableVector2.a(a4.b());
                                a3[i2] = new GeneralName(new X509Name(new DERSequence(aSN1EncodableVector2)));
                            }
                        } else {
                            a3 = generalNameArr;
                        }
                        if (a3 != null) {
                            for (Object contains : a3) {
                    ...
                    } else if (distributionPoint.c() == null) {
                        throw new AnnotatedException("Either the cRLIssuer or the distributionPoint field must be contained in DistributionPoint.");
                    } else {
                        a3 = distributionPoint.c().a();
                        for (Object contains2 : a3) {
    ...
    protected static void b(DistributionPoint distributionPoint, Object obj, X509CRL x509crl) throws AnnotatedException {
        int i;
        int i2 = 0;
        Object a = CertPathValidatorUtilities.a((X509Extension) x509crl, d);
        int i3;
        if (a == null || !IssuingDistributionPoint.a(a).c()) {
            i3 = 0;
        } else {
            i3 = 1;
        }
        ...
        if (distributionPoint.c() != null) {
            ...
            while (i2 < a2.length) {
                if (a2[i2].a() == 4) {
                    try {
                        if (Arrays.a(a2[i2].b().d().f(), encoded)) {
                            i = 1;
                        }
                    } catch (Throwable e) {
    ...
    protected static ReasonsMask a(X509CRL x509crl, DistributionPoint distributionPoint) throws AnnotatedException {
        try {
            IssuingDistributionPoint a = IssuingDistributionPoint.a(CertPathValidatorUtilities.a((X509Extension) x509crl, d));
            if (a != null && a.i() != null && distributionPoint.b() != null) {
                return new ReasonsMask(distributionPoint.b()).b(new ReasonsMask(a.i()));
            }
            if ((a == null || a.i() == null) && distributionPoint.b() == null) {
                return ReasonsMask.a;
            }
            return (distributionPoint.b() == null ? ReasonsMask.a : new ReasonsMask(distributionPoint.b())).b(a == null ? ReasonsMask.a : new ReasonsMask(a.i()));
        } catch (Throwable e) {
            throw new AnnotatedException("Issuing distribution point extension could not be decoded.", e);
        }
    }

    protected static Set a(X509CRL x509crl, Object obj, X509Certificate x509Certificate, PublicKey publicKey, ExtendedPKIXParameters extendedPKIXParameters, List list) throws AnnotatedException {
        int i = 0;
    ...
    protected static void a(X509CRL x509crl, X509CRL x509crl2, ExtendedPKIXParameters extendedPKIXParameters) throws AnnotatedException {
        Object obj = 1;
        if (x509crl != null) {
            try {
    ...
    protected static void a(Date date, X509CRL x509crl, Object obj, CertStatus certStatus, ExtendedPKIXParameters extendedPKIXParameters) throws AnnotatedException {
    ...
    protected static PKIXPolicyNode a(CertPath certPath, int i, List[] listArr, PKIXPolicyNode pKIXPolicyNode, int i2) throws CertPathValidatorException {
        ...
        try {
            ...
            if (a != null) {
                ...
                for (int i3 = 0; i3 < a.h(); i3++) {
                    ...
                    String a3 = ((ASN1ObjectIdentifier) aSN1Sequence.a(0)).a();
                    a2 = ((ASN1ObjectIdentifier) aSN1Sequence.a(1)).a();
                    if (hashMap.containsKey(a3)) {
                        ((Set) hashMap.get(a3)).add(a2);
                    } else {
                        Set hashSet2 = new HashSet();
                        hashSet2.add(a2);
                        hashMap.put(a3, hashSet2);
                        hashSet.add(a3);
                    }
                }
                for (String a22 : hashSet) {
                    ...
                    if (i2 > 0) {
                        ...
                        for (PKIXPolicyNode pKIXPolicyNode22 : listArr[size]) {
                            if (pKIXPolicyNode22.getValidPolicy().equals(a22)) {
                                pKIXPolicyNode22.c = (Set) hashMap.get(a22);
                                obj = 1;
                                break;
                            }
                        }
                            ...
                            for (PKIXPolicyNode pKIXPolicyNode222 : listArr[size]) {
                                if ("2.5.29.32.0".equals(pKIXPolicyNode222.getValidPolicy())) {
                                    ...
                                    try {
                                        ...
                                        while (e.hasMoreElements()) {
                                            try {
                                                PolicyInformation a4 = PolicyInformation.a(e.nextElement());
                                                if ("2.5.29.32.0".equals(a4.a().a())) {
                                                    try {
                                                        set = CertPathValidatorUtilities.a(a4.b());
                                                        break;
                                                    } catch (Throwable e2) {
                                        ...
                                        if ("2.5.29.32.0".equals(pKIXPolicyNode3.getValidPolicy())) {
                                            pKIXPolicyNode222 = new PKIXPolicyNode(new ArrayList(), size, (Set) hashMap.get(a22), pKIXPolicyNode3, set, a22, z);
                        ...
                        while (it.hasNext()) {
                            ...
                            if (pKIXPolicyNode222.getValidPolicy().equals(a22)) {
    ...
    protected static void a(CertPath certPath, int i) throws CertPathValidatorException {
        try {
            ...
            if (a != null) {
                ...
                while (i2 < a.h()) {
                    try {
                        ...
                        ASN1ObjectIdentifier a3 = ASN1ObjectIdentifier.a(a2.a(0));
                        ASN1ObjectIdentifier a4 = ASN1ObjectIdentifier.a(a2.a(1));
                        if ("2.5.29.32.0".equals(a3.a())) {
                            throw new CertPathValidatorException("IssuerDomainPolicy is anyPolicy", null, certPath, i);
                        } else if ("2.5.29.32.0".equals(a4.a())) {
    ...
    protected static void a(CertPath certPath, int i, PKIXPolicyNode pKIXPolicyNode, int i2) throws CertPathValidatorException {
    ...
    protected static PKIXPolicyNode a(CertPath certPath, int i, PKIXPolicyNode pKIXPolicyNode) throws CertPathValidatorException {
        try {
    ...
    protected static void a(CertPath certPath, int i, PKIXNameConstraintValidator pKIXNameConstraintValidator) throws CertPathValidatorException {
        List certificates = certPath.getCertificates();
        X509Extension x509Extension = (X509Certificate) certificates.get(i);
                    ...
                    try {
                        ...
                        if (a2 != null) {
                            try {
                                ...
                                while (i3 < a3.length) {
                                    try {
                                        pKIXNameConstraintValidator.a(a3[i3]);
                                        pKIXNameConstraintValidator.b(a3[i3]);
                                        i3++;
                                    } catch (Throwable e2) {
    ...
    protected static PKIXPolicyNode a(CertPath certPath, int i, Set set, PKIXPolicyNode pKIXPolicyNode, List[] listArr, int i2) throws CertPathValidatorException {
        List certificates = certPath.getCertificates();
        ...
        try {
            ...
            while (e.hasMoreElements()) {
                ...
                if (!"2.5.29.32.0".equals(a4.a())) {
                    try {
                        a2 = CertPathValidatorUtilities.a(a3.b());
                        if (!CertPathValidatorUtilities.a(i3, listArr, a4, a2)) {
                            CertPathValidatorUtilities.b(i3, listArr, a4, a2);
                        }
                    } catch (Throwable e2) {
            ...
            if (i2 > 0 || (i3 < size && CertPathValidatorUtilities.b(x509Certificate))) {
                Enumeration e3 = a.e();
                while (e3.hasMoreElements()) {
                    PolicyInformation a5 = PolicyInformation.a(e3.nextElement());
                    if ("2.5.29.32.0".equals(a5.a().a())) {
                        a2 = CertPathValidatorUtilities.a(a5.b());
                        ...
                        for (int i4 = 0; i4 < list.size(); i4++) {
                            ...
                            for (Object next2 : pKIXPolicyNode3.getExpectedPolicies()) {
                                ...
                                if (next22 instanceof String) {
                                    str = (String) next22;
                                } else if (next22 instanceof ASN1ObjectIdentifier) {
                                    str = ((ASN1ObjectIdentifier) next22).a();
                                }
    ...
    protected static void a(CertPath certPath, ExtendedPKIXParameters extendedPKIXParameters, int i, PublicKey publicKey, boolean z, X500Principal x500Principal, X509Certificate x509Certificate) throws ExtCertPathValidatorException {
        Throwable e;
        List certificates = certPath.getCertificates();
    ...
    protected static int a(CertPath certPath, int i, int i2) throws CertPathValidatorException {
        try {
            ...
            while (e.hasMoreElements()) {
                try {
                    ...
                    if (a2.a() == 0) {
                        int intValue = ASN1Integer.a(a2, false).a().intValue();
    ...
    protected static int b(CertPath certPath, int i, int i2) throws CertPathValidatorException {
        try {
            ASN1Sequence a = ASN1Sequence.a((Object) CertPathValidatorUtilities.a((X509Certificate) certPath.getCertificates().get(i), g));
            if (a == null) {
                return i2;
    ...
    protected static void b(CertPath certPath, int i, PKIXNameConstraintValidator pKIXNameConstraintValidator) throws CertPathValidatorException {
        try {
            NameConstraints a;
            ...
            if (a != null) {
                GeneralSubtree[] a3 = a.a();
                if (a3 != null) {
                    try {
                        pKIXNameConstraintValidator.a(a3);
                    } catch (Throwable e) {
                ...
                if (a3 != null) {
                    ...
                    while (i2 != a3.length) {
                        try {
                            pKIXNameConstraintValidator.a(a3[i2]);
                            i2++;
                        } catch (Throwable e2) {
    ...
    private static void a(DistributionPoint distributionPoint, ExtendedPKIXParameters extendedPKIXParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, CertStatus certStatus, ReasonsMask reasonsMask, List list) throws AnnotatedException {
                ...
                if (a.c(reasonsMask)) {
                    ...
                    if (extendedPKIXParameters.d() == 1 || x509Certificate.getNotAfter().getTime() >= x509crl.getThisUpdate().getTime()) {
                        ...
                        if (criticalExtensionOIDs != null) {
                            ...
                            hashSet.remove(X509Extensions.m.a());
                            hashSet.remove(X509Extensions.l.a());
                            if (!hashSet.isEmpty()) {
                        ...
                        if (x509crl2 != null) {
                            ...
                            if (criticalExtensionOIDs != null) {
                                ...
                                hashSet2.remove(X509Extensions.m.a());
                                hashSet2.remove(X509Extensions.l.a());
                                if (!hashSet2.isEmpty()) {
    ...
    protected static void a(ExtendedPKIXParameters extendedPKIXParameters, X509Certificate x509Certificate, Date date, X509Certificate x509Certificate2, PublicKey publicKey, List list) throws AnnotatedException {
        Throwable th = null;
        try {
            ...
            try {
                ...
                if (a != null) {
                    try {
                        DistributionPoint[] a2 = a.a();
                        if (a2 != null) {
                            int i = 0;
                            while (i < a2.length && certStatus.b() == 11 && !reasonsMask.a()) {
                                Object obj2;
                                Throwable th2;
                                try {
                                    a(a2[i], (ExtendedPKIXParameters) extendedPKIXParameters.clone(), x509Certificate, date, x509Certificate2, publicKey, certStatus, reasonsMask, list);
                                    obj2 = 1;
                                    th2 = th;
                                } catch (Throwable e) {
                                    th2 = e;
    ...
    protected static int c(CertPath certPath, int i, int i2) throws CertPathValidatorException {
        try {
            ASN1Integer a = ASN1Integer.a(CertPathValidatorUtilities.a((X509Certificate) certPath.getCertificates().get(i), c));
            if (a == null) {
                return i2;
            }
    ...
    protected static void b(CertPath certPath, int i) throws CertPathValidatorException {
        try {
    ...
    protected static int d(CertPath certPath, int i, int i2) throws CertPathValidatorException {
    ...
    protected static int e(CertPath certPath, int i, int i2) throws CertPathValidatorException {
        try {
            BasicConstraints a = BasicConstraints.a(CertPathValidatorUtilities.a((X509Certificate) certPath.getCertificates().get(i), h));
            if (a == null) {
                return i2;
    ...
    protected static void c(CertPath certPath, int i) throws CertPathValidatorException {
    ...
    protected static void a(CertPath certPath, int i, Set set, List list) throws CertPathValidatorException {
    ...
    protected static int i(CertPath certPath, int i, int i2) throws CertPathValidatorException {
        try {
            ASN1Sequence a = ASN1Sequence.a((Object) CertPathValidatorUtilities.a((X509Certificate) certPath.getCertificates().get(i), g));
            if (a == null) {
                return i2;
    ...
    protected static void a(CertPath certPath, int i, List list, Set set) throws CertPathValidatorException {
        X509Certificate x509Certificate = (X509Certificate) certPath.getCertificates().get(i);
        for (PKIXCertPathChecker check : list) {
            try {
                check.check(x509Certificate, set);
    ...
    protected static PKIXPolicyNode a(CertPath certPath, ExtendedPKIXParameters extendedPKIXParameters, Set set, int i, List[] listArr, PKIXPolicyNode pKIXPolicyNode, Set set2) throws CertPathValidatorException {
