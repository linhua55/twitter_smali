...
public class PKIXCRLUtil {
    public Set a(X509CRLStoreSelector x509CRLStoreSelector, ExtendedPKIXParameters extendedPKIXParameters, Date date) throws AnnotatedException {
    ...
    private final Collection a(X509CRLStoreSelector x509CRLStoreSelector, List list) throws AnnotatedException {
