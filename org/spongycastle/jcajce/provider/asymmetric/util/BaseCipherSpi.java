...
public abstract class BaseCipherSpi extends CipherSpi {
    ...
    protected BaseCipherSpi() {
        this.c = new Class[]{IvParameterSpec.class, PBEParameterSpec.class, RC2ParameterSpec.class, RC5ParameterSpec.class};
        this.a = null;
        this.b = null;
    }
        ...
        try {
            ...
            if (str.equals("") && i == 2) {
                try {
                    ...
                    throw new InvalidKeyException("algorithm " + a.a().b() + " not supported");
                } catch (Exception e) {
