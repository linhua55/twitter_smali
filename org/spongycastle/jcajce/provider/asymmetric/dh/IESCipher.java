...
public class IESCipher extends CipherSpi {
    ...
    private boolean h;
    private AsymmetricKeyParameter i;

    /* compiled from: Twttr */
    public class IES extends IESCipher {
        public IES() {
    ...
    /* compiled from: Twttr */
    public class IESwithAES extends IESCipher {
        public IESwithAES() {
    ...
    /* compiled from: Twttr */
    public class IESwithDESede extends IESCipher {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) throws IllegalBlockSizeException, BadPaddingException {
        ...
        if (this.i != null) {
            ...
            try {
                this.a.a(this.f, iESWithCipherParameters, new EphemeralKeyPairGenerator(dHKeyPairGenerator, new KeyEncoder() {
