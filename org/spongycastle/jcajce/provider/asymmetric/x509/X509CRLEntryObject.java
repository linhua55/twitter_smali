...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private X500Name a(boolean z, X500Name x500Name) {
        ...
        try {
            GeneralName[] a2 = GeneralNames.a(a.e()).a();
            for (int i = 0; i < a2.length; i++) {
                if (a2[i].a() == 4) {
                    return X500Name.a(a2[i].b());
                }
            }
            return null;
        } catch (Exception e) {
    ...
    public String toString() {
        ...
        if (c != null) {
            ...
            if (a.hasMoreElements()) {
                ...
                while (a.hasMoreElements()) {
                    ASN1ObjectIdentifier aSN1ObjectIdentifier = (ASN1ObjectIdentifier) a.nextElement();
                    Extension a2 = c.a(aSN1ObjectIdentifier);
                    if (a2.c() != null) {
                        ...
                        try {
                            if (aSN1ObjectIdentifier.equals(X509Extension.i)) {
                                stringBuffer.append(CRLReason.a(ASN1Enumerated.a(aSN1InputStream.d()))).append(property);
