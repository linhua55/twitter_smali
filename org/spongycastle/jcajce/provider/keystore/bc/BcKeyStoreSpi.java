...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    /* compiled from: Twttr */
    public class BouncyCastleStore extends BcKeyStoreSpi {
    ...
    /* compiled from: Twttr */
    public class Std extends BcKeyStoreSpi {
        public Std() {
            super(2);
        }
    }
    ...
    class StoreEntry {
        ...
        StoreEntry(BcKeyStoreSpi bcKeyStoreSpi, String str, Key key, char[] cArr, Certificate[] certificateArr) throws Exception {
            this.f = bcKeyStoreSpi;
            this.e = new Date();
            this.a = 4;
            this.b = str;
            ...
            int nextInt = (bcKeyStoreSpi.b.nextInt() & 1023) + 1024;
    ...
    /* compiled from: Twttr */
    public class Version1 extends BcKeyStoreSpi {
        public Version1() {
            super(1);
        }
    }
    ...
    private void a(Key key, DataOutputStream dataOutputStream) throws IOException {
