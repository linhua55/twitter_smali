...
public final class DES {
    ...
    public class Mappings extends AlgorithmProvider {
        ...
        public void a(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.a("Alg.Alias.Cipher." + PKCSObjectIdentifiers.y_, "PBEWITHMD2ANDDES");
            ...
            configurableProvider.a("Alg.Alias.SecretKeyFactory." + PKCSObjectIdentifiers.y_, "PBEWITHMD2ANDDES");
        ...
        private void a(ConfigurableProvider configurableProvider, ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
            configurableProvider.a("Alg.Alias.KeyGenerator." + aSN1ObjectIdentifier.a(), str);
            configurableProvider.a("Alg.Alias.KeyFactory." + aSN1ObjectIdentifier.a(), str);
        }
    }
    ...
    public class PBEWithMD2KeyFactory extends DESPBEKeyFactory {
        public PBEWithMD2KeyFactory() {
            super("PBEwithMD2andDES", PKCSObjectIdentifiers.y_, true, 0, 5, 64, 64);
        }
    }
