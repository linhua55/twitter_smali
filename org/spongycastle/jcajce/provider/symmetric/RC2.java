...
public final class RC2 {
    ...
    public class AlgParams extends BaseAlgorithmParameters {
        ...
        protected byte[] engineGetEncoded(String str) throws IOException {
            if (a(str)) {
                if (this.d == -1) {
                    return new RC2CBCParameter(engineGetEncoded()).f();
                }
                return new RC2CBCParameter(this.d, engineGetEncoded()).f();
        ...
        protected void engineInit(byte[] bArr, String str) throws IOException {
            if (a(str)) {
                RC2CBCParameter a = RC2CBCParameter.a(ASN1Primitive.b(bArr));
                if (a.a() != null) {
                    this.d = a.a().intValue();
                }
                this.c = a.b();
    ...
    public class Mappings extends AlgorithmProvider {
        ...
        public void a(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.a("Alg.Alias.SecretKeyFactory." + PKCSObjectIdentifiers.z_, "PBEWITHMD2ANDRC2");
            ...
            configurableProvider.a("Alg.Alias.Cipher." + PKCSObjectIdentifiers.z_, "PBEWITHMD2ANDRC2");
    ...
    /* compiled from: Twttr */
    public class PBEWithMD2KeyFactory extends PBESecretKeyFactory {
        public PBEWithMD2KeyFactory() {
            super("PBEwithMD2andRC2", PKCSObjectIdentifiers.z_, true, 0, 5, 64, 64);
        }
    }

    /* compiled from: Twttr */
    public class PBEWithMD5AndRC2 extends BaseBlockCipher {
    ...
    /* compiled from: Twttr */
    public class PBEWithMD5KeyFactory extends PBESecretKeyFactory {
    ...
    /* compiled from: Twttr */
    public class PBEWithSHA1AndRC2 extends BaseBlockCipher {
    ...
    /* compiled from: Twttr */
    public class PBEWithSHA1KeyFactory extends PBESecretKeyFactory {
    ...
    public class PBEWithSHAAnd128BitKeyFactory extends PBESecretKeyFactory {
        public PBEWithSHAAnd128BitKeyFactory() {
            super("PBEwithSHAand128BitRC2-CBC", PKCSObjectIdentifiers.by, true, 2, 1, 128, 64);
        }
    }

    /* compiled from: Twttr */
    public class PBEWithSHAAnd128BitRC2 extends BaseBlockCipher {
    ...
    /* compiled from: Twttr */
    public class PBEWithSHAAnd40BitRC2 extends BaseBlockCipher {
