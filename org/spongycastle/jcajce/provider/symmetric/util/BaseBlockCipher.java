...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    class AEADGenericBlockCipher implements GenericBlockCipher {
        ...
        static {
            Class a = BaseBlockCipher.b("javax.crypto.AEADBadTagException");
            if (a != null) {
                a = a(a);
            } else {
                a = null;
        ...
        public int a(byte[] bArr, int i) throws IllegalStateException, BadPaddingException {
            try {
                ...
                if (a != null) {
                    ...
                    try {
                        badPaddingException = (BadPaddingException) a.newInstance(new Object[]{invalidCipherTextException.getMessage()});
                    } catch (Exception e2) {
    ...
    static {
        e = b("javax.crypto.spec.GCMParameterSpec");
    }
        ...
        if (this.c == null) {
            if (this.n != null) {
                ...
                try {
                    ...
                    this.c.init(new GCMParameters(this.k.d(), this.k.b()).f());
                } catch (Exception e22) {
        ...
        if (!(key instanceof SecretKey)) {
            ...
            if (key instanceof BCPBEKey) {
                ...
                if (this.l != 0) {
                    ...
                    if (ivParameterSpec.getIV().length == this.l || c(this.p)) {
            ...
            } else if (c(this.p) || (this.i instanceof AEADGenericBlockCipher)) {
                try {
