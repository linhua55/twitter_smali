...
public class IntegerPolynomial implements Polynomial {
    ...
    private IntegerPolynomial d(IntegerPolynomial integerPolynomial) {
        ...
        IntegerPolynomial integerPolynomial4 = new IntegerPolynomial(Arrays.b(iArr, i2, length));
        IntegerPolynomial integerPolynomial5 = new IntegerPolynomial(Arrays.b(iArr2, i2));
        IntegerPolynomial integerPolynomial6 = new IntegerPolynomial(Arrays.b(iArr2, i2, length));
    ...
    public Resultant f() {
        ...
        for (i = 0; i < length; i++) {
            nextProbablePrime = bigIntPolynomial.a[i];
            if (nextProbablePrime.compareTo(divide) > 0) {
                bigIntPolynomial.a[i] = nextProbablePrime.subtract(multiply);
            }
            if (nextProbablePrime.compareTo(bigInteger3) < 0) {
                bigIntPolynomial.a[i] = nextProbablePrime.add(multiply);
            }
        }
