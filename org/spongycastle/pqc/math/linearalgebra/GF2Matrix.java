...
public class GF2Matrix extends Matrix {
    ...
    public GF2Matrix(int i, char c, SecureRandom secureRandom) {
        ...
        switch (c) {
            case ApiRunnable.ACTION_CODE_REPORT_COMMENT /*73*/:
                a(i);
            case ApiRunnable.ACTION_CODE_GET_BROADCASTS_FOR_CHANNEL /*76*/:
                b(i, secureRandom);
    ...
    public static GF2Matrix[] a(int i, SecureRandom secureRandom) {
        ...
        int[] b = permutation.b();
        int[][] iArr = (int[][]) Array.newInstance(Integer.TYPE, new int[]{i, i5});
        for (i2 = 0; i2 < i; i2++) {
            System.arraycopy(gF2Matrix3.a[b[i2]], 0, iArr[i2], 0, i5);
        }
        ...
        for (i2 = 0; i2 < i; i2++) {
            ...
            int i7 = 1 << (i2 & 31);
            for (i3 = i2 + 1; i3 < i; i3++) {
                if ((gF2Matrix.a[i3][i6] & i7) != 0) {
                    for (i4 = 0; i4 <= i6; i4++) {
                        int[] iArr2 = gF2Matrix4.a[i3];
                        iArr2[i4] = iArr2[i4] ^ gF2Matrix4.a[i2][i4];
                    }
                }
            }
        }
        ...
        for (int i8 = i - 1; i8 >= 0; i8--) {
            ...
            i7 = 1 << (i8 & 31);
            for (i2 = i8 - 1; i2 >= 0; i2--) {
                if ((gF2Matrix2.a[i2][i3] & i7) != 0) {
                    for (i4 = i3; i4 < i5; i4++) {
                        iArr2 = gF2Matrix5.a[i2];
                        iArr2[i4] = iArr2[i4] ^ gF2Matrix5.a[i8][i4];
                    }
                }
            }
        }
