...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.c = new byte[aSN1Sequence2.h()][];
        for (i = 0; i < aSN1Sequence2.h(); i++) {
        ...
        byte[][][][] bArr = new byte[aSN1Sequence2.h()][][][];
        byte[][][][] bArr2 = new byte[aSN1Sequence2.h()][][][];
        byte[][][] bArr3 = new byte[aSN1Sequence2.h()][][];
        byte[][] bArr4 = new byte[aSN1Sequence2.h()][];
        for (int i3 = 0; i3 < aSN1Sequence2.h(); i3++) {
            int i4;
            ASN1Sequence aSN1Sequence3 = (ASN1Sequence) aSN1Sequence2.a(i3);
            ASN1Sequence aSN1Sequence4 = (ASN1Sequence) aSN1Sequence3.a(0);
            bArr[i3] = new byte[aSN1Sequence4.h()][][];
            for (i4 = 0; i4 < aSN1Sequence4.h(); i4++) {
                ASN1Sequence aSN1Sequence5 = (ASN1Sequence) aSN1Sequence4.a(i4);
                bArr[i3][i4] = new byte[aSN1Sequence5.h()][];
                for (i2 = 0; i2 < aSN1Sequence5.h(); i2++) {
                    bArr[i3][i4][i2] = ((ASN1OctetString) aSN1Sequence5.a(i2)).e();
                }
            }
            aSN1Sequence4 = (ASN1Sequence) aSN1Sequence3.a(1);
            bArr2[i3] = new byte[aSN1Sequence4.h()][][];
            for (i4 = 0; i4 < aSN1Sequence4.h(); i4++) {
                aSN1Sequence5 = (ASN1Sequence) aSN1Sequence4.a(i4);
                bArr2[i3][i4] = new byte[aSN1Sequence5.h()][];
                for (i2 = 0; i2 < aSN1Sequence5.h(); i2++) {
                    bArr2[i3][i4][i2] = ((ASN1OctetString) aSN1Sequence5.a(i2)).e();
                }
            }
            aSN1Sequence4 = (ASN1Sequence) aSN1Sequence3.a(2);
            bArr3[i3] = new byte[aSN1Sequence4.h()][];
            for (int i5 = 0; i5 < aSN1Sequence4.h(); i5++) {
                bArr3[i3][i5] = ((ASN1OctetString) aSN1Sequence4.a(i5)).e();
            }
            bArr4[i3] = ((ASN1OctetString) aSN1Sequence3.a(3)).e();
        }
        int length = this.g.length - 1;
        this.h = new Layer[length];
        for (i2 = 0; i2 < length; i2++) {
            this.h[i2] = new Layer(this.g[i2], this.g[i2 + 1], RainbowUtil.a(bArr[i2]), RainbowUtil.a(bArr2[i2]), RainbowUtil.a(bArr3[i2]), RainbowUtil.b(bArr4[i2]));
        }
    }
