...
public class RainbowKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            try {
                return a(PrivateKeyInfo.a(ASN1Primitive.b(((PKCS8EncodedKeySpec) keySpec).getEncoded())));
            } catch (Exception e) {
    ...
    public PrivateKey a(PrivateKeyInfo privateKeyInfo) throws IOException {
        RainbowPrivateKey a = RainbowPrivateKey.a(privateKeyInfo.c());
        return new BCRainbowPrivateKey(a.a(), a.b(), a.e(), a.c(), a.i(), a.h());
    }

    public PublicKey a(SubjectPublicKeyInfo subjectPublicKeyInfo) throws IOException {
        RainbowPublicKey a = RainbowPublicKey.a(subjectPublicKeyInfo.c());
        return new BCRainbowPublicKey(a.a(), a.b(), a.c(), a.e());
    }
}
