...
public class NTRUEncryptionKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    ...
    static {
        a = new NTRUEncryptionKeyGenerationParameters(1087, 2048, 120, 120, 256, 13, 25, 14, true, new byte[]{(byte) 0, (byte) 6, (byte) 3}, true, false, new SHA512Digest());
        b = new NTRUEncryptionKeyGenerationParameters(1171, 2048, cse.AppCompatTheme_ratingBarStyle, cse.AppCompatTheme_ratingBarStyle, 256, 13, 20, 15, true, new byte[]{(byte) 0, (byte) 6, (byte) 4}, true, false, new SHA512Digest());
        c = new NTRUEncryptionKeyGenerationParameters(1499, 2048, 79, 79, 256, 13, 17, 19, true, new byte[]{(byte) 0, (byte) 6, (byte) 5}, true, false, new SHA512Digest());
        d = new NTRUEncryptionKeyGenerationParameters(439, 2048, 146, 130, 128, 9, 32, 9, true, new byte[]{(byte) 0, (byte) 7, (byte) 101}, true, false, new SHA256Digest());
        e = new NTRUEncryptionKeyGenerationParameters(439, 2048, 9, 8, 5, 130, 128, 9, 32, 9, true, new byte[]{(byte) 0, (byte) 7, (byte) 101}, true, true, new SHA256Digest());
        f = new NTRUEncryptionKeyGenerationParameters(743, 2048, 248, 220, 256, 10, 27, 14, true, new byte[]{(byte) 0, (byte) 7, (byte) 105}, false, false, new SHA512Digest());
        g = new NTRUEncryptionKeyGenerationParameters(743, 2048, 11, 11, 15, 220, 256, 10, 27, 14, true, new byte[]{(byte) 0, (byte) 7, (byte) 105}, false, true, new SHA512Digest());
    }
