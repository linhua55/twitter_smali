...
public class NTRUSigningKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    class BasisGenerationTask implements Callable<Basis> {
        ...
        public Basis a() throws Exception {
            return this.a.b();
        }
    }
    ...
    private FGBasis c() {
        ...
        while (true) {
            if (this.a.A == 0) {
                ...
                Object a6 = ProductFormPolynomial.a(i, i4, i5, i6 + 1, i6, new SecureRandom());
            }
            m2 = a2.m();
            if (z) {
                if (m2.c(i8).c.equals(BigInteger.ZERO)) {
                    continue;
                }
            }
            if (m2.b(i2) != null) {
        ...
        if (this.a.y == 0) {
            ...
            IntegerPolynomial a7 = a.a(integerPolynomial);
            a7.b(a2.a(integerPolynomial2));
            Resultant f3 = a7.f();
            ...
            BigDecimalPolynomial a8 = f2.b.a(new BigDecimal(f2.c), (bigIntPolynomial2.a() + 1) + i9);
            BigDecimalPolynomial a9 = f.b.a(new BigDecimal(f.c), i9 + (bigIntPolynomial.a() + 1));
            a8 = a8.a(bigIntPolynomial2);
            a8.b(a9.a(bigIntPolynomial));
            a8.a();
            a4 = a8.b();
        }
