    ...
    public boolean a(byte[] bArr, byte[] bArr2) {
        ...
        while (i >= 0) {
            ...
            for (Object obj22 : bArr3) {
                System.arraycopy(bArr2, i2, obj22, 0, this.e);
                i2 += this.e;
            }
            ...
            for (a = 0; a < bArr3.length; a++) {
                obj22 = new byte[(this.e << 1)];
                if (i3 % 2 == 0) {
                    System.arraycopy(obj3, 0, obj22, 0, this.e);
                    System.arraycopy(bArr3[a], 0, obj22, this.e, this.e);
                    i3 /= 2;
                } else {
                    System.arraycopy(bArr3[a], 0, obj22, 0, this.e);
                    System.arraycopy(obj3, 0, obj22, this.e, obj3.length);
                    i3 = (i3 - 1) / 2;
                }
                this.d.a(obj22, 0, obj22.length);
                obj3 = new byte[this.d.b()];
                this.d.a(obj3, 0);
            }
            i--;
            Object obj4 = obj3;
        }
        if (Arrays.a(this.c, bArr)) {
            return true;
        }
        return false;
    }
